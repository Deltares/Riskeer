...
/*  Created On : 03-nov-2020 11:25:55 				*/
/*  DBMS       : SQLite 								*/
/* ---------------------------------------------------- */
...
DROP TABLE IF EXISTS 'ProbabilisticPipingCalculationOutput'
;
...
(
	...
	'PhreaticLevelExitStandardDeviation' REAL NULL,
	'DampingFactorExitMean' REAL NULL,
	'DampingFactorStandardDeviation' REAL NULL,
	'RelevantForScenario' TINYINT (1) NOT NULL,	-- true or false
	'ScenarioContribution' REAL NULL,
	...
	CONSTRAINT 'FK_ProbabilisticPipingCalculationEntitiy_CalculationGroupEntity' FOREIGN KEY ('CalculationGroupEntityId') REFERENCES 'CalculationGroupEntity' ('CalculationGroupEntityId') ON DELETE Cascade ON UPDATE Cascade,
	CONSTRAINT 'FK_ProbabilisticPipingCalculationEntitiy_HydraulicLocationEntity' FOREIGN KEY ('HydraulicLocationEntityId') REFERENCES 'HydraulicLocationEntity' ('HydraulicLocationEntityId') ON DELETE Set Null ON UPDATE Cascade,
	CONSTRAINT 'FK_ProbabilisticPipingCalculationEntitiy_PipingStochasticSoilProfileEntity' FOREIGN KEY ('PipingStochasticSoilProfileEntityId') REFERENCES 'PipingStochasticSoilProfileEntity' ('PipingStochasticSoilProfileEntityId') ON DELETE Set Null ON UPDATE Cascade,
	CONSTRAINT 'FK_ProbabilisticPipingCalculationEntitiy_SurfaceLineEntity' FOREIGN KEY ('SurfaceLineEntityId') REFERENCES 'SurfaceLineEntity' ('SurfaceLineEntityId') ON DELETE Set Null ON UPDATE Cascade
)
;

CREATE TABLE 'ProbabilisticPipingCalculationOutput'
(
	...
	CONSTRAINT 'FK_ProbabilisticPipingCalculationOutput_ProbabilisticPipingCalculationEntitiy' FOREIGN KEY ('ProbabilisticPipingCalculationEntityId') REFERENCES 'ProbabilisticPipingCalculationEntity' ('ProbabilisticPipingCalculationEntityId') ON DELETE Cascade ON UPDATE Cascade,
	CONSTRAINT 'FK_ProbabilisticPipingCalculationOutput_Profile_GeneralResultFaultTreeIllustrationPointEntity' FOREIGN KEY ('ProfileSpecificGeneralResultFaultTreeIllustrationPointEntityId') REFERENCES 'GeneralResultFaultTreeIllustrationPointEntity' ('GeneralResultFaultTreeIllustrationPointEntityId') ON DELETE Cascade ON UPDATE Cascade,
	CONSTRAINT 'FK_ProbabilisticPipingCalculationOutput_Section_GeneralResultFaultTreeIllustrationPointEntity' FOREIGN KEY ('SectionSpecificGeneralResultFaultTreeIllustrationPointEntityId') REFERENCES 'GeneralResultFaultTreeIllustrationPointEntity' ('GeneralResultFaultTreeIllustrationPointEntityId') ON DELETE Cascade ON UPDATE Cascade,
...
CREATE INDEX 'IXFK_ProbabilisticPipingCalculationEntitiy_CalculationGroupEntity'
 ON 'ProbabilisticPipingCalculationEntity' ('CalculationGroupEntityId' ASC)
;

CREATE INDEX 'IXFK_ProbabilisticPipingCalculationEntitiy_HydraulicLocationEntity'
 ON 'ProbabilisticPipingCalculationEntity' ('HydraulicLocationEntityId' ASC)
;

CREATE INDEX 'IXFK_ProbabilisticPipingCalculationEntitiy_PipingStochasticSoilProfileEntity'
 ON 'ProbabilisticPipingCalculationEntity' ('PipingStochasticSoilProfileEntityId' ASC)
;

CREATE INDEX 'IXFK_ProbabilisticPipingCalculationEntitiy_SurfaceLineEntity'
 ON 'ProbabilisticPipingCalculationEntity' ('SurfaceLineEntityId' ASC)
;

CREATE INDEX 'IXFK_ProbabilisticPipingCalculationOutput_ProbabilisticPipingCalculationEntitiy'
 ON 'ProbabilisticPipingCalculationOutput' ('ProbabilisticPipingCalculationEntityId' ASC)
;

CREATE INDEX 'IXFK_ProbabilisticPipingCalculationOutput_Profile_GeneralResultFaultTreeIllustrationPointEntity'
 ON 'ProbabilisticPipingCalculationOutput' ('ProfileSpecificGeneralResultFaultTreeIllustrationPointEntityId' ASC)
;

CREATE INDEX 'IXFK_ProbabilisticPipingCalculationOutput_Section_GeneralResultFaultTreeIllustrationPointEntity'
 ON 'ProbabilisticPipingCalculationOutput' ('ProfileSpecificGeneralResultFaultTreeIllustrationPointEntityId' ASC)
;
