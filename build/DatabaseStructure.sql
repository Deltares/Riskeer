...
/*  Created On : 18-nov-2021 14:44:51 				*/
/*  DBMS       : SQLite 								*/
/* ---------------------------------------------------- */
...
BEGIN
	...
	WHERE OLD.HydraulicLocationCalculationCollectionEntityId IS NOT NULL 
	AND HydraulicLocationCalculationCollectionEntityId IS OLD.HydraulicLocationCalculationCollectionEntityId;
END; 
;
...
CREATE INDEX 'IXFK_SpecificFailurePathFailureMechanismSectionEntity_SpecificFailurePathEntity'
 ON 'SpecificFailurePathFailureMechanismSectionEntity' ('SpecificFailurePathEntityId' ASC)
;
CREATE TRIGGER [TR_AfterDeleteSpecificFailurePathEntity_RemoveFailureMechanismSectionEntityId]
	AFTER DELETE
	ON SpecificFailurePathFailureMechanismSectionEntity
	FOR EACH ROW
BEGIN
	DELETE 
	FROM FailureMechanismSectionEntity
