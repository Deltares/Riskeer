...
/*  Created On : 30-Jan-2017 11:15:35 				*/
/*  DBMS       : SQLite 								*/
/* ---------------------------------------------------- */
...
DROP TABLE IF EXISTS 'WmtsMapDataEntity'
;
...
CREATE TABLE 'WmtsMapDataEntity'
(
	'WmtsMapDataEntityId' INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
	'AssessmentSectionEntityId' INTEGER NOT NULL,
	'Name' TEXT NOT NULL,
	'SourceCapabilitiesUrl' TEXT NOT NULL,
	'SelectedCapabilityName' TEXT NOT NULL,
	'PreferredFormat' VARCHAR (255) NOT NULL,
...
CREATE INDEX 'IXFK_WmtsMapDataEntity_AssessmentSectionEntity'
 ON 'WmtsMapDataEntity' ('AssessmentSectionEntityId' ASC)
;
