...
/*  Created On : 20-jan-2022 07:18:12 				*/
/*  DBMS       : SQLite 								*/
/* ---------------------------------------------------- */
...
(
	...
	'FailurePathAssemblyProbabilityResultType' TINYINT (1) NOT NULL,	-- Enum: Automatic = 1, Manual = 2
	'ManualFailurePathAssemblyProbability' REAL NULL,
...
(
	...
	'AdoptableInitialFailureMechanismResultType' TINYINT (1) NOT NULL,	-- Enum: Adopt = 1 Manual = 2 NoFailureProbability = 3
	'ManualInitialFailureMechanismResultSectionProbability' REAL NULL,
	'FurtherAnalysisNeeded' TINYINT (1) NOT NULL,	-- true or false
...
(
	...
	'FailureMechanismSectionEntityId' INTEGER NOT NULL,
	'IsRelevant' TINYINT (1) NOT NULL,	-- true or false
	'NonAdoptableInitialFailureMechanismResultType' TINYINT (1) NOT NULL,	-- Enum: Manual = 1 NoFailureProbability = 2
	'ManualInitialFailureMechanismResultSectionProbability' REAL NULL,
	'FurtherAnalysisNeeded' TINYINT (1) NOT NULL,	-- true or false
	'RefinedSectionProbability' REAL NULL,
...
(
	...
	'FailureMechanismSectionEntityId' INTEGER NOT NULL,
	'IsRelevant' TINYINT (1) NOT NULL,	-- true or false
	'AdoptableInitialFailureMechanismResultType' TINYINT (1) NOT NULL,	-- Enum: Adopt = 1 Manual = 2 NoFailureProbablity = 3
	'ManualInitialFailureMechanismResultSectionProbability' REAL NULL,
	'ManualInitialFailureMechanismResultProfileProbability' REAL NULL,
	'FurtherAnalysisNeeded' TINYINT (1) NOT NULL,	-- true or false
	'ProbabilityRefinementType' TINYINT (1) NOT NULL,	-- Enum:  Profile = 1, Section = 2,  Both = 3
...
;
CREATE TRIGGER [TR_AfterDeleteSpecificFailurePathFailureMechanismSectionEntity_RemoveFailureMechanismSectionEntityId]
	AFTER DELETE
