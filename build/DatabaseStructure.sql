...
/*  Created On : 14-jan-2022 11:44:50 				*/
/*  DBMS       : SQLite 								*/
/* ---------------------------------------------------- */
...
(
	...
	'InitialAdoptableFailureMechanismResultType' TINYINT (1) NOT NULL,	-- Enum: Adopt = 1 Manual = 2 NoFailureProbability = 3
...
(
	...
	'FailureMechanismSectionEntityId' INTEGER NOT NULL,
	'IsRelevant' TINYINT (1) NOT NULL,	-- true or false
	'InitialAdoptableFailureMechanismResultType' TINYINT (1) NOT NULL,	-- Enum: Adopt = 1 Manual = 2 NoFailureProbablity = 3
	'ManualInitialFailureMechanismResultSectionProbability' REAL NULL,
	'ManualInitialFailureMechanismResultProfileProbability' REAL NULL,
	'FurtherAnalysisNeeded' TINYINT (1) NOT NULL,	-- true or false
	'ProbabilityRefinementType' TINYINT (1) NOT NULL,	-- Enum:  Profile = 1, Section = 2,  Both = 3
