...
/*  Created On : 07-Sep-2017 3:09:10 PM 				*/
/*  DBMS       : SQLite 								*/
/* ---------------------------------------------------- */
...
DROP TABLE IF EXISTS 'MacroStabilityInwardsSoilLayer1DEntity'
;

DROP TABLE IF EXISTS 'MacroStabilityInwardsSoilProfile1DEntity'
;

DROP TABLE IF EXISTS 'MacroStabilityInwardsSoilLayer2DEntity'
;

DROP TABLE IF EXISTS 'MacroStabilityInwardsSoilProfile2DEntity'
;
...
(
	...
	'NormativeNorm' TINYINT (1) NOT NULL, -- EnumType: 1 = LowerLimit, 2 = Signaling
...
(
	...
	'SurfaceLineEntityId' INTEGER NOT NULL,
	'Type' SMALLINT NOT NULL, -- Enumtype: 1 = SurfaceLevelOutside 2 = SurfaceLevelInside  3 = TrafficLoadOutside 4 = TrafficLoadInside 5 = ShoulderBaseInside 6 = ShoulderTopInside 7 = DikeToeAtRiver 8 = DikeToeAtPolder 9 = BottomDitchDikeSide 10 = BottomDitchPolderSide 11 = DitchDikeSide 12 = DikeTopAtPolder 13 = DitchPolderSide
	'X' REAL,
	'Y' REAL,
	'Z' REAL,
...
CREATE TABLE 'MacroStabilityInwardsSoilLayer1DEntity'
(
	'MacroStabilityInwardsSoilLayer1DEntityId' INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
	'MacroStabilityInwardsSoilProfile1DEntityId' INTEGER NOT NULL,
	'Top' REAL,
	'IsAquifer' TINYINT (1) NOT NULL,
	'Color' INTEGER NOT NULL, -- ARGB value of Color.
	'MaterialName' TEXT NOT NULL,
	'ShearStrengthModel' TINYINT (1) NOT NULL, -- Enumtype: 1 = None, 2 = SuCalculated, 3 = CPhi, 4 = CPhiOrSuCalculated
	'UsePop' TINYINT (1) NOT NULL, -- true of false
	'AbovePhreaticLevelMean' REAL,
	'AbovePhreaticLevelDeviation' REAL,
	'AbovePhreaticLevelShift' REAL,
	'BelowPhreaticLevelMean' REAL,
	'BelowPhreaticLevelDeviation' REAL,
	'BelowPhreaticLevelShift' REAL,
	'CohesionMean' REAL,
	'CohesionDeviation' REAL,
	'FrictionAngleMean' REAL,
	'FrictionAngleDeviation' REAL,
	'ShearStrengthRatioMean' REAL,
	'ShearStrengthRatioDeviation' REAL,
	'StrengthIncreaseExponentMean' REAL,
	'StrengthIncreaseExponentDeviation' REAL,
	'PopMean' REAL,
	'PopDeviation' REAL,
	'Order' INT (4) NOT NULL,
	CONSTRAINT 'FK_MacroStabilityInwardsSoilLayer1DEntity_MacroStabilityInwardsSoilProfile1DEntity' FOREIGN KEY ('MacroStabilityInwardsSoilProfile1DEntityId') REFERENCES 'MacroStabilityInwardsSoilProfile1DEntity' ('MacroStabilityInwardsSoilProfile1DEntityId') ON DELETE Cascade ON UPDATE Cascade
)
;

CREATE TABLE 'MacroStabilityInwardsSoilProfile1DEntity'
(
	'MacroStabilityInwardsSoilProfile1DEntityId' INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
	'Name' TEXT NOT NULL,
	'Bottom' REAL
)
;

CREATE TABLE 'MacroStabilityInwardsSoilLayer2DEntity'
(
	'MacroStabilityInwardsSoilLayer2DEntityId' INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
	'MacroStabilityInwardsSoilProfile2DEntityId' INTEGER NOT NULL,
	'IsAquifer' TINYINT (1) NOT NULL,
	'Color' INTEGER, -- ARGB value of Color.
	'MaterialName' TEXT NOT NULL,
	'ShearStrengthModel' TINYINT (1) NOT NULL, -- Enumtype: 1 = None, 2 = SuCalculated, 3 = CPhi, 4 = CPhiOrSuCalculated
	'UsePop' TINYINT (1) NOT NULL,
	'AbovePhreaticLevelMean' REAL,
	'AbovePhreaticLevelDeviation' REAL,
	'AbovePhreaticLevelShift' REAL,
	'BelowPhreaticLevelMean' REAL,
	...
	'PopDeviation' REAL,
	'Order' INT (4) NOT NULL,
	CONSTRAINT 'FK_MacroStabilityInwardsSoilLayer2DEntity_MacroStabilityInwardsSoilProfile2DEntity' FOREIGN KEY ('MacroStabilityInwardsSoilProfile2DEntityId') REFERENCES 'MacroStabilityInwardsSoilProfile2DEntity' ('MacroStabilityInwardsSoilProfile2DEntityId') ON DELETE Cascade ON UPDATE Cascade
)
;

CREATE TABLE 'MacroStabilityInwardsSoilProfile2DEntity'
(
	'MacroStabilityInwardsSoilProfile2DEntityId' INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
	'Name' TEXT NOT NULL
)
;
...
(
	...
	'StochasticSoilModelEntityId' INTEGER NOT NULL,
	'MacroStabilityInwardsSoilProfile1DEntityId' INTEGER,
	'MacroStabilityInwardsSoilProfile2DEntityId' INTEGER,
	'Probability' REAL NOT NULL,
	'Order' INT (4) NOT NULL,
	CONSTRAINT 'FK_MacroStabilityInwardsStochasticSoilProfileEntity_MacroStabilityInwardsSoilProfile1DEntity' FOREIGN KEY ('MacroStabilityInwardsSoilProfile1DEntityId') REFERENCES 'MacroStabilityInwardsSoilProfile1DEntity' ('MacroStabilityInwardsSoilProfile1DEntityId') ON DELETE Cascade ON UPDATE Cascade,
	CONSTRAINT 'FK_MacroStabilityInwardsStochasticSoilProfileEntity_MacroStabilityInwardsSoilProfile2DEntity' FOREIGN KEY ('MacroStabilityInwardsSoilProfile2DEntityId') REFERENCES 'MacroStabilityInwardsSoilProfile2DEntity' ('MacroStabilityInwardsSoilProfile2DEntityId') ON DELETE Cascade ON UPDATE Cascade,
...
CREATE INDEX 'IXFK_MacroStabilityInwardsSoilLayer1DEntity_MacroStabilityInwardsSoilProfile1DEntity'
 ON 'MacroStabilityInwardsSoilLayer1DEntity' ('MacroStabilityInwardsSoilProfile1DEntityId' ASC)
;

CREATE INDEX 'IXFK_MacroStabilityInwardsSoilLayer2DEntity_MacroStabilityInwardsSoilProfile2DEntity'
 ON 'MacroStabilityInwardsSoilLayer2DEntity' ('MacroStabilityInwardsSoilProfile2DEntityId' ASC)
;
