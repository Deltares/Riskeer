...
/*  Created On : 22-sep-2021 14:58:58 				*/
/*  DBMS       : SQLite 								*/
/* ---------------------------------------------------- */
...
(
	...
	CONSTRAINT 'FK_DuneLocationCalculationForTargetProbabilityCollectionEntity_DuneErosionFailureMechanismMetaEntity' FOREIGN KEY ('DuneErosionFailureMechanismMetaEntityId') REFERENCES 'DuneErosionFailureMechanismMetaEntity' ('DuneErosionFailureMechanismMetaEntityId') ON DELETE No Action ON UPDATE No Action
)
;
