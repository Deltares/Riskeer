...
/*  Created On : 14-sep-2021 12:33:05 				*/
/*  DBMS       : SQLite 								*/
/* ---------------------------------------------------- */
...
DROP TABLE IF EXISTS 'HydraulicBoundaryLocationCalculationsForTargetProbabilityEntity'
;
...
CREATE TABLE 'HydraulicBoundaryLocationCalculationsForTargetProbabilityEntity'
(
	'HydraulicBoundaryLocationCalculationsForTargetProbabilityEntityId' INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
	'AssessmentSectionEntityId' INTEGER NOT NULL,
...
CREATE TABLE 'HydraulicBoundaryLocationCalculationsForTargetProbabilityHydraulicLocationCalculationEntity'
(
	'HydraulicBoundaryLocationCalculationsForTargetProbabilityEntityId' INTEGER NOT NULL,
	'HydraulicLocationCalculationEntityId' INTEGER NOT NULL,
	CONSTRAINT 'PK_HydraulicBoundaryLocationCalculationsForTargetProbabilityHydraulicLocationCalculationEntity' PRIMARY KEY ('HydraulicBoundaryLocationCalculationsForTargetProbabilityEntityId','HydraulicLocationCalculationEntityId'),
	CONSTRAINT 'HydraulicBoundaryLocationCalculationsForTargetProbabilityHydraulicLocationCalculationEntity_HydraulicBoundaryLocationCalculationsForTargetProbabilityEntityId' FOREIGN KEY ('HydraulicBoundaryLocationCalculationsForTargetProbabilityEntityId') REFERENCES 'HydraulicBoundaryLocationCalculationsForTargetProbabilityEntity' ('HydraulicBoundaryLocationCalculationsForTargetProbabilityEntityId') ON DELETE No Action ON UPDATE No Action,
...
CREATE INDEX 'IXFK_HydraulicBoundaryLocationCalculationsForTargetProbabilityEntity_AssessmentSectionEntity'
 ON 'HydraulicBoundaryLocationCalculationsForTargetProbabilityEntity' ('AssessmentSectionEntityId' ASC)
;
...
CREATE INDEX 'IXFK_HydraulicBoundaryLocationCalculationsForTargetProbabilityHydraulicLocationCalculationEntity_HydraulicBoundaryLocationCalculationsForTargetProbabilityEntity'
 ON 'HydraulicBoundaryLocationCalculationsForTargetProbabilityHydraulicLocationCalculationEntity' ('HydraulicBoundaryLocationCalculationsForTargetProbabilityEntityId' ASC)
;
...
CREATE INDEX 'IXFK_HydraulicBoundaryLocationCalculationsForTargetProbabilityHydraulicLocationCalculationEntity_HydraulicLocationCalculationEntity'
 ON 'HydraulicBoundaryLocationCalculationsForTargetProbabilityHydraulicLocationCalculationEntity' ('HydraulicLocationCalculationEntityId' ASC)
;
CREATE TRIGGER [TR_AfterDeleteHydraulicBoundaryLocationCalculationsForTargetProbabilityEntity_RemoveHydraulicLocationCalculationEntity]
	AFTER DELETE
