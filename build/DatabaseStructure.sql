...
/*  Created On : 13-Jul-2017 2:06:57 PM 				*/
/*  DBMS       : SQLite 								*/
/* ---------------------------------------------------- */
...
CREATE TRIGGER [TR_AfterDeleteTopLevelFaultTreeIllustrationPointEntity_RemoveFaultTreeIllustrationPointEntity]
    ...
    FOR EACH ROW
BEGIN
    DELETE FROM FaultTreeIllustrationPointEntity
        WHERE OLD.FaultTreeIllustrationPointEntityId IS NOT NULL AND 
		FaultTreeIllustrationPointEntityId IS OLD.FaultTreeIllustrationPointEntityId;
END; 
;
