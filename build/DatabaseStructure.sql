...
/*  Created On : 07-dec-2021 15:20:56 				*/
/*  DBMS       : SQLite 								*/
/* ---------------------------------------------------- */
...
DROP TABLE IF EXISTS 'MicrostabilityOutwardsFailureMechanismMetaEntity'
;
...
CREATE TABLE 'MicrostabilityOutwardsFailureMechanismMetaEntity'
(
...
(
	...
	'InitialFailureMechanismResultType' TINYINT (1) NOT NULL,	-- Enum: Adopt = 1 Manual = 2 NoFailureProbablity = 3
...
CREATE INDEX 'IXFK_MicrostabilityFailureMechanismMetaEntity_FailureMechanismEntity'
 ON 'MicrostabilityOutwardsFailureMechanismMetaEntity' ('FailureMechanismEntityId' ASC)
;
