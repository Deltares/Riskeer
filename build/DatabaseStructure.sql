...
/*  Created On : 28-okt-2021 08:02:27 				*/
/*  DBMS       : SQLite 								*/
/* ---------------------------------------------------- */
...
DROP TABLE IF EXISTS 'SpecificFailurePathEntity'
;

DROP TABLE IF EXISTS 'SpecificFailurePathFailureMechanismSectionEntity'
;
...
(
	...
	'HydraulicLocationCalculationCollectionEntity1Id' INTEGER NOT NULL,	-- Represents the design water level signaling norm
	'HydraulicLocationCalculationCollectionEntity2Id' INTEGER NOT NULL,	-- Represents the design water level lower limit norm
	'Id' TEXT NULL,
...
(
	...
	CONSTRAINT 'FK_FailureMechanismSectionEntity_FailureMechanismEntity' FOREIGN KEY () REFERENCES  () ON DELETE Cascade ON UPDATE Cascade
)
;
...
(
	...
	'WaterLevelType' TINYINT (1) NOT NULL,	-- Enum: 1 = None, 2 = LowerLimit, 3 = Signaling, 4 = UserDefinedTargetProbability
...
CREATE TABLE 'SpecificFailurePathEntity'
(
	'SpecificFailurePathEntityId' INTEGER NOT NULL PRIMARY KEY,
	'AssessmentSectionEntityId' INTEGER NOT NULL,
	...
	'OutputComments' TEXT NULL,
	'NotRelevantComments' TEXT NULL,
	CONSTRAINT 'FK_SpecificFailurePathEntity_AssessmentSectionEntity' FOREIGN KEY ('AssessmentSectionEntityId') REFERENCES 'AssessmentSectionEntity' ('AssessmentSectionEntityId') ON DELETE No Action ON UPDATE No Action
)
;

CREATE TABLE 'SpecificFailurePathFailureMechanismSectionEntity'
(
	'SpecificFailurePathEntityId' INTEGER NOT NULL,
	'FailureMechanismSectionEntityId' INTEGER NOT NULL,
	CONSTRAINT 'PK_SpecificFailurePathFailureMechanismSectionEntity' PRIMARY KEY ('SpecificFailurePathEntityId','FailureMechanismSectionEntityId'),
	CONSTRAINT 'FK_SpecificFailurePathFailureMechanismSectionEntity_FailureMechanismSectionEntity' FOREIGN KEY ('FailureMechanismSectionEntityId') REFERENCES 'FailureMechanismSectionEntity' ('FailureMechanismSectionEntityId') ON DELETE Cascade ON UPDATE Cascade,
	CONSTRAINT 'FK_SpecificFailurePathFailureMechanismSectionEntity_SpecificFailurePathEntity' FOREIGN KEY ('SpecificFailurePathEntityId') REFERENCES 'SpecificFailurePathEntity' ('SpecificFailurePathEntityId') ON DELETE Cascade ON UPDATE Cascade
)
;
...
CREATE INDEX 'IXFK_FailureMechanismSectionEntity_FailureMechanismEntity'
 ON 'FailureMechanismSectionEntity' ()
;
...
;
CREATE TRIGGER [TR_AfterDeleteFailureMechanismEntity_RemoveFailureMechanismSectionEntityId]
	AFTER DELETE
	ON FailureMechanismEntity
	FOR EACH ROW
BEGIN
	DELETE 
...
;
CREATE TRIGGER [TR_AfterDeleteHydraulicLocationCalculationForTargetProbabilityCollectionEntity_RemoveHydraulicLocationCalculationEntity]
	AFTER DELETE
	ON HydraulicLocationCalculationForTargetProbabilityCollectionEntity
	FOR EACH ROW
BEGIN
	DELETE 
	FROM HydraulicLocationCalculationEntity
...
CREATE INDEX 'IXFK_SpecificFailurePathFailureMechanismSectionEntity_FailureMechanismSectionEntity'
 ON 'SpecificFailurePathFailureMechanismSectionEntity' ('FailureMechanismSectionEntityId' ASC)
;
CREATE TRIGGER [TR_AfterDeleteSpecificFailurePathEntity_RemoveFailureMechanismSectionEntityId]
	AFTER DELETE
	ON SpecificFailurePathEntity
	FOR EACH ROW
BEGIN
	DELETE 
	FROM FailureMechanismSectionEntity
