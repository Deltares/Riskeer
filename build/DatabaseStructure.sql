...
/*  Created On : 28-Jun-2017 08:44:13 				*/
/*  DBMS       : SQLite 								*/
/* ---------------------------------------------------- */
...
(
	...
	'ShouldWaterLevelIllustrationPointsBeCalculated' TINYINT (1) NOT NULL, -- true or false
	'Order' INT (4) NOT NULL,
...
(
	...
	'GrassCoverErosionOutwardsHydraulicLocationGeneralResultEntityId' INTEGER,
	'Name' TEXT NOT NULL,
