...
namespace Migration.Core.Storage
{
    ...
    /// </summary>
    public class MigrationDatabaseSourceFile : SqLiteDatabaseReaderBase
    {
        /// <summary>
        /// Creates a new instance of the <see cref="MigrationDatabaseSourceFile"/> class.
        /// </summary>
        ...
        /// </list>
        /// </exception>
        public MigrationDatabaseSourceFile(string databaseFilePath) : base(databaseFilePath) {}
