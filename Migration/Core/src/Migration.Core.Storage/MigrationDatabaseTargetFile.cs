...
namespace Migration.Core.Storage
{
    ...
    /// </summary>
    public class MigrationDatabaseTargetFile : IDisposable
    {
        private SQLiteConnection connection;
        private bool disposed;

        /// <summary>
        /// Creates a new instance of the <see cref="MigrationDatabaseTargetFile"/> class.
        /// </summary>
        ...
        /// </list></exception>
        public MigrationDatabaseTargetFile(string filePath)
        {
