...
{
    [TestFixture]
    public class TestUpgradeScriptTest
    {
        [Test]
        [TestCase("")]
        [TestCase(null)]
        public void Constructor_EmptyOrNullFromVersion_ThrowsArgumentException(string fromVersion)
        {
            // Call
        ...
        [TestCase("")]
        [TestCase(null)]
        public void Constructor_EmptyOrNullToVersion_ThrowsArgumentException(string toVersion)
        {
            // Call
            TestDelegate call = () => new TestUpgradeScript("fromVersion", toVersion);
