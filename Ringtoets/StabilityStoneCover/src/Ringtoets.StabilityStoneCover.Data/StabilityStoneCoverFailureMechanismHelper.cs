...
{
    /// <summary>
    /// Class containing helper methods for <see cref="StabilityStoneCoverFailureMechanism"/>.
    /// </summary>
    public static class StabilityStoneCoverFailureMechanismHelper
    {
        /// <summary>
        /// Determines if the failure mechanism has section assembly results that are manually overwritten.
        /// </summary>
        /// <param name="failureMechanism">The <see cref="StabilityStoneCoverFailureMechanism"/>.</param>
        ...
        public static bool HasManualAssemblyResults(StabilityStoneCoverFailureMechanism failureMechanism)
        {
