...
namespace Ringtoets.StabilityStoneCover.Forms.UITypeEditors
{
    ...
    /// </summary>
    public class StabilityStoneCoverWaveConditionsCalculationInputContextHydraulicBoundaryLocationEditor :
        SelectionEditor<StabilityStoneCoverWaveConditionsCalculationInputContextProperties, HydraulicBoundaryLocation>
    {
        /// <summary>
        /// Creates a new instance of <see cref="StabilityStoneCoverWaveConditionsCalculationInputContextHydraulicBoundaryLocationEditor"/>.
        /// </summary>
        public StabilityStoneCoverWaveConditionsCalculationInputContextHydraulicBoundaryLocationEditor()
        {
