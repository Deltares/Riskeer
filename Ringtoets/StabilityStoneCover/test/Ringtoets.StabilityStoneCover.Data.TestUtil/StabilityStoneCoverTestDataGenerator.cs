...
namespace Ringtoets.StabilityStoneCover.Data.TestUtil
{
    ...
    public static class StabilityStoneCoverTestDataGenerator
    {
        ...
        /// <summary>
        /// This method sets random data values to all properties of <paramref name="calculation"/>.
        /// </summary>
        /// <param name="calculation">The input to set the random data values to.</param>
        public static void SetRandomOutputToStoneCoverWaveConditoinsCalculation(StabilityStoneCoverWaveConditionsCalculation calculation)
        {
            calculation.Output = new StabilityStoneCoverWaveConditionsOutput(new[]
                                                                             {
