...
namespace Ringtoets.StabilityStoneCover.Data.Test
{
    ...
    public class StabilityStoneCoverFailureMechanismSectionResultAssemblyFactoryTest
    {
        ...
        {
            // Call
            TestDelegate call = () => StabilityStoneCoverFailureMechanismSectionResultAssemblyFactory.AssembleDetailedAssessment(null);
        ...
        public void AssembleDetailedAssessment_WithSectionResult_SetsInputOnCalculator()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                StabilityStoneCoverFailureMechanismSectionResultAssemblyFactory.AssembleDetailedAssessment(sectionResult);
        ...
        public void AssembleDetailedAssessment_CalculatorThrowsExceptions_ThrowsAssemblyException()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                TestDelegate call = () => StabilityStoneCoverFailureMechanismSectionResultAssemblyFactory.AssembleDetailedAssessment(sectionResult);
        ...
        {
            // Call
            TestDelegate call = () => StabilityStoneCoverFailureMechanismSectionResultAssemblyFactory.AssembleTailorMadeAssessment(null);
        ...
        public void AssembleTailorMadeAssessment_CalculatorThrowsExceptions_ThrowsAssemblyException()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                TestDelegate call = () => StabilityStoneCoverFailureMechanismSectionResultAssemblyFactory.AssembleTailorMadeAssessment(sectionResult);
        ...
        {
            // Call
            TestDelegate call = () => StabilityStoneCoverFailureMechanismSectionResultAssemblyFactory.AssembleFailureMechanism(null);
        ...
        public void AssembleFailureMechanism_WithoutManualInput_SetsInputOnCalculator()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                StabilityStoneCoverFailureMechanismSectionResultAssemblyFactory.AssembleFailureMechanism(sectionResults);

                // Assert
                FailureMechanismSectionAssemblyCategoryGroup assemblyCategory =
                    StabilityStoneCoverFailureMechanismSectionResultAssemblyFactory.AssembleCombinedAssessment(sectionResults.Single());
        ...
        public void AssembleFailureMechanism_WithManualInputConsiderManualAssemblyTrue_SetsInputOnCalculator()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Assert
                FailureMechanismSectionAssemblyCategoryGroup assemblyCategory =
                    StabilityStoneCoverFailureMechanismSectionResultAssemblyFactory.AssembleTailorMadeAssessment(sectionResults.Single());
                Assert.AreEqual(assemblyCategory, calculator.FailureMechanismSectionCategories.Single());
            }
        }
        ...
        public void AssembleFailureMechanism_WithManualInputConsiderManualAssemblyFalse_SetsInputOnCalculator()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                StabilityStoneCoverFailureMechanismSectionResultAssemblyFactory.AssembleFailureMechanism(sectionResults, false);
        ...
        public void AssembleFailureMechanism_AssemblyRan_ReturnsOutput()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                FailureMechanismAssemblyCategoryGroup actualOutput =
                    StabilityStoneCoverFailureMechanismSectionResultAssemblyFactory.AssembleFailureMechanism(
        ...
        public void AssembleFailureMechanism_FailureMechanismCalculatorThrowsException_ThrowsAssemblyException()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                TestDelegate call = () => StabilityStoneCoverFailureMechanismSectionResultAssemblyFactory.AssembleFailureMechanism(
                    Enumerable.Empty<StabilityStoneCoverFailureMechanismSectionResult>());
