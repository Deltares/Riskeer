...
namespace Ringtoets.StabilityStoneCover.Forms.Test.TreeNodeInfos
{
    ...
    public class StabilityStoneCoverWaveConditionsOutputTreeNodeInfoTest
    {
        ...
        public void SetUp()
        {
            ...
            info = plugin.GetTreeNodeInfos().First(tni => tni.TagType == typeof(StabilityStoneCoverWaveConditionsOutput));
        }
        ...
        public void Initialized_Always_ExpectedPropertiesSet()
        {
            ...
            // Assert
            Assert.AreEqual(typeof(StabilityStoneCoverWaveConditionsOutput), info.TagType);
