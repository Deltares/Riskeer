...
{
    [TestFixture]
    public class GrassCoverErosionOutwardsDesignWaterLevelCalculationsViewIntegrationTest
    {
        ...
        public void GivenDesignWaterLevelCalculationsView_WhenFailureMechanismContributionChanged_ThenButtonAndErrorMessageSyncedAccordingly(bool rowSelected,
                                                                                                                                             bool contributionAfterChangeNotZero,
                                                                                                                                             string expectedErrorMessage)
        {
            // Given
            GrassCoverErosionOutwardsDesignWaterLevelCalculationsView view = ShowFullyConfiguredDesignWaterLevelCalculationsView();
        ...
        private GrassCoverErosionOutwardsDesignWaterLevelCalculationsView ShowFullyConfiguredDesignWaterLevelCalculationsView()
        {
