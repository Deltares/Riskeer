...
namespace Ringtoets.GrassCoverErosionOutwards.Plugin.Test.TreeNodeInfos
{
    ...
    public class GrassCoverErosionOutwardsDesignWaterLevelLocationsContextTreeNodeInfoTest
    {
        ...
        public void CalculateDesignWaterLevelsFromContextMenu_Always_SendsRightInputToCalculationService()
        {
            ...
            IAssessmentSection assessmentSection = AssessmentSectionHelper.CreateAssessmentSectionStub(failureMechanism, mockRepository, filePath);
            HydraulicBoundaryLocation grassCoverErosionOutwardsHydraulicBoundaryLocation = assessmentSection.HydraulicBoundaryDatabase.Locations.First();
            ...
            using (var treeViewControl = new TreeViewControl())
            {
                ...
                using (var plugin = new GrassCoverErosionOutwardsPlugin())
                {
                    ...
                    using (new HydraRingCalculatorFactoryConfig())
                    {
                        ...
                        double expectedProbability = failureMechanism.GetMechanismSpecificNorm(assessmentSection);
