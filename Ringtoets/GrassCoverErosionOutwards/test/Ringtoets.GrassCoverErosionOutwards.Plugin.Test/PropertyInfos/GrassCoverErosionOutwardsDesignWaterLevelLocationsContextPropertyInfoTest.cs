...
namespace Ringtoets.GrassCoverErosionOutwards.Plugin.Test.PropertyInfos
{
    ...
    public class GrassCoverErosionOutwardsDesignWaterLevelLocationsContextPropertyInfoTest
    {
        ...
        [Test]
        public void CreateInstance_WithContext_SetsHydraulicBoundaryDatabaseAsData()
        {
            // Setup
            ...
            using (var plugin = new GrassCoverErosionOutwardsPlugin())
            {
                ...
                // Assert
                Assert.IsInstanceOf<GrassCoverErosionOutwardsDesignWaterLevelCalculationsProperties>(objectProperties);
