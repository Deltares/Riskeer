...
{
    [TestFixture]
    public class GrassCoverErosionOutwardsWaveHeightCalculationPropertiesTest
    {
        ...
        public void Constructor_ExpectedValues()
        {
            ...
            // Call
            var properties = new GrassCoverErosionOutwardsWaveHeightCalculationProperties(hydraulicBoundaryLocationCalculation);
        ...
        public void GetProperties_Always_ReturnsExpectedValues()
        {
            ...
            // Assert
            Assert.AreEqual(hydraulicBoundaryLocationCalculation.Output.Result, properties.WaveHeight);
