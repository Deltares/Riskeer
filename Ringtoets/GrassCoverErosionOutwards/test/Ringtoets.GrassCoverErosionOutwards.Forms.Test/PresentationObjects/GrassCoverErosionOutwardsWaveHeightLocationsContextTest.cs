...
{
    [TestFixture]
    public class GrassCoverErosionOutwardsWaveHeightLocationsContextTest
    {
        [Test]
        public void Constructor_GrassCoverErosionOutwardsHydraulicBoundaryLocationsIsNull_ThrowsArgumentNullException()
        {
            ...
            // Call
            TestDelegate call = () => new GrassCoverErosionOutwardsWaveHeightLocationsContext(null, assessmentSection, failureMechanism);
        ...
        public void Constructor_AssessmentSectionIsNull_ThrowsArgumentNullException()
        {
            ...
            // Call
            TestDelegate call = () => new GrassCoverErosionOutwardsWaveHeightLocationsContext(locations, null, failureMechanism);
        ...
        public void Constructor_GrassCoverErosionOutwardsFailureMechanismsIsNull_ThrowsArgumentNullException()
        {
            ...
            // Call
            TestDelegate call = () => new GrassCoverErosionOutwardsDesignWaterLevelLocationsContext(locations, assessmentSection, null);
        ...
        [Test]
        public void Constructor_WithAssessmentSectionsAndLocation_ExpectedValues()
        {
            // Setup
            ...
            // Call
            var presentationObject = new GrassCoverErosionOutwardsWaveHeightLocationsContext(locations, assessmentSection, failureMechanism);
