...
namespace Ringtoets.GrassCoverErosionOutwards.Data.Test
{
    ...
    public class GrassCoverErosionOutwardsFailureMechanismSectionResultAssemblyFactoryTest
    {
        ...
        {
            // Call
            TestDelegate call = () => GrassCoverErosionOutwardsFailureMechanismSectionResultAssemblyFactory.AssembleDetailedAssessment(null);
        ...
        public void AssembleDetailedAssessment_CalculatorThrowsExceptions_ThrowsAssemblyException()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                TestDelegate call = () => GrassCoverErosionOutwardsFailureMechanismSectionResultAssemblyFactory.AssembleDetailedAssessment(sectionResult);
        ...
        {
            // Call
            TestDelegate call = () => GrassCoverErosionOutwardsFailureMechanismSectionResultAssemblyFactory.AssembleTailorMadeAssessment(null);
        ...
        public void AssembleTailorMadeAssessment_CalculatorThrowsExceptions_ThrowsAssemblyException()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                TestDelegate call = () => GrassCoverErosionOutwardsFailureMechanismSectionResultAssemblyFactory.AssembleTailorMadeAssessment(sectionResult);
        ...
        {
            // Call
            TestDelegate call = () => GrassCoverErosionOutwardsFailureMechanismSectionResultAssemblyFactory.AssembleCombinedAssessment(
                null);
        ...
        public void AssembleCombinedAssessment_WithInput_SetsInputOnCalculator()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                GrassCoverErosionOutwardsFailureMechanismSectionResultAssemblyFactory.AssembleCombinedAssessment(
                    sectionResult);

                // Assert
                FailureMechanismSectionAssemblyCategoryGroup expectedSimpleAssembly = GrassCoverErosionOutwardsFailureMechanismSectionResultAssemblyFactory.AssembleSimpleAssessment(
                    sectionResult);
                FailureMechanismSectionAssemblyCategoryGroup expectedDetailedAssembly = GrassCoverErosionOutwardsFailureMechanismSectionResultAssemblyFactory.AssembleDetailedAssessment(
                    sectionResult);
                FailureMechanismSectionAssemblyCategoryGroup expectedTailorMadeAssembly = GrassCoverErosionOutwardsFailureMechanismSectionResultAssemblyFactory.AssembleTailorMadeAssessment(
                    sectionResult);
        ...
        {
            // Call
            TestDelegate call = () => GrassCoverErosionOutwardsFailureMechanismSectionResultAssemblyFactory.AssembleFailureMechanism(null);
        ...
        public void AssembleFailureMechanism_WithoutManualInput_SetsInputOnCalculator()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                GrassCoverErosionOutwardsFailureMechanismSectionResultAssemblyFactory.AssembleFailureMechanism(sectionResults);

                // Assert
                FailureMechanismSectionAssemblyCategoryGroup assemblyCategory =
                    GrassCoverErosionOutwardsFailureMechanismSectionResultAssemblyFactory.AssembleCombinedAssessment(sectionResults.Single());
        ...
        public void AssembleFailureMechanism_WithManualInputConsiderManualAssemblyTrue_SetsInputOnCalculator()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Assert
                FailureMechanismSectionAssemblyCategoryGroup assemblyCategory =
                    GrassCoverErosionOutwardsFailureMechanismSectionResultAssemblyFactory.AssembleTailorMadeAssessment(sectionResults.Single());
                Assert.AreEqual(assemblyCategory, calculator.FailureMechanismSectionCategories.Single());
            }
        }
        ...
        public void AssembleFailureMechanism_WithManualInputConsiderManualAssemblyFalse_SetsInputOnCalculator()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                GrassCoverErosionOutwardsFailureMechanismSectionResultAssemblyFactory.AssembleFailureMechanism(sectionResults, false);
        ...
        public void AssembleFailureMechanism_AssemblyRan_ReturnsOutput()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                FailureMechanismAssemblyCategoryGroup actualOutput =
                    GrassCoverErosionOutwardsFailureMechanismSectionResultAssemblyFactory.AssembleFailureMechanism(
                        Enumerable.Empty<GrassCoverErosionOutwardsFailureMechanismSectionResult>());
        ...
        public void AssembleFailureMechanism_FailureMechanismCalculatorThrowsException_ThrowsAssemblyException()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                TestDelegate call = () => GrassCoverErosionOutwardsFailureMechanismSectionResultAssemblyFactory.AssembleFailureMechanism(
                    Enumerable.Empty<GrassCoverErosionOutwardsFailureMechanismSectionResult>());
