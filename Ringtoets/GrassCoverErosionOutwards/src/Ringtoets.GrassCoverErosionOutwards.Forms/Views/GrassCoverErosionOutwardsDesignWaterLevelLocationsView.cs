...
namespace Ringtoets.GrassCoverErosionOutwards.Forms.Views
{
    ...
    /// </summary>
    public class GrassCoverErosionOutwardsDesignWaterLevelLocationsView : HydraulicBoundaryCalculationsView
    {
        ...
        public GrassCoverErosionOutwardsDesignWaterLevelLocationsView(ObservableList<HydraulicBoundaryLocationCalculation> calculations,
