...
namespace Ringtoets.GrassCoverErosionOutwards.Forms.PropertyClasses
{
    ...
    public class GrassCoverErosionOutwardsDesignWaterLevelLocationsProperties : HydraulicBoundaryLocationsProperties
    {
        ...
        public GrassCoverErosionOutwardsDesignWaterLevelLocationsProperties(ObservableList<HydraulicBoundaryLocationCalculation> hydraulicBoundaryLocationCalculations)
        ...
        public GrassCoverErosionOutwardsDesignWaterLevelLocationProperties[] Locations
        {
            get
            {
                return data.Select(calculation => new GrassCoverErosionOutwardsDesignWaterLevelLocationProperties(calculation)).ToArray();
            }
        }
    }
}