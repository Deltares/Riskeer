...
namespace Ringtoets.GrassCoverErosionOutwards.Forms.PresentationObjects
{
    ...
    {
        /// <summary>
        /// Creates a new instance of <see cref="GrassCoverErosionOutwardsDesignWaterLevelCalculationContext"/>.
        /// </summary>
        /// <param name="wrappedData">The <see cref="HydraulicBoundaryLocationCalculation"/> which the
        /// <see cref="GrassCoverErosionOutwardsDesignWaterLevelCalculationContext"/> belongs to.</param>
