...
namespace Ringtoets.GrassCoverErosionOutwards.Forms.PresentationObjects
{
    ...
    /// </summary>
    public class GrassCoverErosionOutwardsWaveHeightCalculationContext : HydraulicBoundaryLocationCalculationContext
    {
        /// <summary>
        /// Creates a new instance of <see cref="GrassCoverErosionOutwardsWaveHeightCalculationContext"/>.
        /// </summary>
        /// <param name="wrappedData">The <see cref="HydraulicBoundaryLocationCalculation"/> which the
        /// <see cref="GrassCoverErosionOutwardsWaveHeightCalculationContext"/> belongs to.</param>
        /// <exception cref="ArgumentNullException">Thrown when <paramref name="wrappedData"/> is <c>null</c>.</exception>
        public GrassCoverErosionOutwardsWaveHeightCalculationContext(HydraulicBoundaryLocationCalculation wrappedData)
            : base(wrappedData) {}
    }
}