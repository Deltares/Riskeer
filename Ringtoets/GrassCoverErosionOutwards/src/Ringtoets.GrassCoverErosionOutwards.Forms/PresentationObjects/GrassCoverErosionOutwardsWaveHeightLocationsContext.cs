...
namespace Ringtoets.GrassCoverErosionOutwards.Forms.PresentationObjects
{
    ...
    /// </summary>
    public class GrassCoverErosionOutwardsWaveHeightLocationsContext : ObservableWrappedObjectContextBase<ObservableList<HydraulicBoundaryLocationCalculation>>
    {
        /// <summary>
