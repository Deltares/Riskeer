...
namespace Ringtoets.GrassCoverErosionOutwards.Service.MessageProviders
{
    ...
    public class GrassCoverErosionOutwardsDesignWaterLevelCalculationMessageProvider : ICalculationMessageProvider
    {
        ...
        {
            return string.Format(Resources.GrassCoverErosionOutwardsPlugin_Calculate_Error_in_DesignWaterLevel_0_calculation_click_details_for_last_error_report_1, locationName, failureMessage);
        }

        public string GetCalculationFailedUnexplainedMessage(string locationName)
        {
            return string.Format(Resources.GrassCoverErosionOutwardsPlugin_Calculate_Error_in_DesignWaterLevel_0_calculation_no_error_report, locationName);
        }
