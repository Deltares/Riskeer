...
{
    [TestFixture]
    public class GrassCoverErosionInwardsFailureMechanismHelperTest
    {
        [Test]
        public void HasManualAssemblyResults_FailureMechanismNull_ThrowsArgumentNullException()
        {
            // Call
            TestDelegate call = () => GrassCoverErosionInwardsFailureMechanismHelper.HasManualAssemblyResults(null);
