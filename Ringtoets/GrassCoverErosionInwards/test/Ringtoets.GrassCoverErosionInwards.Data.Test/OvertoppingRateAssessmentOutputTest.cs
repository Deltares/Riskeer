...
{
    [TestFixture]
    public class OvertoppingRateAssessmentOutputTest
    {
        [Test]
        [SetCulture("nl-NL")]
        [TestCase(-0.01)]
        ...
        public void Constructor_InvalidTargetProbability_ThrowsArgumentOutOfRangeException(double targetProbability)
        {
            ...
            // Call
            TestDelegate call = () => new OvertoppingRateAssessmentOutput(overtoppingRate, targetProbability,
                                                                          targetReliability,
        ...
        public void Constructor_ValidInput_ExpectedProperties(double targetProbability, double calculatedProbability)
        {
            ...
            // Call
            var output = new OvertoppingRateAssessmentOutput(overtoppingRate, targetProbability,
                                                             targetReliability,
                                                             calculatedProbability,
                                                             calculatedReliability,
                                                             convergence);
