...
{
    [TestFixture]
    public class GrassCoverErosionInwardsFailureMechanismContextPropertyInfoTest
    {
        ...
        public void SetUp()
        {
            ...
            info = plugin.GetPropertyInfos().First(tni => tni.PropertyObjectType == typeof(GrassCoverErosionInwardsFailureMechanismContextProperties));
        }
        ...
        public void Initialized_Always_ExpectedPropertiesSet()
        {
            ...
            Assert.AreEqual(typeof(GrassCoverErosionInwardsFailureMechanismContextProperties), info.PropertyObjectType);
        }
