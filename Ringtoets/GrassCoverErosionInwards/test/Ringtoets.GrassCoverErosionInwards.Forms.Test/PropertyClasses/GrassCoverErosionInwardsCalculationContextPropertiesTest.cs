...
namespace Ringtoets.GrassCoverErosionInwards.Forms.Test.PropertyClasses
{
    ...
    public class GrassCoverErosionInwardsCalculationContextPropertiesTest
    {
        ...
        public void Data_SetNewCalculationContextInstance_ReturnCorrectPropertyValues()
        {
            ...
            var calculationMock = mockRepository.StrictMock<GrassCoverErosionInwardsCalculation>(new GeneralGrassCoverErosionInwardsInput(), new ProbabilityAssessmentInput());
