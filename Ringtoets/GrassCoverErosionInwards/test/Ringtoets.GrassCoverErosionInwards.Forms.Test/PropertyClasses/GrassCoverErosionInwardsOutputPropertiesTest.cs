...
namespace Ringtoets.GrassCoverErosionInwards.Forms.Test.PropertyClasses
{
    ...
    public class GrassCoverErosionInwardsOutputPropertiesTest
    {
        ...
        {
            // Setup
            var data = new TestGrassCoverErosionInwardsOutput();

            // Call
            var properties = new GrassCoverErosionInwardsOutputProperties(data);
        ...
        [Test]
        public void Constructor_WithDataSet_ReturnCorrectPropertyValues()
        {
            // Setup
            ...
            var probabilityAssessmentOutput = new ProbabilityAssessmentOutput(requiredProbability,
                                                                              ...
                                                                              reliability,
                                                                              factorOfSafety);
            var resultOutput = new GrassCoverErosionInwardsOvertoppingOutput(waveHeight,
        ...
        public void PropertyAttributes_WithDikeHeightAndOvertoppingRateCalculated_ReturnExpectedValues()
        {
            ...
            var resultOutput = new GrassCoverErosionInwardsOvertoppingOutput(10,
                                                                             true,
                                                                             probabilityAssessmentOutput);
                                                                                                      ...
                                                                                                      bool overtoppingRateCalculated)
        {
            ...
            var resultOutput = new GrassCoverErosionInwardsOvertoppingOutput(2,
                                                                             true,
                                                                             probabilityAssessmentOutput);
