...
namespace Ringtoets.GrassCoverErosionInwards.Forms.Test.PresentationObjects
{
    ...
    public class GrassCoverErosionInwardsFailureMechanismContextTest
    {
        ...
        public void Constructor_ExpectedValues()
        {
            ...
            // Call
            var context = new GrassCoverErosionInwardsFailureMechanismContext(failureMechanism, assessmentSectionMock);
        ...
        public void Constructor_AssessmentSectionIsNull_ThrowsArgumentNullException()
        {
            ...
            // Call
            TestDelegate call = () => new GrassCoverErosionInwardsFailureMechanismContext(failureMechanism, null);
