...
{
    /// <summary>
    /// Class containing helper methods for <see cref="DuneErosionFailureMechanism"/>.
    /// </summary>
    public static class DuneErosionFailureMechanismHelper
    {
        /// <summary>
        /// Determines if the failure mechanism has section assembly results that are manually overwritten.
        /// </summary>
        /// <param name="failureMechanism">The <see cref="DuneErosionFailureMechanism"/>.</param>
        ...
        public static bool HasManualAssemblyResults(DuneErosionFailureMechanism failureMechanism)
        {
