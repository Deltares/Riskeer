...
namespace Ringtoets.DuneErosion.Plugin.Test.UpdateInfos
{
    [TestFixture]
    public class DuneErosionFailureMechanismSectionsContextUpdateInfoTest
    {
        [Test]
        ...
        private static UpdateInfo GetUpdateInfo(DuneErosionPlugin plugin)
        {
            return plugin.GetUpdateInfos().First(ii => ii.DataType == typeof(DuneErosionFailureMechanismSectionsContext));
        }
    }
}