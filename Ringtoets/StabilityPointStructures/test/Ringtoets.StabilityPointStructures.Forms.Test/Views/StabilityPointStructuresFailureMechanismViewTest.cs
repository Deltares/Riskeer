...
namespace Ringtoets.StabilityPointStructures.Forms.Test.Views
{
    ...
    public class StabilityPointStructuresFailureMechanismViewTest
    {
        ...
        public void Data_StabilityPointStructuresFailureMechanismContext_DataSet()
        {
            ...
            using (var view = new StabilityPointStructuresFailureMechanismView())
            {
                var failureMechanismContext = new StabilityPointStructuresFailureMechanismContext(new StabilityPointStructuresFailureMechanism(), new TestAssessmentSection());
        ...
        public void Data_StabilityPointStructuresFailureMechanismContext_DataUpdatedToCollectionOfFilledMapData()
        {
            ...
            using (var view = new StabilityPointStructuresFailureMechanismView())
            {
                ...
                MapDataTestHelper.AssertHydraulicBoundaryLocationsMapData(assessmentSection.HydraulicBoundaryDatabase, mapDataList[hydraulicBoundaryLocationsIndex]);
        ...
        public void UpdateObserver_AssessmentSectionUpdated_MapDataUpdated()
        {
            ...
            using (var view = new StabilityPointStructuresFailureMechanismView())
            {
                ...
                // Precondition
                MapDataTestHelper.AssertHydraulicBoundaryLocationsMapData(hydraulicBoundaryDatabase1, hydraulicBoundaryLocationsMapData);
                ...
                // Assert
                MapDataTestHelper.AssertHydraulicBoundaryLocationsMapData(hydraulicBoundaryDatabase2, hydraulicBoundaryLocationsMapData);
            }
        }
        ...
        public void UpdateObserver_HydraulicBoundaryDatabaseUpdated_MapDataUpdated()
        {
            ...
            using (var view = new StabilityPointStructuresFailureMechanismView())
            {
                ...
                // Precondition
                MapDataTestHelper.AssertHydraulicBoundaryLocationsMapData(hydraulicBoundaryDatabase, hydraulicBoundaryLocationsMapData);
        ...
        public void UpdateObserver_FailureMechanismSectionsUpdated_MapDataUpdated()
        {
            ...
            using (var view = new StabilityPointStructuresFailureMechanismView())
            {
                ...
                var failureMechanism = new StabilityPointStructuresFailureMechanism();
                var failureMechanismContext = new StabilityPointStructuresFailureMechanismContext(failureMechanism, new TestAssessmentSection());
