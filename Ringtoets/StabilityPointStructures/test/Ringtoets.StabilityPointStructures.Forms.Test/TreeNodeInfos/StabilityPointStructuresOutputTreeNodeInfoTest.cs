...
{
    [TestFixture]
    public class StabilityPointStructuresOutputTreeNodeInfoTest
    {
        ...
        public void SetUp()
        {
            ...
            info = plugin.GetTreeNodeInfos().First(tni => tni.TagType == typeof(StabilityPointStructuresOutput));
        }
        ...
        public void Initialized_Always_ExpectedPropertiesSet()
        {
            ...
            // Assert
            Assert.AreEqual(typeof(StabilityPointStructuresOutput), info.TagType);
