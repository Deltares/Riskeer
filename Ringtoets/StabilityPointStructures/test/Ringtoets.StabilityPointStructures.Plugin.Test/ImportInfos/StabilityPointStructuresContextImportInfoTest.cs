...
namespace Ringtoets.StabilityPointStructures.Plugin.Test.ImportInfos
{
    ...
    public class StabilityPointStructuresContextImportInfoTest
    {
        ...
        public void CreateFileImporter_Always_ExpectedPropertiesSet()
        {
            ...
            var list = new ObservableList<StabilityPointStructure>();

            var importTarget = new StabilityPointStructuresContext(list, assessmentSectionMock);
        ...
        public void IsEnabled_ReferenceLineSet_ReturnTrue()
        {
            ...
            var context = new StabilityPointStructuresContext(list, assessmentSectionMock);
