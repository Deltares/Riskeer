...
{
    /// <summary>
    /// Assembly category boundaries calculator stub for testing purposes.
    /// </summary>
    public class AssemblyCategoryBoundariesCalculatorStub : IAssemblyCategoryBoundariesCalculator
    {
        /// <summary>
