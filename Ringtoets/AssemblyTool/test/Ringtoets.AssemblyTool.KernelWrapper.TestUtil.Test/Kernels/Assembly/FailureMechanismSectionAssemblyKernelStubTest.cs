...
namespace Ringtoets.AssemblyTool.KernelWrapper.TestUtil.Test.Kernels.Assembly
{
    ...
    public class FailureMechanismSectionAssemblyKernelStubTest
    {
        ...
        public void TranslateAssessmentResultWbi0G5_ThrowExceptionsFalse_InputCorrectlySetToKernelAndCalculatedTrue()
        {
            ...
            // Call
            kernel.TranslateAssessmentResultWbi0G5(assessmentSection, failureMechanism, lengthEffect, assessmentResult, failureProbability);
        ...
        public void TranslateAssessmentResultWbi0G5_ThrowExceptionsFalse_ReturnFailureMechanismSectionAssemblyResult()
        {
            ...
            // Call
            FmSectionAssemblyDirectResult result = kernel.TranslateAssessmentResultWbi0G5(assessmentSection,
                                                                                          failureMechanism,
                                                                                          lengthEffect,
                                                                                          assessmentResult,
                                                                                          failureProbability);
