...
namespace Ringtoets.AssemblyTool.KernelWrapper.TestUtil.Test.Kernels.Assembly
{
    ...
    public class FailureMechanismSectionAssemblyKernelStubTest
    {
        ...
        public void TranslateAssessmentResultWbi0T3_KernelDoesNotThrowException_InputCorrectlySetToKernelAndCalculatedTrue()
        {
            ...
            // Call
            kernel.TranslateAssessmentResultWbi0T3(assessmentResult, failureProbability, categories);
        ...
        public void TranslateAssessmentResultWbi0T3_KernelDoesNotThrowException_ReturnFailureMechanismSectionAssemblyResult()
        {
            ...
            // Call
            FmSectionAssemblyDirectResultWithProbability result = kernel.TranslateAssessmentResultWbi0T3(assessmentResult,
                                                                                                         failureProbability,
                                                                                                         categories);
        ...
        public void TranslateAssessmentResultWbi0T3_ThrowExceptionOnCalculateTrue_ThrowsException()
        {
            ...
            // Call
            TestDelegate test = () => kernel.TranslateAssessmentResultWbi0T3(assessmentResult,
                                                                             failureProbability,
                                                                             categories);
        ...
        public void TranslateAssessmentResultWbi0T5_KernelDoesNotThrowException_InputCorrectlySetToKernelAndCalculatedTrue()
        {
            ...
            // Call
            kernel.TranslateAssessmentResultWbi0T5(lengthEffect, assessmentResult, failureProbability, categories);
        ...
        public void TranslateAssessmentResultWbi0T5_KernelDoesNotThrowException_ReturnFailureMechanismSectionAssemblyResult()
        {
            ...
            // Call
            FmSectionAssemblyDirectResult result = kernel.TranslateAssessmentResultWbi0T5(lengthEffect,
                                                                                          assessmentResult,
                                                                                          failureProbability,
                                                                                          categories);
        ...
        public void TranslateAssessmentResultWbi0T5_ThrowExceptionOnCalculateTrue_ThrowsException()
        {
            ...
            // Call
            TestDelegate test = () => kernel.TranslateAssessmentResultWbi0T5(lengthEffect,
                                                                             assessmentResult,
                                                                             failureProbability,
                                                                             categories);
        ...
        public void TranslateAssessmentResultWbi0T7_KernelDoesNotThrowException_InputCorrectlySetToKernelAndCalculatedTrue()
        {
            ...
            // Call
            kernel.TranslateAssessmentResultWbi0T7(assessmentResult, failureProbability, categories);
        ...
        public void TranslateAssessmentResultWbi0T7_KernelDoesNotThrowException_ReturnFailureMechanismSectionAssemblyResult()
        {
            ...
            // Call
            FmSectionAssemblyDirectResult result = kernel.TranslateAssessmentResultWbi0T7(assessmentResult,
                                                                                          failureProbability,
                                                                                          categories);
        ...
        public void TranslateAssessmentResultWbi0T7_ThrowExceptionOnCalculateTrue_ThrowsException()
        {
            ...
            // Call
            TestDelegate test = () => kernel.TranslateAssessmentResultWbi0T7(assessmentResult,
                                                                             failureProbability,
                                                                             categories);
        ...
        public void TranslateAssessmentResultWbi0A1_WithDirectResultAndThrowExceptionsFalse_InputCorrectlySetToKernelAndCalculatedTrue()
        {
            ...
            var simpleAssemblyResult = new FmSectionAssemblyDirectResult(random.NextEnumValue<EFmSectionCategory>());
            var detailedAssemblyResult = new FmSectionAssemblyDirectResult(random.NextEnumValue<EFmSectionCategory>());
            var tailorMadeAssemblyResult = new FmSectionAssemblyDirectResult(random.NextEnumValue<EFmSectionCategory>());
        ...
        public void TranslateAssessmentResultWbi0A1_WithDirectResultAndThrowExceptionsFalse_ReturnFailureMechanismSectionAssemblyResult()
        {
            ...
            // Call
            FmSectionAssemblyDirectResult result = kernel.TranslateAssessmentResultWbi0A1(
        ...
        public void TranslateAssessmentResultWbi0A1_WithDirectResultAndThrowExceptionOnCalculateTrue_ThrowsException()
        {
            ...
            TestDelegate test = () => kernel.TranslateAssessmentResultWbi0A1(
                new FmSectionAssemblyDirectResult(random.NextEnumValue<EFmSectionCategory>()),
                new FmSectionAssemblyDirectResult(random.NextEnumValue<EFmSectionCategory>()),
                new FmSectionAssemblyDirectResult(random.NextEnumValue<EFmSectionCategory>()));
        ...
        [Test]
        public void TranslateAssessmentResultWbi0A1WithProbability_WithDirectResultAndThrowExceptionsFalse_InputCorrectlySetToKernelAndCalculatedTrue()
        {
            // Setup
            var random = new Random(11);
            var simpleAssemblyResult = new FmSectionAssemblyDirectResultWithProbability(random.NextEnumValue<EFmSectionCategory>(),
                                                                                        random.NextDouble());
            var detailedAssemblyResult = new FmSectionAssemblyDirectResultWithProbability(random.NextEnumValue<EFmSectionCategory>(),
                                                                                          random.NextDouble());
            var tailorMadeAssemblyResult = new FmSectionAssemblyDirectResultWithProbability(random.NextEnumValue<EFmSectionCategory>(),
                                                                                            random.NextDouble());
            ...
            // Assert
            Assert.AreSame(simpleAssemblyResult, kernel.SimpleAssessmentResultInputWithProbability);
            Assert.AreSame(detailedAssemblyResult, kernel.DetailedAssessmentResultInputWithProbability);
            Assert.AreSame(tailorMadeAssemblyResult, kernel.TailorMadeAssessmentResultInputWithProbability);
            Assert.IsTrue(kernel.Calculated);
        }

        [Test]
        public void TranslateAssessmentResultWbi0A1WithProbability_WithDirectResultAndThrowExceptionsFalse_ReturnFailureMechanismSectionAssemblyResult()
        {
            // Setup
            var random = new Random(11);
            var simpleAssemblyResult = new FmSectionAssemblyDirectResultWithProbability(random.NextEnumValue<EFmSectionCategory>(),
            ...
            // Call
            FmSectionAssemblyDirectResultWithProbability result = kernel.TranslateAssessmentResultWbi0A1(
                simpleAssemblyResult, detailedAssemblyResult, tailorMadeAssemblyResult);
        ...
        [Test]
        public void TranslateAssessmentResultWbi0A1WithProbability_WithDirectResultAndThrowExceptionOnCalculateTrue_ThrowsException()
        {
            // Setup
            var random = new Random(11);
            var kernel = new FailureMechanismSectionAssemblyKernelStub
            ...
            // Call
            TestDelegate test = () => kernel.TranslateAssessmentResultWbi0A1(
                new FmSectionAssemblyDirectResultWithProbability(random.NextEnumValue<EFmSectionCategory>(), random.NextDouble()),
                new FmSectionAssemblyDirectResultWithProbability(random.NextEnumValue<EFmSectionCategory>(), random.NextDouble()),
                new FmSectionAssemblyDirectResultWithProbability(random.NextEnumValue<EFmSectionCategory>(), random.NextDouble()));
        ...
        [Test]
        public void TranslateAssessmentResultWbi0A1WithIndirectResult_Always_ThrowsNotImplementedException()
        {
            // Setup
            var kernel = new FailureMechanismSectionAssemblyKernelStub();

            // Call
            TestDelegate call = () => kernel.TranslateAssessmentResultWbi0A1((FmSectionAssemblyIndirectResult) null, null, null);
