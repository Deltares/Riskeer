...
{
    /// <summary>
    /// Factory that creates kernels that wrap the assembly tool kernel.
    /// </summary>
    public class AssemblyToolKernelWrapperFactory : IAssemblyToolKernelFactory
    {
        private static IAssemblyToolKernelFactory instance;

        private AssemblyToolKernelWrapperFactory() {}
