...
namespace Ringtoets.MacroStabilityInwards.KernelWrapper.Kernels.UpliftVan
{
    ...
    public class UpliftVanKernelWrapperException : Exception
    {
        ...
        /// </summary>
        /// <param name="messages">The error messages that explains the reason for the exception.</param>
        public UpliftVanKernelWrapperException(IEnumerable<string> messages)
        {
            Messages = messages;
        }
