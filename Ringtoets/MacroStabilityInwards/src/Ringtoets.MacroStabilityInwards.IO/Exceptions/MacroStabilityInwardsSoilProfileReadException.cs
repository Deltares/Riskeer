...
namespace Ringtoets.MacroStabilityInwards.IO.Exceptions
{
    ...
    public sealed class MacroStabilityInwardsSoilProfileReadException : Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MacroStabilityInwardsSoilProfileReadException"/> class.
        /// </summary>
        public MacroStabilityInwardsSoilProfileReadException() {}
        ...
        public MacroStabilityInwardsSoilProfileReadException(string message) : base(message) {}
        ...
        public MacroStabilityInwardsSoilProfileReadException(string message, string profileName)
            : base(message)
        {
        ...
        public MacroStabilityInwardsSoilProfileReadException(string message, Exception inner)
            : base(message, inner) {}

        /// <summary>
        /// Initializes a new instance of the <see cref="MacroStabilityInwardsSoilProfileReadException"/> class with a specified error message 
        ...
        /// or <c>null</c> if no inner exception is specified.</param>
        public MacroStabilityInwardsSoilProfileReadException(string message, string profileName, Exception innerException)
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="MacroStabilityInwardsSoilProfileReadException"/> with
        ...
        private MacroStabilityInwardsSoilProfileReadException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
