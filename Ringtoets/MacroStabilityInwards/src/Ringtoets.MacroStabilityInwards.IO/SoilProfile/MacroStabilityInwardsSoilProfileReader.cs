...
namespace Ringtoets.MacroStabilityInwards.IO.SoilProfile
{
    ...
    {
        private const string mechanismName = "Piping";
        private const string mechanismParameterName = "mechanism";

        private IDataReader dataReader;

        /// <summary>
        /// Creates a new instance of <see cref="MacroStabilityInwardsSoilProfileReader"/> which will use the <paramref name="databaseFilePath"/>
        ...
        /// </list>
        /// </exception>
        public MacroStabilityInwardsSoilProfileReader(string databaseFilePath) : base(databaseFilePath)
        {
        ...
        /// the <see cref="MacroStabilityInwardsSoilProfileReader"/>.
        /// </summary>
        ...
        public MacroStabilityInwardsSoilProfile ReadProfile()
        {
            ...
            try
            {
                return ReadMacroStabilityInwardsSoilProfile();
            }
            catch (InvalidCastException e)
            {
                string message = new FileReaderErrorMessageBuilder(Path).Build(Resources.MacroStabilityInwardsSoilProfileReader_Critical_Unexpected_value_on_column);
        ...
        /// </summary>
        /// <exception cref="MacroStabilityInwardsSoilProfileReadException">Thrown when the amount of profiles in database could not be read.</exception>
