    ...
    internal class CriticalProfileProperties
    {
        ...
        internal CriticalProfileProperties(IRowBasedDatabaseReader reader)
        {
            ...
            catch (InvalidCastException e)
            {
                ...
                {
                    messageBuilder.WithSubject(string.Format(Resources.MacroStabilityInwardsSoilProfileReader_SoilProfileName_0_, ProfileName));
                }
                string message = messageBuilder.Build(Resources.MacroStabilityInwardsSoilProfileReader_Critical_Unexpected_value_on_column);
