...
namespace Ringtoets.MacroStabilityInwards.IO.SoilProfile
{
    ...
    internal static class SoilProfile1DReader
    {
        ...
        internal static MacroStabilityInwardsSoilProfile ReadFrom(IRowBasedDatabaseReader reader)
        {
            ...
            try
            {
                for (var i = 1; i <= criticalProperties.LayerCount; i++)
                {
                    ...
                    soilProfileBuilder.Add(soilLayer.AsMacroStabilityInwardsSoilLayer());
                    reader.MoveNext();
                }
        ...
        /// </summary>
        /// <exception cref="MacroStabilityInwardsSoilProfileReadException">Thrown when reading properties of the layers failed.</exception>
