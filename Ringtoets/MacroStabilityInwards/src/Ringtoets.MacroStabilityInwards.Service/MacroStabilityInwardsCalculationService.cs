        ...
        private static UpliftVanCalculatorInput CreateInputFromData(MacroStabilityInwardsInput inputParameters)
        {
            return new UpliftVanCalculatorInput(
                new UpliftVanCalculatorInput.ConstructionProperties
                {
                    ...
                    PhreaticLineOffsets = UpliftVanPhreaticLineOffsetsConverter.Convert(inputParameters.LocationInputExtreme),
                    ...
                    WaterLevelPolder = inputParameters.LocationInputExtreme.WaterLevelPolder,
                    ...
                    PenetrationLength = inputParameters.LocationInputExtreme.PenetrationLength,
