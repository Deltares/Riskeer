        ...
        private static UpliftVanCalculatorInput CreateInputFromData(MacroStabilityInwardsInput inputParameters)
        {
            return new UpliftVanCalculatorInput(
                new UpliftVanCalculatorInput.ConstructionProperties
                {
                    ...
                    PhreaticLineOffsetBelowDikeTopAtRiver = !inputParameters.UseDefaultOffsets ? inputParameters.PhreaticLineOffsetBelowDikeTopAtRiver : double.NaN,
                    PhreaticLineOffsetBelowDikeTopAtPolder = !inputParameters.UseDefaultOffsets ? inputParameters.PhreaticLineOffsetBelowDikeTopAtPolder : double.NaN,
                    PhreaticLineOffsetBelowShoulderBaseInside = !inputParameters.UseDefaultOffsets ? inputParameters.PhreaticLineOffsetBelowShoulderBaseInside : double.NaN,
                    PhreaticLineOffsetBelowDikeToeAtPolder = !inputParameters.UseDefaultOffsets ? inputParameters.PhreaticLineOffsetBelowDikeToeAtPolder : double.NaN,
