...
{
    [TestFixture]
    public class TestMacroStabilityInwardsFailureMechanismTest
    {
        [Test]
        public void Constructor_ExpectedValues()
        {
            ...
            // Assert
            Assert.IsInstanceOf<MacroStabilityInwardsFailureMechanism>(failureMechanism);
        ...
        {
            // Call
            TestMacroStabilityInwardsFailureMechanism failureMechanism = TestMacroStabilityInwardsFailureMechanism.GetFailureMechanismWithSurfaceLinesAndStochasticSoilModels();
