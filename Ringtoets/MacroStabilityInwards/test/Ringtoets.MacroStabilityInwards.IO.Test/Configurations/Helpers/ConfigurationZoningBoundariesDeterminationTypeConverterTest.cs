...
namespace Ringtoets.MacroStabilityInwards.IO.Test.Configurations.Helpers
{
    ...
    public class ConfigurationZoningBoundariesDeterminationTypeConverterTest
    {
        ...
        public void ConvertTo_InvalidCases_ThrowsNotSupportedException(ConfigurationZoningBoundariesDeterminationType invalidValue,
                                                                       Type convertToType)
        {
            // Setup
            var converter = new ConfigurationZoningBoundariesDeterminationTypeConverter();
        ...
        {
            yield return new TestCaseData((ConfigurationZoningBoundariesDeterminationType) 99999,
                                          typeof(string))
                .SetName(testName);
        ...
        private static IEnumerable<TestCaseData> InvalidConvertFrom(string testName)
        {
            ...
            yield return new TestCaseData((MacroStabilityInwardsZoningBoundariesDeterminationType) 99999)
                .SetName(testName);
