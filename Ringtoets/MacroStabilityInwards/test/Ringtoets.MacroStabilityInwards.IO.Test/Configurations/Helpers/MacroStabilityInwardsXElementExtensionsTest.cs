...
namespace Ringtoets.MacroStabilityInwards.IO.Test.Configurations.Helpers
{
    ...
    public class MacroStabilityInwardsXElementExtensionsTest
    {
        ...
        #region GetMacroStabilityInwardsPhreaticLineConfiguration

        [Test]
        public void GetMacroStabilityInwardsPhreaticLineConfiguration_XElementNameNull_ThrowArgumentNullException()
        {
            // Call
            TestDelegate test = () => ((XElement) null).GetMacroStabilityInwardsPhreaticLineConfiguration("element");
        ...
        [Test]
        public void GetMacroStabilityInwardsPhreaticLineConfiguration_DescendantElementNameNull_ThrowArgumentNullException()
        {
            // Setup
            var element = new XElement("Root");

            // Call
            TestDelegate test = () => element.GetMacroStabilityInwardsPhreaticLineConfiguration(null);
        ...
        [Test]
        public void GetMacroStabilityInwardsPhreaticLineConfiguration_DescendantElementNameNotFound_ReturnNull()
        {
            // Setup
            ...
            // Call
            MacroStabilityInwardsPhreaticLineConfiguration configuration = element.GetMacroStabilityInwardsPhreaticLineConfiguration("differentElementName");
        ...
        public void GetMacroStabilityInwardsPhreaticLineConfiguration_DescendantElementNoValidDouble_ThrowException(string doubleValue, Type exceptionType)
        {
            // Setup
            const string descendantElementName = "descendantElement";

            var element = new XElement("Root", new XElement(descendantElementName, new XElement("binnenwaarts", doubleValue)));

            // Call
            TestDelegate test = () => element.GetMacroStabilityInwardsPhreaticLineConfiguration(descendantElementName);
        ...
        [Test]
        public void GetMacroStabilityInwardsPhreaticLineConfiguration_WithoutProperties_ReturnMacroStabilityInwardsPhreaticLineConfiguration()
        {
            // Setup
            const string descendantElementName = "descendantElement";
            var element = new XElement("Root", new XElement(descendantElementName));
            ...
            // Call
            MacroStabilityInwardsPhreaticLineConfiguration configuration = element.GetMacroStabilityInwardsPhreaticLineConfiguration(descendantElementName);
        ...
        [Test]
        public void GetMacroStabilityInwardsPhreaticLineConfiguration_WithInwardsElement_ReturnMacroStabilityInwardsPhreaticLineConfiguration()
        {
            // Setup
            var random = new Random(31);
            double inwards = random.NextDouble();
            const string descendantElementName = "descendantElement";

            var inwardsElement = new XElement("binnenwaarts", inwards);

            var element = new XElement("Root", new XElement(descendantElementName, inwardsElement));
        ...
        [Test]
        public void GetMacroStabilityInwardsPhreaticLineConfiguration_WithOutwardsElement_ReturnMacroStabilityInwardsPhreaticLineConfiguration()
        {
            // Setup
            var random = new Random(31);
            double outwards = random.NextDouble();
            const string descendantElementName = "descendantElement";

            var outwardsElement = new XElement("buitenwaarts", outwards);

            var element = new XElement("Root", new XElement(descendantElementName, outwardsElement));
        ...
        [Test]
        public void GetMacroStabilityInwardsPhreaticLineConfiguration_ValidDescendantElement_ReturnMacroStabilityInwardsPhreaticLineConfiguration()
        {
            // Setup
            var random = new Random(31);
            double inwards = random.NextDouble();
            ...
            var element = new XElement("Root", new XElement(descendantElementName, inwardsElement, outwardsElement));
