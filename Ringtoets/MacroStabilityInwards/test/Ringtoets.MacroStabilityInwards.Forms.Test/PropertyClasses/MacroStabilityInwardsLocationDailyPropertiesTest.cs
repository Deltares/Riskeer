...
{
    [TestFixture]
    public class MacroStabilityInwardsLocationDailyPropertiesTest
    {
        ...
        public void Constructor_ExpectedValues()
        {
            ...
            // Call
            var properties = new MacroStabilityInwardsLocationDailyProperties(input, changeHandler);

            // Assert
            Assert.IsInstanceOf<ObjectProperties<MacroStabilityInwardsLocationInputDaily>>(properties);
            Assert.AreSame(input, properties.Data);

            TestHelper.AssertTypeConverter<MacroStabilityInwardsLocationDailyProperties, ExpandableObjectConverter>(
                nameof(MacroStabilityInwardsLocationDailyProperties.Offsets));
        ...
        public void Constructor_ValidData_PropertiesHaveExpectedAttributesValues()
        {
            ...
            PropertiesTestHelper.AssertRequiredPropertyDescriptorProperties(
                ...
                "Polderpeil [m+NAP]",
                "Het niveau van het oppervlaktewater binnen een beheersgebied onder dagelijkse omstandigheden.");
        ...
        public void GivenPropertiesWithData_WhenChangingProperties_ThenPropertiesSetOnInput()
        {
            ...
            MacroStabilityInwardsLocationInput input = calculationItem.InputParameters.LocationInputDaily;

            var handler = new ObservablePropertyChangeHandler(calculationItem, calculationItem.InputParameters);
            var properties = new MacroStabilityInwardsLocationDailyProperties(calculationItem.InputParameters.LocationInputDaily, handler);
        ...
        private static void SetPropertyAndVerifyNotifcationsForCalculation(Action<MacroStabilityInwardsLocationDailyProperties> setProperty,
                                                                           MacroStabilityInwardsCalculation calculation)
        {
            ...
            var properties = new MacroStabilityInwardsLocationDailyProperties(input.LocationInputDaily, handler);
