...
namespace Ringtoets.MacroStabilityInwards.Forms.Test
{
    ...
    public class MacroStabilityInwardsCalculationConfigurationHelperTest
    {
        ...
        public void GetStochasticSoilModelsForSurfaceLine_SurfaceLineIntersectingSoilModel_ReturnSoilModel()
        {
            ...
            // Call
            IEnumerable<StochasticSoilModel> result = MacroStabilityInwardsCalculationConfigurationHelper.GetStochasticSoilModelsForSurfaceLine(
                surfaceLine,
                availableSoilModels);
        ...
        {
            // Setup
            var soilProfile1 = new MacroStabilityInwardsSoilProfile("Profile 1", -10.0, new[]
            {
                new MacroStabilityInwardsSoilLayer(-5.0),
                new MacroStabilityInwardsSoilLayer(-2.0),
                new MacroStabilityInwardsSoilLayer(1.0)
            }, SoilProfileType.SoilProfile1D, 1);
            var soilProfile2 = new MacroStabilityInwardsSoilProfile("Profile 2", -8.0, new[]
            {
                new MacroStabilityInwardsSoilLayer(-4.0),
                new MacroStabilityInwardsSoilLayer(0.0),
                new MacroStabilityInwardsSoilLayer(4.0)
        ...
        public void GetStochasticSoilModelsForSurfaceLine_SoilModelGeometryNotIntersecting_ReturnEmpty()
        {
            ...
            // Call
            IEnumerable<StochasticSoilModel> result = MacroStabilityInwardsCalculationConfigurationHelper.GetStochasticSoilModelsForSurfaceLine(surfaceLine, availableSoilModels);
        ...
        public void GenerateCalculationItemsStructure_WithSurfaceLinesWithEmptySoilModels_LogFourWarnings()
        {
            ...
            var surfaceLines = new List<RingtoetsMacroStabilityInwardsSurfaceLine>
            {
        ...
        public void GenerateCalculationItemsStructure_SoilProfileEqualNames_CalculationsGetUniqueName()
        {
            ...
            var soilProfile2 = new MacroStabilityInwardsSoilProfile("Profile 1", -8.0, new[]
            {
                new MacroStabilityInwardsSoilLayer(-4.0),
                new MacroStabilityInwardsSoilLayer(0.0),
                new MacroStabilityInwardsSoilLayer(4.0)
            }, SoilProfileType.SoilProfile1D, 2);
            var soilProfile3 = new MacroStabilityInwardsSoilProfile("Profile 1", -8.0, new[]
            {
                new MacroStabilityInwardsSoilLayer(-4.0),
                new MacroStabilityInwardsSoilLayer(0.0),
                new MacroStabilityInwardsSoilLayer(4.0)
