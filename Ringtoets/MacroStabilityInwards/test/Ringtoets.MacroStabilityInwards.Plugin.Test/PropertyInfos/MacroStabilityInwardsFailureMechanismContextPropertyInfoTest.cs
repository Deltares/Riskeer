...
{
    [TestFixture]
    public class MacroStabilityInwardsFailureMechanismContextPropertyInfoTest
    {
        ...
        public void CreateInstance_Always_NewPropertiesWithFailureMechanismContextAsData()
        {
            ...
            // Assert
            Assert.IsInstanceOf<MacroStabilityInwardsFailureMechanismContextProperties>(objectProperties);
