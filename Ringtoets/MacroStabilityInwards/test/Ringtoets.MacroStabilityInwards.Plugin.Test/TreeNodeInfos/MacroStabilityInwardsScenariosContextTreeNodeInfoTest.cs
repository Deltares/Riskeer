...
namespace Ringtoets.MacroStabilityInwards.Plugin.Test.TreeNodeInfos
{
    ...
    public class MacroStabilityInwardsScenariosContextTreeNodeInfoTest
    {
        ...
        public void SetUp()
        {
            ...
            info = plugin.GetTreeNodeInfos().First(tni => tni.TagType == typeof(MacroStabilityInwardsScenariosContext));
        }
        ...
        public void Text_Always_ReturnScenarios()
        {
            ...
            var context = new MacroStabilityInwardsScenariosContext(group, failureMechanism);
