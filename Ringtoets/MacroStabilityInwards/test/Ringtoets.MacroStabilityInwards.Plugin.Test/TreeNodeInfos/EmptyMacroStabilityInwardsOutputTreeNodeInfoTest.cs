...
{
    [TestFixture]
    public class EmptyMacroStabilityInwardsOutputTreeNodeInfoTest
    {
        ...
        public void SetUp()
        {
            ...
            info = plugin.GetTreeNodeInfos().First(tni => tni.TagType == typeof(EmptyMacroStabilityInwardsOutput));
        }
