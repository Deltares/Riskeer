...
namespace Ringtoets.WaveImpactAsphaltCover.Forms.Views
{
    ...
    public partial class WaveImpactAsphaltCoverFailureMechanismView : UserControl, IMapView
    {
        ...
        private void UpdateMapData()
        {
            ...
            calculationsMapData.Features = WaveImpactAsphaltCoverMapDataFeaturesFactory.CreateCalculationFeatures(calculationGroup.GetCalculations().Cast<WaveImpactAsphaltCoverWaveConditionsCalculation>());
