...
namespace Ringtoets.WaveImpactAsphaltCover.Service
{
    ...
    /// wave impact asphalt cover wave conditions calculations.
    /// </summary>
    public static class WaveImpactAsphaltCoverWaveConditionsCalculationActivityFactory
    {
        /// <summary>
        ...
        public static IEnumerable<CalculatableActivity> CreateCalculationActivities(WaveImpactAsphaltCoverFailureMechanism failureMechanism,
        ...
        /// <exception cref="ArgumentNullException">Thrown when any parameter is <c>null</c>.</exception>
        public static CalculatableActivity CreateCalculationActivity(WaveImpactAsphaltCoverWaveConditionsCalculation calculation,
                                                                     WaveImpactAsphaltCoverFailureMechanism failureMechanism,
                                                                     IAssessmentSection assessmentSection)
        {
            if (calculation == null)
