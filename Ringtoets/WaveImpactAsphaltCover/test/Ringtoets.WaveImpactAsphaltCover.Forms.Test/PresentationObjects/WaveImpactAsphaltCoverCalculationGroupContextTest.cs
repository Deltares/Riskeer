    ...
    public class WaveImpactAsphaltCoverWaveConditionsCalculationGroupContextTest
    {
        ...
        public void Equals_ToOtherWithDifferentWrappedData_ReturnFalse()
        {
            ...
            var context1 = new WaveImpactAsphaltCoverWaveConditionsCalculationGroupContext(calculationGroup1,
                                                                                           ...
                                                                                           failureMechanism,
                                                                                           assessmentSection);
            var context2 = new WaveImpactAsphaltCoverWaveConditionsCalculationGroupContext(calculationGroup2,
                                                                                           parent,
                                                                                           failureMechanism,
                                                                                           assessmentSection);
        ...
        public void Equals_ToOtherWithDifferentParent_ReturnFalse()
        {
            ...
            var failureMechanism = new WaveImpactAsphaltCoverFailureMechanism();
            var context1 = new WaveImpactAsphaltCoverWaveConditionsCalculationGroupContext(calculationGroup,
                                                                                           parent1,
                                                                                           failureMechanism,
                                                                                           assessmentSection);
            var context2 = new WaveImpactAsphaltCoverWaveConditionsCalculationGroupContext(calculationGroup,
                                                                                           parent2,
                                                                                           failureMechanism,
                                                                                           assessmentSection);
