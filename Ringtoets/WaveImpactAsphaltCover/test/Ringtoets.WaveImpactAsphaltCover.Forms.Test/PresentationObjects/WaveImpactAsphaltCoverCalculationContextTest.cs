...
namespace Ringtoets.WaveImpactAsphaltCover.Forms.Test.PresentationObjects
{
    ...
    public class WaveImpactAsphaltCoverWaveConditionsCalculationContextTest
    {
        ...
        public void Equals_ToOtherWithDifferentParent_ReturnFalse()
        {
            ...
            var context1 = new WaveImpactAsphaltCoverWaveConditionsCalculationContext(calculation1, parent1, failureMechanism, assessmentSection);
            var context2 = new WaveImpactAsphaltCoverWaveConditionsCalculationContext(calculation2, parent2, failureMechanism, assessmentSection);
        ...
        public void Equals_ToOtherWithSameWrappedDataAndParent_ReturnTrue()
        {
            ...
            var failureMechanism = new WaveImpactAsphaltCoverFailureMechanism();
            var parent = new CalculationGroup();
            var context1 = new WaveImpactAsphaltCoverWaveConditionsCalculationContext(calculation, parent, failureMechanism, assessmentSection);
            var context2 = new WaveImpactAsphaltCoverWaveConditionsCalculationContext(calculation, parent, failureMechanism, assessmentSection);
