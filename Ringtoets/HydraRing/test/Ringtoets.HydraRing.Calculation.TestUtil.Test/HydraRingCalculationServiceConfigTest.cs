...
namespace Ringtoets.HydraRing.Calculation.TestUtil.Test
{
    ...
    public class HydraRingCalculationServiceConfigTest
    {
        ...
        {
            // Call
            var factory = new HydraRingCalculationServiceConfig();
        ...
        {
            // Setup
            var expectedFactory = HydraRingCalculationService.Instance;

            // Call
            using (new HydraRingCalculationServiceConfig()) { }

            // Assert
            Assert.AreSame(expectedFactory, HydraRingCalculationService.Instance);
        }
    }
}