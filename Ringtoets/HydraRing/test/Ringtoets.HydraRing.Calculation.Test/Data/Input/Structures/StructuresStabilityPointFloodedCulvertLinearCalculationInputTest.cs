...
namespace Ringtoets.HydraRing.Calculation.Test.Data.Input.Structures
{
    ...
    public class StructuresStabilityPointFloodedCulvertLinearCalculationInputTest
    {
        ...
        public void Constructor_ExpectedValues()
        {
            ...
            const double stabilityLinearLoadModelMean = 22.22;
            const double stabilityLinearLoadModelVariation = 0.1;
            const double constructiveStrengthLinearLoadModelMean = 23.23;
            const double constructiveStrengthLinearLoadModelVariation = 0.1;

            // Call
            var input = new StructuresStabilityPointFloodedCulvertLinearCalculationInput(hydraulicBoundaryLocationId, section, forelandPoints,
                                                                                         volumicWeightWater,
        ...
        private static IEnumerable<HydraRingVariable> GetDefaultVariables()
        {
            ...
            yield return new HydraRingVariable(80, HydraRingDistributionType.LogNormal, double.NaN, HydraRingDeviationType.Variation, 22.22, 0.1, double.NaN);
            ...
            yield return new HydraRingVariable(83, HydraRingDistributionType.LogNormal, double.NaN, HydraRingDeviationType.Variation, 23.23, 0.1, double.NaN);
