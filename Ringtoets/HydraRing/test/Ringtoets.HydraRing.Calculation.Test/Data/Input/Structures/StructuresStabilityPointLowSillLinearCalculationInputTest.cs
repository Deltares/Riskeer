...
namespace Ringtoets.HydraRing.Calculation.Test.Data.Input.Structures
{
    ...
    public class StructuresStabilityPointLowSillLinearCalculationInputTest
    {
        ...
        public void Constructor_ExpectedValues()
        {
            ...
            const double stabilityLinearLoadModelMean = 21.21;
            const double stabilityLinearLoadModelVariation = 0.1;
            const double constructiveStrengthLinearLoadModelMean = 22.22;
            const double constructiveStrengthLinearLoadModelVariation = 0.1;
            const double widthFlowAperturesMean = 23.23;
        ...
        private static IEnumerable<HydraRingVariable> GetDefaultVariables()
        {
            ...
            yield return new HydraRingVariable(80, HydraRingDistributionType.LogNormal, double.NaN, HydraRingDeviationType.Variation, 21.21, 0.1, double.NaN);
            ...
            yield return new HydraRingVariable(83, HydraRingDistributionType.LogNormal, double.NaN, HydraRingDeviationType.Variation, 22.22, 0.1, double.NaN);
            ...
            yield return new HydraRingVariable(106, HydraRingDistributionType.Normal, double.NaN, HydraRingDeviationType.Variation, 23.23, 0.05, double.NaN);
            ...
            yield return new HydraRingVariable(133, HydraRingDistributionType.Normal, double.NaN, HydraRingDeviationType.Standard, 5000, 0.5, double.NaN);
