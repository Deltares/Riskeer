...
namespace Ringtoets.HydraRing.Calculation.Test.Data.Input.Structures
{
    ...
    public class StructuresStabilityPointLowSillQuadraticCalculationInputTest
    {
        ...
        public void Constructor_ExpectedValues()
        {
            ...
            const double stabilityQuadraticLoadModelMean = 21.21;
            const double stabilityQuadraticLoadModelVariation = 0.1;
            const double constructiveStrengthQuadraticLoadModelMean = 22.22;
            ...
            // Call
            var input = new StructuresStabilityPointLowSillQuadraticCalculationInput(hydraulicBoundaryLocationId, section, forelandPoints,
                                                                                     volumicWeightWater,
        ...
        {
            // Setup
            var input = new StructuresStabilityPointLowSillQuadraticCalculationInput(111, new HydraRingSection(1, double.NaN, double.NaN),
        ...
        private static IEnumerable<HydraRingVariable> GetDefaultVariables()
        {
            ...
            yield return new HydraRingVariable(81, HydraRingDistributionType.LogNormal, double.NaN, HydraRingDeviationType.Variation, 21.21, 0.1, double.NaN);
            ...
            yield return new HydraRingVariable(84, HydraRingDistributionType.LogNormal, double.NaN, HydraRingDeviationType.Variation, 22.22, 0.1, double.NaN);
