    ...
    public class HydraRingConfigurationTest
    {
        ...
        public void GenerateDataBaseCreationScript_NonDefaultHydraRingConfiguration_ReturnsExpectedCreationScript()
        {
            ...
            var expectedCreationScript = "DELETE FROM [HydraulicModels];" + Environment.NewLine +
                                         ...
                                         "INSERT INTO [Numerics] VALUES (999, 3, NULL, NULL, 3, 1, 4);" + Environment.NewLine +
                                         "INSERT INTO [Numerics] VALUES (999, 3, NULL, NULL, 4, 1, 4);" + Environment.NewLine +
                                         "INSERT INTO [Numerics] VALUES (999, 3, NULL, NULL, 5, 4, 4);" + Environment.NewLine +
                                         Environment.NewLine +
