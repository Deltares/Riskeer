...
namespace Ringtoets.HydraRing.Calculation.Test.Providers
{
    ...
    public class VariableDefaultsProviderTest
    {
        ...
        [TestCase(HydraRingFailureMechanismType.DikesPiping, 54, 999999)]
        [TestCase(HydraRingFailureMechanismType.DikesPiping, 55, 600)]
        [TestCase(HydraRingFailureMechanismType.DikesPiping, 56, 180)]
        [TestCase(HydraRingFailureMechanismType.DikesPiping, 58, 999999)]
        ...
        [TestCase(HydraRingFailureMechanismType.StructuresStructuralFailure, 62, 999999)]
        [TestCase(HydraRingFailureMechanismType.StructuresStructuralFailure, 63, 999999)]
        [TestCase(HydraRingFailureMechanismType.StructuresStructuralFailure, 64, 999999)]
