...
namespace Ringtoets.HydraRing.Calculation.Test.Providers
{
    ...
    public class VariableDefaultsProviderTest
    {
        ...
        [TestCase(HydraRingFailureMechanismType.QVariant, 20, 300)]
        [TestCase(HydraRingFailureMechanismType.QVariant, 21, 300)]
        [TestCase(HydraRingFailureMechanismType.QVariant, 22, 300)]
        [TestCase(HydraRingFailureMechanismType.QVariant, 23, 300)]
        [TestCase(HydraRingFailureMechanismType.QVariant, 24, 300)]
        ...
        public void GetSubMechanismSettings_DefaultsOnly_ReturnsExpectedSubMechanismSettings(HydraRingFailureMechanismType failureMechanismType, int variableId, int expectedCorrelationLength)
        {
            // Setup
