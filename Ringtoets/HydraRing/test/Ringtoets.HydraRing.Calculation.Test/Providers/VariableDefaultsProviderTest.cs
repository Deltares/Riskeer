...
namespace Ringtoets.HydraRing.Calculation.Test.Providers
{
    ...
    public class VariableDefaultsProviderTest
    {
        ...
        [TestCase(HydraRingFailureMechanismType.StructuresStructuralFailure, 66, 50)]
        [TestCase(HydraRingFailureMechanismType.StructuresStructuralFailure, 67, 50)]
        [TestCase(HydraRingFailureMechanismType.StructuresStructuralFailure, 80, 50)]
        [TestCase(HydraRingFailureMechanismType.StructuresStructuralFailure, 81, 50)]
        ...
        [TestCase(HydraRingFailureMechanismType.StructuresStructuralFailure, 84, 50)]
