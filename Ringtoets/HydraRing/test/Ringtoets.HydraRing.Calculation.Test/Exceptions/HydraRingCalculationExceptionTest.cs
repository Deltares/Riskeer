...
namespace Ringtoets.HydraRing.Calculation.Test.Exceptions
{
    ...
    public class HydraRingCalculationExceptionTest
    {
        ...
        {
            // Setup
            string expectedMessage = string.Format("Exception of type '{0}' was thrown.", typeof(HydraRingCalculationException).FullName);

            // Call
            HydraRingCalculationException exception = new HydraRingCalculationException();
        ...
        public void Constructor_WithCustomMessage_InnerExceptionNullAndMessageSetToCustom()
        {
            ...
            // Call
            HydraRingCalculationException exception = new HydraRingCalculationException(expectedMessage);
        ...
        public void Constructor_WithCustomMessageAndInnerException_InnerExceptionSetAndMessageSetToCustom()
        {
            ...
            // Call
            HydraRingCalculationException exception = new HydraRingCalculationException(expectedMessage, expectedInnerException);
        ...
        public void Constructor_SerializationRoundTrip_ExceptionProperlyInitialized()
        {
            ...
            var originalException = new HydraRingCalculationException("outer", originalInnerException);
            ...
            // Call
            HydraRingCalculationException persistedException = SerializationTestHelper.SerializeAndDeserializeException(originalException);
