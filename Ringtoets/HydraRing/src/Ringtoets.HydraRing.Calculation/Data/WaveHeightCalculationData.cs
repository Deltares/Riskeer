...
namespace Ringtoets.HydraRing.Calculation.Data
{
    ...
    /// </summary>
    public class WaveHeightCalculationData : HydraulicCalculationData
    {
        /// <summary>
        /// Creates a new instance of the <see cref="WaveHeightCalculationData"/> class.
        /// </summary>
        ...
        public WaveHeightCalculationData(HydraulicBoundaryLocation hydraulicBoundaryLocation, double beta) : base(hydraulicBoundaryLocation, beta) {}
