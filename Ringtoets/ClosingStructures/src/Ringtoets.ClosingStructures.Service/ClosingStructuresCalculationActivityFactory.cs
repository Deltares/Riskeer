...
namespace Ringtoets.ClosingStructures.Service
{
    ...
    /// closing structures calculations.
    /// </summary>
    public static class ClosingStructuresCalculationActivityFactory
    {
        /// <summary>
        ...
        public static IEnumerable<CalculatableActivity> CreateCalculationActivities(ClosingStructuresFailureMechanism failureMechanism,
        ...
        /// <exception cref="ArgumentNullException">Thrown when any parameter is <c>null</c>.</exception>
        public static CalculatableActivity CreateCalculationActivity(StructuresCalculation<ClosingStructuresInput> calculation,
                                                                     ClosingStructuresFailureMechanism failureMechanism,
                                                                     IAssessmentSection assessmentSection)
        {
            if (calculation == null)
