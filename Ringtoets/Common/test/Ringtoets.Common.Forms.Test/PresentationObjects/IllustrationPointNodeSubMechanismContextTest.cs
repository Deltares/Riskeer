...
namespace Ringtoets.Common.Forms.Test.PresentationObjects
{
    ...
    public class IllustrationPointNodeSubMechanismContextTest
    {
        ...
        {
            // Call
            TestDelegate test = () => new IllustrationPointNodeSubMechanismContext(null, "", "");
        ...
        public void Constructor_WindDirectionNameNull_ThrowsArgumentNullException()
        {
            ...
            // Call
            TestDelegate test = () => new IllustrationPointNodeSubMechanismContext(node, null, "");
        ...
        public void Constructor_IllustrationPointNodeInvalidType_ThrowsArgumentException()
        {
            ...
            // Call
            TestDelegate test = () => new IllustrationPointNodeSubMechanismContext(node, windDirectionName, closingSituation);

            // Assert
            var exception = Assert.Throws<ArgumentException>(test);
            Assert.AreEqual("illustrationPointNode type has to be SubMechanismIllustrationPoint", exception.Message);
        }
        ...
        public void Constructor_ValidParameters_ExpectedProperties()
        {
            ...
            // Call
            var context = new IllustrationPointNodeSubMechanismContext(node, windDirectionName, closingSituation);
