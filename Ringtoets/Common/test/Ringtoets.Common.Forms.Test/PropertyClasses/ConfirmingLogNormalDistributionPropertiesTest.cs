...
namespace Ringtoets.Common.Forms.Test.PropertyClasses
{
    ...
    public class ConfirmingLogNormalDistributionPropertiesTest
    {
        ...
        public void Constructor_WithParameters_ExpectedValues()
        {
            ...
            // Call
            var properties = new ConfirmingLogNormalDistributionProperties<ICalculationInput, ICalculation>(
                DistributionPropertiesReadOnly.None, distribution, calculation, input, handler);

            // Assert
            Assert.IsInstanceOf<ConfirmingDistributionPropertiesBase<LogNormalDistribution, ICalculationInput, ICalculation>>(properties);
