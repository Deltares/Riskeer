...
{
    [TestFixture]
    public class WaveHeightHydraulicBoundaryLocationPropertiesTest
    {
        ...
        public void Constructor_ExpectedValues()
        {
            ...
            // Call
            var properties = new WaveHeightHydraulicBoundaryLocationProperties(location,
            ...
            TestHelper.AssertTypeConverter<WaveHeightHydraulicBoundaryLocationProperties, ExpandableArrayConverter>(
                nameof(WaveHeightHydraulicBoundaryLocationProperties.CategoryBoundaries));
        }
        ...
        public void GetProperties_ValidData_ReturnsExpectedValues()
        {
            ...
            // Call
            var properties = new WaveHeightHydraulicBoundaryLocationProperties(hydraulicBoundaryLocation,
                                                                               calculations);

            // Assert
            WaveHeightCalculationOutputProperties categoryBoundaryCalculation = properties.CategoryBoundaries.Single();
