...
{
    [TestFixture]
    public abstract class CustomSchemaCalculationConfigurationWriterDesignGuidelinesTestFixture<TWriter, TConfiguration>
        ...
        where TWriter : SchemaCalculationConfigurationWriter<TConfiguration>
    {
        ...
        {
            Assert.IsInstanceOf<SchemaCalculationConfigurationWriter<TConfiguration>>(writer);
        }
