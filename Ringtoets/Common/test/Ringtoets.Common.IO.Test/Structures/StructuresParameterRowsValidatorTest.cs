    ...
    public class StructuresParameterRowsValidatorTest
    {
        ...
        public void ValidateHeightStructuresParameters_ParametersAllInvalid_ValidIsFalseAndErrorMessages()
        {
            ...
            List<string> expectedErrorMessages = new List<string>
            {
                ...
                "De waarde voor parameter 'KW_HOOGTE2' op regel 2, kolom 'standaardafwijking.variatie', moet een getal zijn dat niet negatief is.",
                ...
                "De waarde voor parameter 'KW_HOOGTE3' op regel 3, kolom 'standaardafwijking.variatie', moet een getal zijn dat niet negatief is.",
                ...
                "De waarde voor parameter 'KW_HOOGTE4' op regel 4, kolom 'standaardafwijking.variatie', moet een getal zijn dat niet negatief is.",
        ...
        public void ValidateClosingStructuresParameters_ParametersAllInvalid_ValidIsFalseAndErrorMessages()
        {
            ...
            List<string> expectedErrorMessages = new List<string>
            {
                ...
                "De waarde voor parameter 'KW_BETSLUIT8' op regel 8, kolom 'standaardafwijking.variatie', moet een getal zijn dat niet negatief is.",
                ...
                "De waarde voor parameter 'KW_BETSLUIT9' op regel 9, kolom 'standaardafwijking.variatie', moet een getal zijn dat niet negatief is.",
                ...
                "De waarde voor parameter 'KW_BETSLUIT10' op regel 10, kolom 'standaardafwijking.variatie', moet een getal zijn dat niet negatief is.",
        ...
        public void ValidateStabilityPointStructuresParameters_ParametersAllInvalid_ValidIsFalseAndErrorMessages()
        {
            ...
            List<string> expectedErrorMessages = new List<string>
            {
                ...
                "De waarde voor parameter 'KW_STERSTAB3' op regel 3, kolom 'standaardafwijking.variatie', moet een getal zijn dat niet negatief is.",
                ...
                "De waarde voor parameter 'KW_STERSTAB8' op regel 8, kolom 'standaardafwijking.variatie', moet een getal zijn dat niet negatief is.",
                ...
                "De waarde voor parameter 'KW_STERSTAB25' op regel 25, kolom 'standaardafwijking.variatie', moet een getal zijn dat niet negatief is.",
