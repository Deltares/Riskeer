...
namespace Ringtoets.Common.IO.Test.SoilProfile
{
    ...
    public class SoilProfileTableDefinitionsTest
    {
        ...
        public void Constants_Always_ExpectedValues()
        {
            ...
            Assert.AreEqual("BelowPhreaticLevelDistribution", SoilProfileTableDefinitions.BelowPhreaticLevelDistribution);
            ...
            Assert.AreEqual("PermeabKxDistribution", SoilProfileTableDefinitions.PermeabilityDistribution);
            ...
            Assert.AreEqual("DiameterD70Distribution", SoilProfileTableDefinitions.DiameterD70Distribution);
            ...
            Assert.AreEqual("AbovePhreaticLevelDistribution", SoilProfileTableDefinitions.AbovePhreaticLevelDistribution);
            ...
            Assert.AreEqual("CohesionDistribution", SoilProfileTableDefinitions.CohesionDistribution);
            ...
            Assert.AreEqual("FrictionAngleDistribution", SoilProfileTableDefinitions.FrictionAngleDistribution);
            ...
            Assert.AreEqual("ShearStrengthRatioDistribution", SoilProfileTableDefinitions.ShearStrengthRatioDistribution);
            ...
            Assert.AreEqual("StrengthIncreaseExponentDistribution", SoilProfileTableDefinitions.StrengthIncreaseExponentDistribution);
            ...
            Assert.AreEqual("PopDistribution", SoilProfileTableDefinitions.PopDistribution);
