...
namespace Ringtoets.Common.IO.Test.Exceptions
{
    ...
    public class CriticalFileValidationExceptionTest
    {
        ...
        public void Constructor_SerializationRoundTrip_ExceptionProperlyInitialized()
        {
            ...
            var originalException = new CriticalFileValidationException("outer", originalInnerException);
            ...
            // Call
            CriticalFileValidationException persistedException = SerializationTestHelper.SerializeAndDeserializeException(originalException);
