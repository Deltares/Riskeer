...
namespace Ringtoets.Common.IO.Test.FileImporters.MessageProviders
{
    ...
    public class ImportMessageProviderTest
    {
        ...
        public void GetCancelledLogMessageText_WithDescriptor_ReturnsExpectedMessage()
        {
            ...
            // Assert
            const string expectedMessage = "Items importeren afgebroken. Geen data gewijzigd.";
            Assert.AreEqual(expectedMessage, message);
        }
        ...
        public void GetUpdateDataFailedLogMessageText_WithDescriptor_ReturnsExpectedMessage()
        {
            ...
            // Assert
            const string expectedMessage = "Het importeren van de items is mislukt: {0}. Geen data gewijzigd.";
            Assert.AreEqual(expectedMessage, message);
        }
    }
}