...
namespace Ringtoets.Common.Service.Test
{
    ...
    public class WaveHeightCalculationServiceTest
    {
        ...
        [Test]
        public void Calculate_ValidWaveHeightCalculationWithIllustrationPointsThrowsException_ThrowsHydraRingFileParserException()
        {
            // Setup
            string validFilePath = Path.Combine(testDataPath, validFile);
            ...
            calculator.Expect(c => c.CalculateWithIllustrationPoints(Arg<WaveHeightCalculationInput>.Is.TypeOf))
