...
namespace Ringtoets.Common.IO.Properties {
    ...
    public class Resources {
        ...
        /// </summary>
        public static string StructuresParameterRowsValidator_Line_0_ColumnName_1_orientation_out_of_range {
            get {
                return ResourceManager.GetString("StructuresParameterRowsValidator_Line_0_ColumnName_1_orientation_out_of_range", resourceCulture);
            }
        }
        ...
        /// </summary>
        public static string StructuresParameterRowsValidator_Line_0_ColumnName_1_probability_out_of_range {
            get {
                return ResourceManager.GetString("StructuresParameterRowsValidator_Line_0_ColumnName_1_probability_out_of_range", resourceCulture);
            }
        }
        ...
        /// </summary>
        public static string StructuresParameterRowsValidator_Line_0_ColumnName_1_value_invalid {
            get {
                return ResourceManager.GetString("StructuresParameterRowsValidator_Line_0_ColumnName_1_value_invalid", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Voor een betrouwbare conversie tussen standaard deviatie en variatiecoëfficiënt mag de gemiddelde waarde (op regel {0}, kolom {1}) niet te dicht op 0 zijn..
        /// </summary>
        public static string StructuresParameterRowsValidator_Mean_on_Line_0_ColumnName_1_causes_unreliable_variation_value_conversion {
            get {
                return ResourceManager.GetString("StructuresParameterRowsValidator_Mean_on_Line_0_ColumnName_1_causes_unreliable_va" +
