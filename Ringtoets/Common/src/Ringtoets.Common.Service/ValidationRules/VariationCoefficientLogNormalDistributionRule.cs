...
{
    /// <summary>
    /// Validation rule to validate a <see cref="VariationCoefficientLogNormalDistribution"/>.
    /// </summary>
    public class VariationCoefficientLogNormalDistributionRule : ValidationRule
    {
        ...
        /// <summary>
        /// Instantiates a <see cref="VariationCoefficientLogNormalDistributionRule"/> to validate 
        /// a <see cref="VariationCoefficientLogNormalDistribution"/>.
        /// </summary>
        ...
        public override IEnumerable<string> Validate()
        {
            ...
            {
                validationResults.Add(string.Format(Resources.ProbabilisticDistributionValidationRule_Mean_of_0_must_be_positive_value,
                                                    parameterName));
            }

            if (IsNotConcreteNumber(distribution.CoefficientOfVariation))
            {
                validationResults.Add(string.Format(Resources.ProbabilistiDistributionValidationRule_CoefficientOfVariation_of_ParameterName_0_must_be_larger_or_equal_to_zero,
                                                    parameterName));
            }
