...
{
    public abstract class VariationCoefficientDesignVariable<TDistribution> where TDistribution : IVariationCoefficientDistribution
    {
        ...
        /// <c>null</c>.</exception>
        protected VariationCoefficientDesignVariable(TDistribution distribution)
        {
