...
namespace Ringtoets.Common.Forms.PropertyClasses
{
    ...
    /// properties.
    /// </summary>
    public class ConfirmingLogNormalDistributionProperties<TCalculationInput, TCalculation> : ConfirmingDistributionPropertiesBase<LogNormalDistribution, TCalculationInput, TCalculation> 
        where TCalculationInput : ICalculationInput 
        where TCalculation : ICalculation
    {
        /// <summary>
        /// Creates a new instance of <see cref="ConfirmingLogNormalDistributionProperties{TCalculationInput,TCalculation}"/>.
        /// </summary>
