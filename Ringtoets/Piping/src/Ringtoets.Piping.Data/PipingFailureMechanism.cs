...
namespace Ringtoets.Piping.Data
{
    ...
    public class PipingFailureMechanism : FailureMechanismBase, ICalculatableFailureMechanism, IHasSectionResults<PipingFailureMechanismSectionResult>
    {
            ...
            : base(PipingDataResources.PipingFailureMechanism_DisplayName, PipingDataResources.PipingFailureMechanism_DisplayCode)
        {
            ...
            SurfaceLines = new ObservableCollectionWithSourcePath<RingtoetsPipingSurfaceLine>();
            StochasticSoilModels = new ObservableCollectionWithSourcePath<StochasticSoilModel>();
        ...
        /// </summary>
        public ObservableCollectionWithSourcePath<RingtoetsPipingSurfaceLine> SurfaceLines { get; }

        /// <summary>
        /// Gets the available stochastic soil models within the scope of the piping failure mechanism.
        /// </summary>
        public ObservableCollectionWithSourcePath<StochasticSoilModel> StochasticSoilModels { get; }
