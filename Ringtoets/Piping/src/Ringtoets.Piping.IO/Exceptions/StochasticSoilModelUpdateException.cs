...
namespace Ringtoets.Piping.IO.Exceptions
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StochasticSoilModelUpdateException"/> class.
        /// </summary>
        public StochasticSoilModelUpdateException() {}
        ...
        public StochasticSoilModelUpdateException(string message) : base(message) {}
        ...
        public StochasticSoilModelUpdateException(string message, Exception inner) : base(message, inner) {}

        /// <summary>
        /// Initializes a new instance of <see cref="StochasticSoilModelUpdateException"/> with
