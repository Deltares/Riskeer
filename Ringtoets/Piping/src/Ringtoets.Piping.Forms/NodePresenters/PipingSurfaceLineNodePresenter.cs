...
namespace Ringtoets.Piping.Forms.NodePresenters
{
    ...
    public class PipingSurfaceLineNodePresenter : RingtoetsNodePresenterBase<RingtoetsPipingSurfaceLine>
    {
        ...
        protected override void UpdateNode(TreeNode parentNode, TreeNode node, RingtoetsPipingSurfaceLine nodeData)
        {
        ...
        protected override ContextMenuStrip GetContextMenu(TreeNode node, RingtoetsPipingSurfaceLine nodeData)
        {
