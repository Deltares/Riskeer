...
namespace Ringtoets.Piping.Forms.PropertyClasses
{
    ...
    /// </summary>
    public abstract class PipingDistributionPropertiesBase<TDistribution, TCalculationInput, TCalculation> : ObjectProperties<TDistribution>
        ...
        where TCalculation : ICalculation
    {
        ...
        /// <summary>
        /// Creates a new instance of <see cref="PipingDistributionPropertiesBase{TDistribution,TCalculationInput,TCalculation}"/>.
        /// </summary>
                                                   ...
                                                   ICalculationInputPropertyChangeHandler<TCalculationInput, TCalculation> handler)
        {
            ...
            meanPropertyName = TypeUtils.GetMemberName<PipingDistributionPropertiesBase<TDistribution, TCalculationInput, TCalculation>>(dpb => dpb.Mean);
            standardDeviationPropertyName = TypeUtils.GetMemberName<PipingDistributionPropertiesBase<TDistribution, TCalculationInput, TCalculation>>(dpb => dpb.StandardDeviation);
