...
namespace Ringtoets.Piping.Plugin.FileImporter
{
    ...
    public class PipingSurfaceLinesCsvImporter : FileImporterBase<RingtoetsPipingSurfaceLineCollection>
    {
                                                                                 ...
                                                                                 ICollection<CharacteristicPoints> readCharacteristicPointsLocations)
        {
            ...
            foreach (RingtoetsPipingSurfaceLine readSurfaceLine in readSurfaceLines)
            {
        ...
        private ReadResult<RingtoetsPipingSurfaceLine> ReadPipingSurfaceLines(PipingSurfaceLinesCsvReader reader)
        {
            ...
            string stepName = string.Format(Resources.PipingSurfaceLinesCsvImporter_Read_PipingSurfaceLines_0_,
        ...
        private void AddValidSurfaceLineToCollection(List<RingtoetsPipingSurfaceLine> list, PipingSurfaceLinesCsvReader reader)
        {
            try
            {
                RingtoetsPipingSurfaceLine ringtoetsPipingSurfaceLine = reader.ReadSurfaceLine();
        ...
        private ReadResult<CharacteristicPoints> ReadCharacteristicPoints(string path, CharacteristicPointsCsvReader reader)
        {
            ...
            string stepName = string.Format(Resources.PipingSurfaceLinesCsvImporter_Read_PipingCharacteristicPoints_0_,
