...
namespace Ringtoets.Piping.Data.Test.SoilProfile
{
    ...
    public class PipingStochasticSoilModelProfileDifferenceTest
    {
        ...
        public void Constructor_ValidArguments_ExpectedProperties()
        {
            ...
            // Call
            var difference = new PipingStochasticSoilModelProfileDifference(addedProfiles,
                                                                            updatedProfiles,
                                                                            removedProfiles);

            // Assert
            Assert.AreSame(addedProfiles, difference.AddedProfiles);
            Assert.AreSame(updatedProfiles, difference.UpdatedProfiles);
            Assert.AreSame(removedProfiles, difference.RemovedProfiles);
        }
    }
}