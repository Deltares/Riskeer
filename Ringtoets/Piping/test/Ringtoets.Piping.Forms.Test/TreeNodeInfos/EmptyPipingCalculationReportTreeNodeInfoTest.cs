...
{
    [TestFixture]
    public class EmptyPipingCalculationReportTreeNodeInfoTest
    {
        ...
        public void SetUp()
        {
            ...
            info = plugin.GetTreeNodeInfos().First(tni => tni.TagType == typeof(EmptyPipingCalculationReport));
        }
        ...
        public void Text_Always_ReturnsName()
        {
            ...
            // Assert
            Assert.AreEqual(PipingDataResources.CalculationReport_DisplayName, text);
        }
        ...
        public void Image_Always_ReturnsPlaceHolderIcon()
        {
            ...
            // Assert
            TestHelper.AssertImagesAreEqual(PipingFormsResources.PipingCalculationReportIcon, image);
        }
