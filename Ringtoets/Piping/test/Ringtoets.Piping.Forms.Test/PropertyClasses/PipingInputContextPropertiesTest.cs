...
namespace Ringtoets.Piping.Forms.Test.PropertyClasses
{
    ...
    public class PipingInputContextPropertiesTest
    {
        ...
        public void Constructor_ValidData_PropertiesHaveExpectedAttributesValues()
        {
            ...
            var handler = new ObservablePropertyChangeHandler(calculationItem);
        ...
        public void HydraulicBoundaryLocation_DesignWaterLevelIsNaN_AssessmentLevelSetToNaN()
        {
            ...
            var handler = new ObservableSetPropertyValueAfterConfirmationParameterTester<HydraulicBoundaryLocation>(
        ...
        public void AssessmentLevel_SetNewValue_UpdateDataAndNotifyObservers(double testLevel)
        {
            ...
            var handler = new ObservableSetPropertyValueAfterConfirmationParameterTester<double>(
                inputParameters,
                testLevel,
                new[]
                {
        ...
        public void SurfaceLine_NewSurfaceLine_StochasticSoilModelAndSoilProfileSetToNull()
        {
            ...
            var handler = new ObservableSetPropertyValueAfterConfirmationParameterTester<RingtoetsPipingSurfaceLine>(
                inputParameters,
                newSurfaceLine,
                new IObservable[0]);
        ...
        public void StochasticSoilProfile_DifferentStochasticSoilModel_SoilProfileSetToNull()
        {
            ...
            var handler = new ObservableSetPropertyValueAfterConfirmationParameterTester<StochasticSoilModel>(
                inputParameters,
