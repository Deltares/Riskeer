    ...
    public class PipingChartDataPointsFactoryTest
    {
        ...
        public void CreateEntryPointPoint_EntryPointNaN_ReturnsEmptyPointsArray()
        {
            ...
            var pipingInput = new PipingInput(new GeneralPipingInput())
            {
                ...
                EntryPointL = (RoundedDouble) double.NaN
            };
        ...
        private static void AssertEqualLocalPointCollection(Point3D point, RingtoetsPipingSurfaceLine surfaceLine, IEnumerable<Point2D> chartPoints)
        {
