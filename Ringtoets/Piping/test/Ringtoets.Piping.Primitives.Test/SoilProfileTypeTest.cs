...
{
    [TestFixture]
    public class SoilProfileTypeTest : EnumTestFixture<SoilProfileType>
    {
        protected override IDictionary<SoilProfileType, string> ExpectedDisplayNameForEnumValues
        {
            get
            {
                return new Dictionary<SoilProfileType, string>
                {
                    {
                        SoilProfileType.SoilProfile1D, "1D Profiel"
                    },
                    {
                        SoilProfileType.SoilProfile2D, "2D Profiel"
                    }
                };
            }
        }
        ...
        protected override IDictionary<SoilProfileType, byte> ExpectedValueForEnumValues
        {
            get
            {
                return new Dictionary<SoilProfileType, byte>
                {
                    ...
                    {
                        SoilProfileType.SoilProfile2D, 2
                    }
                };
            }
        }
