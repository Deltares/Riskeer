    ...
    public class PipingCalculatorExceptionTest
    {
        ...
        public void DefaultConstructor_InnerExceptionNullAndMessageDefault()
        {
            ...
            var expectedMessage = string.Format("Exception of type '{0}' was thrown.",
                                                typeof(PipingCalculatorException).FullName);
        ...
        public void Constructor_SerializationRoundTrip_ExceptionProperlyInitialized()
        {
            ...
            var originalException = new PipingCalculatorException("outer", originalInnerException);
            ...
            // Call
            PipingCalculatorException persistedException = SerializationTestHelper.SerializeAndDeserializeException(originalException);
