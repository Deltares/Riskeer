...
namespace Ringtoets.Piping.KernelWrapper.Test
{
    ...
    public class PipingProfileCreatorExceptionTest
    {
        ...
        public void Constructor_SerializationRoundTrip_ExceptionProperlyInitialized()
        {
            ...
            var originalException = new PipingProfileCreatorException("outer", originalInnerException);
            ...
            // Call
            PipingProfileCreatorException persistedException = SerializationTestHelper.SerializeAndDeserializeException(originalException);
