    ...
    public class SoilLayerConversionExceptionTest
    {
        ...
        public void DefaultConstructor_InnerExceptionNullAndMessageDefault()
        {
            ...
            var expectedMessage = string.Format("Exception of type '{0}' was thrown.",
                                                typeof(SoilLayerConversionException).FullName);
        ...
        public void Constructor_SerializationRoundTrip_ExceptionProperlyInitialized()
        {
            ...
            var originalException = new SoilLayerConversionException("outer", originalInnerException);
            ...
            // Call
            SoilLayerConversionException persistedException = SerializationTestHelper.SerializeAndDeserializeException(originalException);
