...
namespace Ringtoets.Piping.IO.Test.Builders
{
    ...
    public class SoilProfileBuilderExceptionTest
    {
        ...
        public void Constructor_SerializationRoundTrip_ExceptionProperlyInitialized()
        {
            ...
            var originalException = new SoilProfileBuilderException("outer", originalInnerException);
            ...
            // Call
            SoilProfileBuilderException persistedException = SerializationTestHelper.SerializeAndDeserializeException(originalException);
