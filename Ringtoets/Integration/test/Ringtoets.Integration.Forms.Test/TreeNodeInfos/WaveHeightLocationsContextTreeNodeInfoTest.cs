                ...
                using (var plugin = new RingtoetsPlugin())
                {
                    ...
                    using (new HydraRingCalculatorFactoryConfig())
                    {
                        ...
                        TestHelper.AssertLogMessages(action, messages =>
                        {
                            ...
                            StringAssert.StartsWith(string.Format("Berekening van 'Golfhoogte berekenen voor locatie '{0}'' beëindigd om:", locationName), msgs[4]);
                            StringAssert.StartsWith(string.Format("Uitvoeren van 'Golfhoogte berekenen voor locatie '{0}'' is mislukt.", locationName), msgs[5]);
                        });
