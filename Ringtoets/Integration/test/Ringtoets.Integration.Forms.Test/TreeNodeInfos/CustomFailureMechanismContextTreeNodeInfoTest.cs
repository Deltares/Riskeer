...
{
    [TestFixture]
    public class CustomFailureMechanismContextTreeNodeInfoTest
    {
        ...
        public void Initialized_Always_ExpectedPropertiesSet()
        {
            ...
            using (var plugin = new RingtoetsGuiPlugin())
            {
                ...
                // Assert
                Assert.AreEqual(typeof(CustomFailureMechanismContext), info.TagType);
        ...
        {
            return guiPlugin.GetTreeNodeInfos().First(tni => tni.TagType == typeof(CustomFailureMechanismContext));
        }

        public class TestFailureMechanism : FailureMechanismBase<CustomFailureMechanismSectionResult>
        {
