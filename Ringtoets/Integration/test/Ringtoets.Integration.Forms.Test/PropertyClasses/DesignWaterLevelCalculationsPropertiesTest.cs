...
namespace Ringtoets.Integration.Forms.Test.PropertyClasses
{
    ...
    public class DesignWaterLevelCalculationsPropertiesTest
    {
        ...
        public void GetProperties_WithData_ReturnExpectedValues()
        {
            ...
            TestHelper.AssertTypeConverter<DesignWaterLevelCalculationsProperties, ExpandableArrayConverter>(nameof(DesignWaterLevelCalculationsProperties.Calculations));
