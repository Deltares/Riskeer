...
namespace Ringtoets.Integration.Forms.Test.PresentationObjects
{
    ...
    public class DesignWaterLevelLocationsContextTest
    {
        ...
        public void Constructor_ExpectedValues()
        {
            ...
            // Call
            var presentationObject = new DesignWaterLevelLocationsContext(locations, assessmentSection);
        ...
        {
            // Call
            TestDelegate call = () => new DesignWaterLevelLocationsContext(new ObservableList<HydraulicBoundaryLocation>(), null);
