...
namespace Ringtoets.Integration.Forms.Test.Views.SectionResultViews
{
    ...
    public class StrengthStabilityLengthwiseConstructionResultViewTest
    {
        ...
        public void GivenFormWithFailureMechanismResultView_ThenExpectedColumnsAreAdded()
        {
            ...
            using (var view = new StrengthStabilityLengthwiseConstructionResultView(new ObservableList<StrengthStabilityLengthwiseConstructionFailureMechanismSectionResult>(),
        ...
        [TestFixture]
        public class StrengthStabilityLengthwiseConstructionFailureMechanismResultControlTest : FailureMechanismAssemblyResultControlTester<
        ...
        {
            protected override StrengthStabilityLengthwiseConstructionResultView CreateResultView(StrengthStabilityLengthwiseConstructionFailureMechanism failureMechanism)
            {
                return new StrengthStabilityLengthwiseConstructionResultView(failureMechanism.SectionResults,
                                                                             failureMechanism);
            }
        }
    }
