...
namespace Ringtoets.Integration.Forms.Test.Views.SectionResultViews
{
    ...
    public class MicrostabilityResultViewTest
    {
        ...
        public void Constructor_ExpectedValues()
        {
            ...
            using (var view = new MicrostabilityResultView(failureMechanism.SectionResults, failureMechanism))
            {
                ...
                Assert.IsInstanceOf<FailureMechanismResultView<MicrostabilityFailureMechanismSectionResult,
                    MicrostabilitySectionResultRow, MicrostabilityFailureMechanism>>(view);
        ...
        public void FailureMechanismResultView_WithFailureMechanismSectionResultAssigned_SectionsAddedAsRows()
        {
            ...
            var result1 = new MicrostabilityFailureMechanismSectionResult(
            ...
            var result2 = new MicrostabilityFailureMechanismSectionResult(
            ...
            var result3 = new MicrostabilityFailureMechanismSectionResult(
            ...
            var result4 = new MicrostabilityFailureMechanismSectionResult(
            ...
            SimpleAssessmentResultType simpleAssessmentResult)
        {
            // Given
            var random = new Random(21);
            var result = new MicrostabilityFailureMechanismSectionResult(
