...
namespace Ringtoets.Integration.Forms.Test.Views.SectionResultViews
{
    ...
    public class TechnicalInnovationResultViewTest
    {
        ...
        [Test]
        public void GivenFormWithFailureMechanismResultView_WhenDataSourceWithTechnicalInnovationFailureMechanismSectionResultAssigned_ThenSectionsAddedAsRows()
        {
            // Given
