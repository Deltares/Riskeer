...
namespace Ringtoets.Integration.Forms.Test.Views.SectionResultRows
{
    ...
    {
        private static GrassCoverSlipOffInwardsSectionResultRow.ConstructionProperties ConstructionProperties
        {
            get
            {
                return new GrassCoverSlipOffInwardsSectionResultRow.ConstructionProperties
                {
        ...
        public void Constructor_ConstructionPropertiesNull_ThrowsArgumentNullException()
        {
            ...
            // Call
            TestDelegate test = () => new GrassCoverSlipOffInwardsSectionResultRow(result, null);
