...
namespace Ringtoets.Integration.Forms.Test.Views.SectionResultRows
{
    ...
    public class ClosingStructureSectionResultRowTest
    {
        ...
        public void AssessmentLayerTwoA_ForTooLargeValues_ThrowsArgumentException(double value)
        {
            ...
            var message = Assert.Throws<ArgumentException>(test).Message;
            Assert.AreEqual(
                RingtoetsCommonFormsResources.ArbitraryProbabilityFailureMechanismSectionResultRow_AssessmentLayerTwoA_Value_too_large,
                message
            );
        }
        ...
        public void AssessmentLayerTwoA_ForNonNumericValues_ThrowsArgumentException(string value)
        {
            ...
            var message = Assert.Throws<ArgumentException>(test).Message;
            Assert.AreEqual(
                RingtoetsCommonFormsResources.ArbitraryProbabilityFailureMechanismSectionResultRow_AssessmentLayerTwoA_Could_not_parse_string_to_double_value,
                message
            );
        }
        ...
        public void AssessmentLayerTwoA_ForNullValue_ThrowsArgumentException()
        {
            ...
            // Assert
            var expectedMessage = RingtoetsCommonFormsResources.ArbitraryProbabilityFailureMechanismSectionResultRow_AssessmentLayerTwoA_Value_cannot_be_null;
