...
namespace Ringtoets.Integration.Forms.Test.Views
{
    ...
    {
        [Test]
        public void GivenFormWithTechnicalInnovationFailureMechanismResultView_WhenAlways_ThenExpectedColumnsAreVisible()
        {
            // Setup
        ...
        [Test]
        public void GivenFormWithTechnicalInnovationFailureMechanismResultView_WhenDataSourceWithTechnicalInnovationFailureMechanismSectionResultAssigned_ThenSectionsAddedAsRows()
        {
            // Given
        ...
        [Test]
        public void GivenFormWithTechnicalInnovationFailureMechanismResultView_WhenSectionPassesLevel0AndListenersNotified_ThenRowsForSectionBecomesDisabled()
        {
            // Given
        ...
        [Test]
        public void GivenFormWithTechnicalInnovationFailureMechanismResultView_WhenDataSourceWithOtherFailureMechanismSectionResultAssigned_ThenSectionsNotAdded()
        {
            // Given
            var section1 = new FailureMechanismSection("Section 1", new[]
            {
