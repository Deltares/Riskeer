...
{
    [TestFixture]
    public class GrassCoverSlipOffInwardsAssemblyMapDataFeaturesFactoryTest
    {
        [Test]
        public void CreateSimpleAssemblyFeatures_FailureMechanismNull_ThrowsArgumentNullException()
        {
            // Call
            TestDelegate call = () => GrassCoverSlipOffInwardsAssemblyMapDataFeaturesFactory.CreateSimpleAssemblyFeatures(null);
        ...
        public void CreateSimpleAssemblyFeatures_WithValidData_ReturnsFeaturesCollection()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                IEnumerable<MapFeature> features = GrassCoverSlipOffInwardsAssemblyMapDataFeaturesFactory.CreateSimpleAssemblyFeatures(failureMechanism);
        ...
        {
            // Call
            TestDelegate call = () => GrassCoverSlipOffInwardsAssemblyMapDataFeaturesFactory.CreateDetailedAssemblyFeatures(null);
        ...
        public void CreateDetailedAssemblyFeatures_WithValidData_ReturnsFeaturesCollection()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                IEnumerable<MapFeature> features = GrassCoverSlipOffInwardsAssemblyMapDataFeaturesFactory.CreateDetailedAssemblyFeatures(failureMechanism);
        ...
        {
            // Call
            TestDelegate call = () => GrassCoverSlipOffInwardsAssemblyMapDataFeaturesFactory.CreateTailorMadeAssemblyFeatures(null);
        ...
        public void CreateTailorMadeAssemblyFeatures_WithValidData_ReturnsFeaturesCollection()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                IEnumerable<MapFeature> features = GrassCoverSlipOffInwardsAssemblyMapDataFeaturesFactory.CreateTailorMadeAssemblyFeatures(failureMechanism);
        ...
        {
            // Call
            TestDelegate call = () => GrassCoverSlipOffInwardsAssemblyMapDataFeaturesFactory.CreateCombinedAssemblyFeatures(null);
        ...
        public void CreateCombinedAssemblyFeatures_WithValidData_ReturnsFeaturesCollection()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                IEnumerable<MapFeature> features = GrassCoverSlipOffInwardsAssemblyMapDataFeaturesFactory.CreateCombinedAssemblyFeatures(failureMechanism);
