...
namespace Ringtoets.Integration.Forms.Test.Factories
{
    ...
    public class MicrostabilityAssemblyMapDataFeaturesFactoryTest
    {
        ...
        {
            // Call
            TestDelegate call = () => MicrostabilityAssemblyMapDataFeaturesFactory.CreateSimpleAssemblyFeatures(null);
        ...
        public void CreateSimpleAssemblyFeatures_WithValidData_ReturnsFeaturesCollection()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                IEnumerable<MapFeature> features = MicrostabilityAssemblyMapDataFeaturesFactory.CreateSimpleAssemblyFeatures(failureMechanism);
        ...
        {
            // Call
            TestDelegate call = () => MicrostabilityAssemblyMapDataFeaturesFactory.CreateDetailedAssemblyFeatures(null);
        ...
        public void CreateDetailedAssemblyFeatures_WithValidData_ReturnsFeaturesCollection()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                IEnumerable<MapFeature> features = MicrostabilityAssemblyMapDataFeaturesFactory.CreateDetailedAssemblyFeatures(failureMechanism);
        ...
        {
            // Call
            TestDelegate call = () => MicrostabilityAssemblyMapDataFeaturesFactory.CreateTailorMadeAssemblyFeatures(null);
        ...
        public void CreateTailorMadeAssemblyFeatures_WithValidData_ReturnsFeaturesCollection()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                IEnumerable<MapFeature> features = MicrostabilityAssemblyMapDataFeaturesFactory.CreateTailorMadeAssemblyFeatures(failureMechanism);
        ...
        {
            // Call
            TestDelegate call = () => MicrostabilityAssemblyMapDataFeaturesFactory.CreateCombinedAssemblyFeatures(null);
        ...
        public void CreateCombinedAssemblyFeatures_WithValidData_ReturnsFeaturesCollection()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                IEnumerable<MapFeature> features = MicrostabilityAssemblyMapDataFeaturesFactory.CreateCombinedAssemblyFeatures(failureMechanism);
