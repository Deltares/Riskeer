...
namespace Ringtoets.Integration.Data.Test.StandAlone
{
    ...
    public class WaterPressureAsphaltCoverFailureMechanismTest
    {
        ...
        [Test]
        public void AddSection_WithSection_AddedWaterPressureAsphaltCoverFailureMechanismSectionResult()
        {
            // Setup
            var failureMechanism = new WaterPressureAsphaltCoverFailureMechanism();
            ...
            Assert.IsInstanceOf<WaterPressureAsphaltCoverFailureMechanismSectionResult>(failureMechanism.SectionResults.ElementAt(0));
        }
    }
}