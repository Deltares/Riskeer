...
namespace Ringtoets.Integration.Data.Test.StandAlone
{
    ...
    public class MicrostabilityFailureMechanismTest
    {
        ...
        [Test]
        public void AddSection_WithSection_AddedMicrostabilityFailureMechanismSectionResult()
        {
            // Setup
            var failureMechanism = new MicrostabilityFailureMechanism();
            ...
            Assert.IsInstanceOf<MicrostabilityFailureMechanismSectionResult>(failureMechanism.SectionResults.ElementAt(0));
        }
    }
}