...
namespace Ringtoets.Integration.Data.Test.StandAlone
{
    ...
    public class TechnicalInnovationFailureMechanismTest
    {
        ...
        [Test]
        public void AddSection_WithSection_AddedTechnicalInnovationFailureMechanismSectionResult()
        {
            // Setup
            var failureMechanism = new TechnicalInnovationFailureMechanism();
            ...
            Assert.IsInstanceOf<TechnicalInnovationFailureMechanismSectionResult>(failureMechanism.SectionResults.ElementAt(0));
        }
    }
}