...
{
    [TestFixture]
    public class MacroStabilityOutwardsFailureMechanismHelperTest
    {
        [Test]
        public void HasManualAssemblyResults_FailureMechanismNull_ThrowsArgumentNullException()
        {
            // Call
            TestDelegate call = () => MacroStabilityOutwardsFailureMechanismHelper.HasManualAssemblyResults(null);
