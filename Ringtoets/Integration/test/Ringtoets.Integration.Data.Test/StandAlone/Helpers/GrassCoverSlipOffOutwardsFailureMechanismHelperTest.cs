...
{
    [TestFixture]
    public class GrassCoverSlipOffOutwardsFailureMechanismHelperTest
    {
        [Test]
        public void HasManualAssemblyResults_FailureMechanismNull_ThrowsArgumentNullException()
        {
            // Call
            TestDelegate call = () => GrassCoverSlipOffOutwardsFailureMechanismHelper.HasManualAssemblyResults(null);
