    ...
    public class GrassCoverSlipOffInwardsFailureMechanismAssemblyFactoryTest
    {
        ...
        public void AssembleFailureMechanism_WithoutManualInput_SetsInputOnCalculator()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                GrassCoverSlipOffInwardsFailureMechanismAssemblyFactory.AssembleFailureMechanism(sectionResults);
        ...
        public void AssembleFailureMechanism_AssemblyRan_ReturnsOutput()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                FailureMechanismAssemblyCategoryGroup actualOutput =
                    GrassCoverSlipOffInwardsFailureMechanismAssemblyFactory.AssembleFailureMechanism(
                        Enumerable.Empty<GrassCoverSlipOffInwardsFailureMechanismSectionResult>());
