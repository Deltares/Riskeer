...
{
    [TestFixture]
    public class IllustrationPointNodeFaultTreeContextPropertyInfoTest
    {
        ...
        {
            // Assert
            Assert.AreEqual(typeof(IllustrationPointNodeFaultTreeContext), info.DataType);
        ...
        public void CreateInstance_ValidArguments_ReturnFaultTreeIllustrationPointBaseProperties()
        {
            ...
            var context = new IllustrationPointNodeFaultTreeContext(
