...
{
    [TestFixture]
    public class FailureMechanismAssemblyCategoriesContextTreeNodeInfoTest
    {
        [Test]
        ...
        {
            return plugin.GetTreeNodeInfos().First(tni => tni.TagType == typeof(FailureMechanismAssemblyCategoriesContext));
        }
    }
}