...
namespace Ringtoets.Integration.Plugin.Test.TreeNodeInfos
{
    ...
    public class StrengthStabilityLengthwiseConstructionFailureMechanismContextTreeNodeInfoTest
    {
        ...
        public void Text_Always_ReturnsName()
        {
            ...
            var failureMechanismContext = new StrengthStabilityLengthwiseConstructionFailureMechanismContext(failureMechanism, assessmentSection);
        ...
        public void ChildNodeObjects_FailureMechanismIsRelevant_ReturnChildDataNodes()
        {
            ...
            var failureMechanismSectionsContext = (StrengthStabilityLengthwiseConstructionFailureMechanismSectionsContext) inputFolder.Contents.ElementAt(0);
            ...
            var failureMechanismResultsContext = (FailureMechanismSectionResultContext<StrengthStabilityLengthwiseConstructionFailureMechanismSectionResult>)
        ...
        private void ChildNodeObjects_FailureMechanismIsRelevantWithSectionResults_OutputNodeAdded<T>() where T : FailureMechanismSectionResult
        {
            ...
            var failureMechanismContext = mocks.Stub<StrengthStabilityLengthwiseConstructionFailureMechanismContext>(failureMechanism, assessmentSection);
