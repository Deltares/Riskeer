...
namespace Ringtoets.Integration.Plugin.Test.TreeNodeInfos
{
    ...
    public class GrassCoverSlipOffOutwardsFailureMechanismSectionResultContextTreeNodeInfoTest
    {
        ...
        public void Initialized_Always_ExpectedPropertiesSet()
        {
            ...
            // Assert
            Assert.AreEqual(typeof(FailureMechanismSectionResultContext<GrassCoverSlipOffOutwardsFailureMechanismSectionResult>), info.TagType);
        ...
        public void Text_Always_ReturnsName()
        {
            ...
            var context = new FailureMechanismSectionResultContext<GrassCoverSlipOffOutwardsFailureMechanismSectionResult>(mechanism.SectionResults, mechanism);
