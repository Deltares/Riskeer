...
namespace Ringtoets.Integration.Plugin.Test.TreeNodeInfos
{
    ...
    public class GrassCoverSlipOffInwardsFailureMechanismSectionResultContextTreeNodeInfoTest
    {
        ...
        public void Initialized_Always_ExpectedPropertiesSet()
        {
            ...
            // Assert
            Assert.AreEqual(typeof(FailureMechanismSectionResultContext<GrassCoverSlipOffInwardsFailureMechanismSectionResult>), info.TagType);
        ...
        public void Text_Always_ReturnsName()
        {
            ...
            var context = new FailureMechanismSectionResultContext<GrassCoverSlipOffInwardsFailureMechanismSectionResult>(mechanism.SectionResults, mechanism);
