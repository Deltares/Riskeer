...
namespace Ringtoets.Integration.Plugin.Test.ViewInfos
{
    ...
    public class MacroStabilityOutwardsFailureMechanismViewInfoTest
    {
        ...
        {
            // Assert
            Assert.AreEqual(typeof(IFailureMechanismContext<MacroStabilityOutwardsFailureMechanism>), info.DataType);
            Assert.AreEqual(typeof(IFailureMechanismContext<MacroStabilityOutwardsFailureMechanism>), info.ViewDataType);
        }
