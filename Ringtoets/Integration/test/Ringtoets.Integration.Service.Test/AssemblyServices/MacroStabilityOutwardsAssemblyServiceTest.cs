...
{
    [TestFixture]
    public class MacroStabilityOutwardsAssemblyServiceTest
    {
        [Test]
        public void AssembleSimpleAssessment_FailureMechanismSectionResultNull_ThrowsArgumentNullException()
        {
            // Call
            TestDelegate call = () => MacroStabilityOutwardsAssemblyService.AssembleSimpleAssessment(null);
        ...
        public void AssembleSimpleAssessment_WithInput_SetsInputOnCalculator()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                MacroStabilityOutwardsAssemblyService.AssembleSimpleAssessment(sectionResult);
        ...
        public void AssembleSimpleAssessment_CalculatorThrowsExceptions_DoesNothing()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                TestDelegate call = () => MacroStabilityOutwardsAssemblyService.AssembleSimpleAssessment(sectionResult);
