...
namespace Ringtoets.Integration.IO.Test.Factories
{
    ...
    {
        [Test]
        public void CreateExportableMicrostabilityFailureMechanism_FailureMechanismNull_ThrowsArgumentNullException()
        {
            // Call
            TestDelegate call = () =>
                ExportableMicrostabilityFailureMechanismFactory.CreateExportableMicrostabilityFailureMechanism(null);
        ...
        [Test]
        public void CreateExportableMicrostabilityFailureMechanism_WithFailureMechanismNotRelevant_ReturnsDefaultExportableFailureMechanism()
        {
            // Setup
            ...
            ExportableFailureMechanism<ExportableFailureMechanismAssemblyResult> exportableFailureMechanism =
                ExportableMicrostabilityFailureMechanismFactory.CreateExportableMicrostabilityFailureMechanism(failureMechanism);
        ...
        [Test]
        public void CreateExportableMicrostabilityFailureMechanism_WithFailureMechanismRelevant_ReturnsExportableFailureMechanism()
        {
            // Setup
            var random = new Random(21);
            var failureMechanism = new MicrostabilityFailureMechanism();
