...
{
    /// <summary>
    /// This class is a presentation object for <see cref="GrassCoverSlipOffInwardsFailureMechanism.Sections"/>.
    /// </summary>
    public class GrassCoverSlipOffInwardsFailureMechanismSectionsContext : FailureMechanismSectionsContext
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GrassCoverSlipOffInwardsFailureMechanismSectionsContext"/> class.
        /// </summary>
        /// <param name="wrappedData">The <see cref="GrassCoverSlipOffInwardsFailureMechanism"/> to wrap.</param>
