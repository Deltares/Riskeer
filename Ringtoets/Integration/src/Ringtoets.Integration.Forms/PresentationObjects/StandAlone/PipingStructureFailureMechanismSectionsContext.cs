...
{
    /// <summary>
    /// This class is a presentation object for <see cref="PipingStructureFailureMechanism.Sections"/>.
    /// </summary>
    public class PipingStructureFailureMechanismSectionsContext : FailureMechanismSectionsContext
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PipingStructureFailureMechanismSectionsContext"/> class.
        /// </summary>
        /// <param name="wrappedData">The <see cref="PipingStructureFailureMechanism"/> to wrap.</param>
