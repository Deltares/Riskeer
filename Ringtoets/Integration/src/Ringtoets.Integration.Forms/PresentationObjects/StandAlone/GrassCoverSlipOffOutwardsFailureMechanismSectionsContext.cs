...
{
    /// <summary>
    /// This class is a presentation object for <see cref="GrassCoverSlipOffOutwardsFailureMechanism.Sections"/>.
    /// </summary>
    public class GrassCoverSlipOffOutwardsFailureMechanismSectionsContext : FailureMechanismSectionsContext
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GrassCoverSlipOffOutwardsFailureMechanismSectionsContext"/> class.
        /// </summary>
        /// <param name="wrappedData">The <see cref="GrassCoverSlipOffOutwardsFailureMechanism"/> to wrap.</param>
