...
{
    /// <summary>
    /// Class for displaying <see cref="MacrostabilityInwardsFailureMechanismSectionResult"/>  as a row in a grid view.
    /// </summary>
    public class MacrostabilityInwardsSectionResultRow : FailureMechanismSectionResultRow<MacrostabilityInwardsFailureMechanismSectionResult>
    {
        ...
        /// <summary>
        /// Gets or sets the value representing the result of the <see cref="MacrostabilityInwardsFailureMechanismSectionResult.AssessmentLayerOne"/>.
        /// </summary>
