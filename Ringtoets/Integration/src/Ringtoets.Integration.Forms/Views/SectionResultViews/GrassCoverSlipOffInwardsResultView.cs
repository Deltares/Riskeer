...
namespace Ringtoets.Integration.Forms.Views.SectionResultViews
{
    ...
    public class GrassCoverSlipOffInwardsResultView
        : FailureMechanismResultView<GrassCoverSlipOffInwardsFailureMechanismSectionResult, GrassCoverSlipOffInwardsFailureMechanism>
    {
        /// <inheritdoc />
        /// <summary>
        ...
        private void OnCellFormatting(object sender, DataGridViewCellFormattingEventArgs eventArgs)
        {
            if (eventArgs.ColumnIndex > SimpleAssessmentColumnIndex)
            {
                SimpleAssessmentResultType simpleAssessmentResult =
                    ((GrassCoverSlipOffInwardsSectionResultRow) GetDataAtRow(eventArgs.RowIndex)).SimpleAssessmentResult;
