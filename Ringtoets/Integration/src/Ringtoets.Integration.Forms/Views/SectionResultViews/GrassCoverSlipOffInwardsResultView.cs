    ...
    public class GrassCoverSlipOffInwardsResultView : FailureMechanismResultView<GrassCoverSlipOffInwardsFailureMechanismSectionResult>
    {
        ...
        private void AddDataGridColumns()
        {
            ...
            DataGridViewControl.AddTextBoxColumn(
                TypeUtils.GetMemberName<GrassCoverSlipOffInwardsSectionResultRow>(sr => sr.Name),
                Resources.FailureMechanismResultView_InitializeDataGridView_Section_name,
                true
            );
            DataGridViewControl.AddCheckBoxColumn(
                TypeUtils.GetMemberName<GrassCoverSlipOffInwardsSectionResultRow>(sr => sr.AssessmentLayerOne),
                Resources.FailureMechanismResultView_InitializeDataGridView_Assessment_layer_one
            );
            DataGridViewControl.AddComboBoxColumn(
                TypeUtils.GetMemberName<GrassCoverSlipOffInwardsSectionResultRow>(sr => sr.AssessmentLayerTwoA),
            ...
            DataGridViewControl.AddTextBoxColumn(
                TypeUtils.GetMemberName<GrassCoverSlipOffInwardsSectionResultRow>(sr => sr.AssessmentLayerThree),
