...
namespace Ringtoets.Integration.Data.StandAlone.AssemblyFactories
{
    ...
    /// </summary>
    public static class MacroStabilityOutwardsAssemblyService
    {
        /// <summary>
        ...
        public static void AssembleSimpleAssessment(MacroStabilityOutwardsFailureMechanismSectionResult failureMechanismSectionResult)
        {
