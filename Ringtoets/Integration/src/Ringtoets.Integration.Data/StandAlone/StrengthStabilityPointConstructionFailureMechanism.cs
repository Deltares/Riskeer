...
namespace Ringtoets.Integration.Data.StandAlone
{
    ...
    /// </summary>
    public class StrengthStabilityPointConstructionFailureMechanism : FailureMechanismBase, IHasSectionResults<CustomProbabilityFailureMechanismSectionResult>
    {
