...
namespace Ringtoets.Integration.Data.StandAlone
{
    ...
    /// </summary>
    public class ClosingStructureFailureMechanism : FailureMechanismBase, IHasSectionResults<CustomFailureMechanismSectionResult>
    {
        private readonly List<CustomFailureMechanismSectionResult> sectionResults;
