...
namespace Ringtoets.Integration.IO.Factories
{
    ...
    public static class ExportableFailureMechanismFactory
    {
        ...
        public static ExportableFailureMechanism<ExportableFailureMechanismAssemblyResultWithProbability> CreateDefaultExportableFailureMechanismWithProbability(ExportableFailureMechanismType failureMechanismCode,
