...
namespace Ringtoets.Integration.IO.Factories
{
    ...
    public static class ExportableStrengthStabilityLengthwiseConstructionFailureMechanismFactory
    {
        ...
        public static ExportableFailureMechanism<ExportableFailureMechanismAssemblyResult> CreateExportableStrengthStabilityLengthwiseConstructionFailureMechanism(
