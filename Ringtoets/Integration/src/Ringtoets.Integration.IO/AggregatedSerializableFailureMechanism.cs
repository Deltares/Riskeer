...
namespace Ringtoets.Integration.IO
{
    ...
    public class AggregatedSerializableFailureMechanism
    {
        ...
        /// </summary>
        /// <param name="failureMechanism">The <see cref="FailureMechanism"/>.</param>
        /// <param name="failureMechanismSectionCollection">The <see cref="AssemblyTool.IO.Model.SerializableFailureMechanismSectionCollection"/>
