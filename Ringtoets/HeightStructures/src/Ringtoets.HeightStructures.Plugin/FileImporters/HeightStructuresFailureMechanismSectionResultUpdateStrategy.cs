...
namespace Ringtoets.HeightStructures.Plugin.FileImporters
{
    ...
    /// </summary>
    public class HeightStructuresFailureMechanismSectionResultUpdateStrategy : IFailureMechanismSectionResultUpdateStrategy<HeightStructuresFailureMechanismSectionResult>
    {
