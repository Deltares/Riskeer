...
{
    [TestFixture]
    public class HeightStructuresAssemblyMapDataFeaturesFactoryTest
    {
        [Test]
        public void CreateSimpleAssemblyFeatures_FailureMechanismNull_ThrowsArgumentNullException()
        {
            // Call
            TestDelegate call = () => HeightStructuresAssemblyMapDataFeaturesFactory.CreateSimpleAssemblyFeatures(null);
        ...
        public void CreateSimpleAssemblyFeatures_WithValidData_ReturnsFeaturesCollection()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                IEnumerable<MapFeature> features = HeightStructuresAssemblyMapDataFeaturesFactory.CreateSimpleAssemblyFeatures(failureMechanism);
        ...
        public void CreateDetailedAssemblyFeatures_FailureMechanismNull_ThrowsArgumentNullException()
        {
            ...
            // Call
            TestDelegate call = () => HeightStructuresAssemblyMapDataFeaturesFactory.CreateDetailedAssemblyFeatures(null, assessmentSection);
        ...
        {
            // Call
            TestDelegate call = () => HeightStructuresAssemblyMapDataFeaturesFactory.CreateDetailedAssemblyFeatures(new HeightStructuresFailureMechanism(), null);
        ...
        public void CreateDetailedAssemblyFeatures_WithValidData_ReturnsFeaturesCollection()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                IEnumerable<MapFeature> features = HeightStructuresAssemblyMapDataFeaturesFactory.CreateDetailedAssemblyFeatures(failureMechanism,
                                                                                                                                 assessmentSection);
        ...
        public void CreateTailorMadeAssemblyFeatures_FailureMechanismNull_ThrowsArgumentNullException()
        {
            ...
            // Call
            TestDelegate call = () => HeightStructuresAssemblyMapDataFeaturesFactory.CreateTailorMadeAssemblyFeatures(null, assessmentSection);
        ...
        {
            // Call
            TestDelegate call = () => HeightStructuresAssemblyMapDataFeaturesFactory.CreateTailorMadeAssemblyFeatures(new HeightStructuresFailureMechanism(), null);
        ...
        public void CreateTailorMadeAssemblyFeatures_WithValidData_ReturnsFeaturesCollection()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                IEnumerable<MapFeature> features = HeightStructuresAssemblyMapDataFeaturesFactory.CreateTailorMadeAssemblyFeatures(failureMechanism,
                                                                                                                                   assessmentSection);
        ...
        public void CreateCombinedAssemblyFeatures_FailureMechanismNull_ThrowsArgumentNullException()
        {
            ...
            // Call
            TestDelegate call = () => HeightStructuresAssemblyMapDataFeaturesFactory.CreateCombinedAssemblyFeatures(null, assessmentSection);
        ...
        {
            // Call
            TestDelegate call = () => HeightStructuresAssemblyMapDataFeaturesFactory.CreateCombinedAssemblyFeatures(new HeightStructuresFailureMechanism(), null);
        ...
        public void CreateCombinedAssemblyFeatures_WithValidData_ReturnsFeaturesCollection()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                IEnumerable<MapFeature> features = HeightStructuresAssemblyMapDataFeaturesFactory.CreateCombinedAssemblyFeatures(failureMechanism,
                                                                                                                                 assessmentSection);
