...
namespace Ringtoets.HeightStructures.Plugin.Test.UpdateInfos
{
    ...
    public class HeightStructuresFailureMechanismSectionsContextUpdateInfoTest
    {
        ...
        private static UpdateInfo GetUpdateInfo(HeightStructuresPlugin plugin)
        {
            return plugin.GetUpdateInfos().First(ii => ii.DataType == typeof(HeightStructuresFailureMechanismSectionsContext));
        }
    }
}