...
namespace Ringtoets.HeightStructures.Plugin.Test.ExportInfos
{
    [TestFixture]
    public class HeightStructuresCalculationGroupContextExportInfoTest
    {
        ...
        private static ExportInfo GetExportInfo(HeightStructuresPlugin plugin)
        {
            return plugin.GetExportInfos().First(ei => ei.DataType == typeof(HeightStructuresCalculationGroupContext));
        }
    }
}