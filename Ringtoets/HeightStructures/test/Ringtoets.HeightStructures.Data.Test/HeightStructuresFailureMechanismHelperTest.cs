...
{
    [TestFixture]
    public class HeightStructuresFailureMechanismHelperTest
    {
        [Test]
        public void HasManualAssemblyResults_FailureMechanismNull_ThrowsArgumentNullException()
        {
            // Call
            TestDelegate call = () => HeightStructuresFailureMechanismHelper.HasManualAssemblyResults(null);
        ...
        public void HasManualAssemblyResults_FailureMechanismWithManualAssemblyResults_ReturnsTrue()
        {
            ...
            // Call
            bool hasManualAssemblyResults = HeightStructuresFailureMechanismHelper.HasManualAssemblyResults(failureMechanism);
