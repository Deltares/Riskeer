...
namespace Riskeer.Common.Forms.Test.PresentationObjects
{
    ...
    public class WaveHeightCalculationsForUserDefinedTargetProbabilitiesGroupContextTest
    {
        ...
        public void Constructor_ExpectedValues()
        {
            ...
            // Call
            var context = new WaveHeightCalculationsForUserDefinedTargetProbabilitiesGroupContext(locations, assessmentSection);
        ...
        {
            // Call
            void Call() => new WaveHeightCalculationsForUserDefinedTargetProbabilitiesGroupContext(new ObservableList<HydraulicBoundaryLocation>(), null);
