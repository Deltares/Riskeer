...
namespace Riskeer.Common.Data.Hydraulics
{
    ...
    public class HydraulicBoundaryCalculationSettings
    {
        ...
        /// <param name="hrdFileVersion">The version of the hydraulic boundary database.</param>
        ...
        /// </summary>
        public string HrdFileVersion { get; }
