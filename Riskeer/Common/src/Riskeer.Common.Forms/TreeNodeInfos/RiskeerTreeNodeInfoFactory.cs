...
namespace Riskeer.Common.Forms.TreeNodeInfos
{
    ...
    public static class RiskeerTreeNodeInfoFactory
    {
        ...
        public static TreeNodeInfo<TCalculationGroupContext> CreateCalculationGroupContextTreeNodeInfo<TCalculationGroupContext>(
            ...
            Func<TCalculationGroupContext, object, ITreeViewCommands, ContextMenuStrip> contextMenuStrip,
        ...
        public static TreeNodeInfo<TCalculationContext> CreateCalculationContextTreeNodeInfo<TCalculationContext>(
            ...
            Func<TCalculationContext, object, ITreeViewCommands, ContextMenuStrip> contextMenuStrip,
        ...
        public static TreeNodeInfo<TFailureMechanismContext> CreateRegistrationStateContextTreeNodeInfo<TFailureMechanismContext>(
            ...
            Func<TFailureMechanismContext, object, ITreeViewCommands, ContextMenuStrip> enabledContextMenuStrip,
            Func<TFailureMechanismContext, object, ITreeViewCommands, ContextMenuStrip> disabledContextMenuStrip)
        ...
        public static TreeNodeInfo<TFailureMechanismContext> CreateFailureMechanismStateContextTreeNodeInfo<TFailureMechanismContext>(
            ...
            Func<TFailureMechanismContext, object, ITreeViewCommands, ContextMenuStrip> contextMenuStrip)
            where TFailureMechanismContext : IFailureMechanismContext<IFailureMechanism>
        {
            return new TreeNodeInfo<TFailureMechanismContext>
            {
        ...
        private static void CalculationGroupOnDrop(object droppedData, object newParentData, object oldParentData, int position, ITreeViewCommands treeViewControl)
        {
        ...
        private abstract class DroppingCalculationInContainerStrategy
        {
            ...
            public virtual void Execute(object draggedData, ICalculationBase calculationBase, int newPosition, ITreeViewCommands treeViewControl)
            {
        ...
        private sealed class DroppingCalculationToNewContainer : DroppingCalculationInContainerStrategy
        {
            ...
            public override void Execute(object draggedData, ICalculationBase calculationBase, int newPosition, ITreeViewCommands treeViewControl)
            {
                MoveCalculationItemToNewOwner(calculationBase, newPosition);
