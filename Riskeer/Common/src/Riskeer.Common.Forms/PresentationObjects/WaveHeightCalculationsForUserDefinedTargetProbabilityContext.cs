...
namespace Riskeer.Common.Forms.PresentationObjects
{
    ...
    public class WaveHeightCalculationsForUserDefinedTargetProbabilityContext : ObservableWrappedObjectContextBase<HydraulicBoundaryLocationCalculationsForTargetProbability>
    {
        ...
        /// </summary>
        /// <param name="wrappedData">The calculations wrapped by the <see cref="WaveHeightCalculationsForUserDefinedTargetProbabilityContext"/>.</param>
        /// <param name="assessmentSection">The <see cref="IAssessmentSection"/> that the <see cref="WaveHeightCalculationsForUserDefinedTargetProbabilityContext"/> belongs to.</param>
