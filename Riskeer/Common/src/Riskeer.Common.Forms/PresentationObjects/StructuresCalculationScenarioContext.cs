...
namespace Riskeer.Common.Forms.PresentationObjects
{
        ...
        where TFailureMechanism : IFailureMechanism
    {
        ...
        protected StructuresCalculationScenarioContext(StructuresCalculationScenario<TInput> calculation,
        ...
        public override bool Equals(WrappedObjectContextBase<StructuresCalculationScenario<TInput>> other)
        {
            return base.Equals(other)
                   && other is StructuresCalculationScenarioContext<TInput, TFailureMechanism> otherContext
                   && ReferenceEquals(Parent, otherContext.Parent);
        }

        public override bool Equals(object obj)
        {
            return Equals(obj as StructuresCalculationScenarioContext<TInput, TFailureMechanism>);
        }
