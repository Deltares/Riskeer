...
{
    /// <summary>
    /// Validation rule to validate a <see cref="LogNormalDistribution"/>.
    /// </summary>
    public class LogNormalDistributionRule : ValidationRule
    {
        private readonly LogNormalDistribution distribution;
        private readonly string parameterName;

        /// <summary>
        /// Creates a new instance of <see cref="LogNormalDistributionRule"/> to validate a <see cref="LogNormalDistribution"/>.
        /// </summary>
        ...
        public LogNormalDistributionRule(LogNormalDistribution distribution, string parameterName)
        {
        ...
        public override IEnumerable<string> Validate()
        {
            ...
            {
                yield return string.Format(Resources.ProbabilisticDistributionValidationRule_Mean_of_0_must_be_positive_value,
                                           parameterName);
            }
