...
namespace Riskeer.Common.Service.IllustrationPoints
{
    ...
    public static class StochastConverter
    {
            ...
            HydraRingSubMechanismIllustrationPointStochast hydraRingSubMechanismIllustrationPointStochast)
        {
            ...
            return new SubMechanismIllustrationPointStochast(hydraRingSubMechanismIllustrationPointStochast.Name, hydraRingSubMechanismIllustrationPointStochast.Unit,
