...
{
    /// <summary>
    /// Factory for assembling assembly results for a stability stone cover failure mechanism.
    /// </summary>
    public static class StabilityStoneCoverFailureMechanismAssemblyFactory
    {
        ...
        /// <param name="failureMechanism">The <see cref="StabilityStoneCoverFailureMechanism"/> the section result belongs to.</param>
        ...
        /// </summary>
        /// <param name="failureMechanism">The <see cref="StabilityStoneCoverFailureMechanism"/> to assemble.</param>
