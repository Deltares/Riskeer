...
{
    /// <summary>
    /// Presentation object for wave conditions output of the <see cref="StabilityStoneCoverFailureMechanism"/>.
    /// </summary>
    public class StabilityStoneCoverWaveConditionsOutputContext : ObservableWrappedObjectContextBase<StabilityStoneCoverWaveConditionsOutput>
    {
        /// <summary>
        ...
        /// Gets the input.
        /// </summary>
        public StabilityStoneCoverWaveConditionsInput Input { get; }
    }
}