...
namespace Riskeer.StabilityStoneCover.Forms.PresentationObjects.RegistrationState
{
    /// <summary>
    /// Presentation object for <see cref="StabilityStoneCoverFailureMechanism"/> in the registration state.
    /// </summary>
