...
namespace Riskeer.StabilityStoneCover.Service
{
    ...
    /// stability stone cover wave conditions calculations.
    /// </summary>
    public static class StabilityStoneCoverWaveConditionsCalculationActivityFactory
    {
        /// <summary>
        ...
        public static IEnumerable<CalculatableActivity> CreateCalculationActivities(StabilityStoneCoverFailureMechanism failureMechanism,
        ...
        /// <exception cref="ArgumentNullException">Thrown when any parameter is <c>null</c>.</exception>
        public static CalculatableActivity CreateCalculationActivity(StabilityStoneCoverWaveConditionsCalculation calculation,
                                                                     StabilityStoneCoverFailureMechanism failureMechanism,
                                                                     IAssessmentSection assessmentSection)
        {
            if (calculation == null)
