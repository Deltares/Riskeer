...
{
    [TestFixture]
    public class StabilityStoneCoverWaveConditionsCalculationTypeTest : EnumWithResourcesDisplayNameTestFixture<StabilityStoneCoverWaveConditionsCalculationType>
    {
        protected override IDictionary<StabilityStoneCoverWaveConditionsCalculationType, int> ExpectedValueForEnumValues
        {
            get
            {
        ...
        protected override IDictionary<StabilityStoneCoverWaveConditionsCalculationType, string> ExpectedDisplayNameForEnumValues
        {
            get
            {
