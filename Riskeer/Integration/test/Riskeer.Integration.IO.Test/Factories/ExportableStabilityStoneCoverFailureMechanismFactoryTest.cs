...
namespace Riskeer.Integration.IO.Test.Factories
{
    ...
    public class ExportableStabilityStoneCoverFailureMechanismFactoryTest
    {
        ...
        public void CreateExportableFailureMechanism_FailureMechanismNull_ThrowsArgumentNullException()
        {
            ...
            // Call
            void Call() => ExportableStabilityStoneCoverFailureMechanismFactory.CreateExportableFailureMechanism(null, assessmentSection);
        ...
        {
            // Call
            void Call() => ExportableStabilityStoneCoverFailureMechanismFactory.CreateExportableFailureMechanism(new StabilityStoneCoverFailureMechanism(), null);
