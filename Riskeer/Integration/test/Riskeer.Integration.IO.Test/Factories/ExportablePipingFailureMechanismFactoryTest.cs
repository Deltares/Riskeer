...
namespace Riskeer.Integration.IO.Test.Factories
{
    ...
    public class ExportablePipingFailureMechanismFactoryTest
    {
        ...
        public void CreateExportableFailureMechanism_FailureMechanismNull_ThrowsArgumentNullException()
        {
            ...
            // Call
            void Call() => ExportablePipingFailureMechanismFactory.CreateExportableFailureMechanism(null, assessmentSection);
        ...
        {
            // Call
            void Call() => ExportablePipingFailureMechanismFactory.CreateExportableFailureMechanism(new PipingFailureMechanism(), null);
