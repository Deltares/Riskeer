    ...
    public class ExportableAssessmentSectionFactoryTest
    {
        ...
        public void CreateExportableAssessmentSection_WithAssessmentSectionWithReferenceLine_ReturnsExpectedValues()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                Assert.AreEqual(ExportableAssemblyMethod.BOI2A2, exportableAssessmentSectionAssemblyResult.AssemblyGroupAssemblyMethod);
                ...
                Assert.AreEqual(ExportableAssemblyMethod.BOI3C1, exportableCombinedSectionAssembly.CombinedSectionAssemblyResult.AssemblyMethod);
