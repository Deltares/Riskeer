...
namespace Riskeer.Integration.IO.Test.Factories
{
    ...
    public class ExportableWaveImpactAsphaltCoverFailureMechanismFactoryTest
    {
        ...
        public void CreateExportableFailureMechanism_FailureMechanismNull_ThrowsArgumentNullException()
        {
            ...
            // Call
            void Call() => ExportableWaveImpactAsphaltCoverFailureMechanismFactory.CreateExportableFailureMechanism(null, assessmentSection);
        ...
        {
            // Call
            void Call() => ExportableWaveImpactAsphaltCoverFailureMechanismFactory.CreateExportableFailureMechanism(new WaveImpactAsphaltCoverFailureMechanism(), null);
