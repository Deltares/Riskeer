...
namespace Riskeer.Integration.IO.Test.Factories
{
    ...
    public class ExportableMicrostabilityFailureMechanismFactoryTest
    {
        ...
        public void CreateExportableFailureMechanism_FailureMechanismNull_ThrowsArgumentNullException()
        {
            ...
            // Call
            void Call() => ExportableMicrostabilityFailureMechanismFactory.CreateExportableFailureMechanism(null, assessmentSection);
        ...
        {
            // Call
            void Call() => ExportableMicrostabilityFailureMechanismFactory.CreateExportableFailureMechanism(new MicrostabilityFailureMechanism(), null);
