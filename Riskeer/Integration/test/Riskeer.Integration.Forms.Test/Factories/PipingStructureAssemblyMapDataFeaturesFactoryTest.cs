...
{
    [TestFixture]
    public class PipingStructureAssemblyMapDataFeaturesFactoryTest
    {
        [Test]
        public void CreateSimpleAssemblyFeatures_FailureMechanismNull_ThrowsArgumentNullException()
        {
            // Call
            TestDelegate call = () => PipingStructureAssemblyMapDataFeaturesFactory.CreateSimpleAssemblyFeatures(null);
        ...
        public void CreateSimpleAssemblyFeatures_WithValidData_ReturnsFeaturesCollection()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                IEnumerable<MapFeature> features = PipingStructureAssemblyMapDataFeaturesFactory.CreateSimpleAssemblyFeatures(failureMechanism);
        ...
        {
            // Call
            TestDelegate call = () => PipingStructureAssemblyMapDataFeaturesFactory.CreateDetailedAssemblyFeatures(null);
        ...
        public void CreateDetailedAssemblyFeatures_WithValidData_ReturnsFeaturesCollection()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                IEnumerable<MapFeature> features = PipingStructureAssemblyMapDataFeaturesFactory.CreateDetailedAssemblyFeatures(failureMechanism);
        ...
        {
            // Call
            TestDelegate call = () => PipingStructureAssemblyMapDataFeaturesFactory.CreateTailorMadeAssemblyFeatures(null);
        ...
        public void CreateTailorMadeAssemblyFeatures_WithValidData_ReturnsFeaturesCollection()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                IEnumerable<MapFeature> features = PipingStructureAssemblyMapDataFeaturesFactory.CreateTailorMadeAssemblyFeatures(failureMechanism);
        ...
        {
            // Call
            TestDelegate call = () => PipingStructureAssemblyMapDataFeaturesFactory.CreateCombinedAssemblyFeatures(null);
        ...
        public void CreateCombinedAssemblyFeatures_WithValidData_ReturnsFeaturesCollection()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                IEnumerable<MapFeature> features = PipingStructureAssemblyMapDataFeaturesFactory.CreateCombinedAssemblyFeatures(failureMechanism);
