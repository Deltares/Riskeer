...
namespace Riskeer.Integration.Forms.Test.Views.SectionResultViews
{
    ...
    public class GrassCoverSlipOffOutwardsResultViewOldTest
    {
            ...
            GrassCoverSlipOffOutwardsSectionResultRowOld>
        {
            ...
            {
                return new GrassCoverSlipOffOutwardsResultViewOld(failureMechanism.SectionResultsOld,
                                                               failureMechanism);
            }
        }
        ...
        {
            var failureMechanismResultView = new GrassCoverSlipOffOutwardsResultViewOld(failureMechanism.SectionResultsOld,
                                                                                     failureMechanism);
