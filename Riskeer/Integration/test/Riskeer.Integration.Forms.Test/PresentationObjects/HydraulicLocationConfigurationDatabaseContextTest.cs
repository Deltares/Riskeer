...
{
    [TestFixture]
    public class HydraulicLocationConfigurationDatabaseContextTest
    {
        [Test]
        ...
        {
            // Call
            void Call() => new HydraulicLocationConfigurationDatabaseContext(new HydraulicBoundaryData(), null);
