...
{
    [TestFixture]
    public class HrdFileGroupContextTest
    {
        [Test]
        public void Constructor_ExpectedValues()
        {
            ...
            // Call
            var context = new HrdFileGroupContext(assessmentSection.HydraulicBoundaryDatabase, assessmentSection);
        ...
        {
            // Call
            TestDelegate call = () => new HrdFileGroupContext(new HydraulicBoundaryDatabase(), null);
