...
{
    [TestFixture]
    public class HydraulicBoundaryDatabasesContextImportInfoTest
    {
        ...
        public void SetUp()
        {
            ...
            importInfo = plugin.GetImportInfos().First(i => i.DataType == typeof(HydraulicBoundaryDatabasesContext));
        }
