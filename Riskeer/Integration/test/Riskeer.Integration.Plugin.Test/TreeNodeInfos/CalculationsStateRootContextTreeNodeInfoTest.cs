    ...
    public class CalculationsStateRootContextTreeNodeInfoTest
    {
        ...
        public void ChildNodeObjects_WithContext_ReturnsChildrenOfData()
        {
            ...
            using (var plugin = new RiskeerPlugin())
            {
                ...
                var stabilityStoneCoverCalculationsContext = (StabilityStoneCoverCalculationsContext) objects[4];
                Assert.AreSame(assessmentSection.StabilityStoneCover, stabilityStoneCoverCalculationsContext.WrappedData);
                Assert.AreSame(assessmentSection, stabilityStoneCoverCalculationsContext.Parent);

                var waveImpactAsphaltCoverCalculationsContext = (WaveImpactAsphaltCoverCalculationsContext) objects[5];
                ...
                var heightStructuresCalculationsContext = (HeightStructuresCalculationsContext) objects[7];
                ...
                var closingStructuresCalculationsContext = (ClosingStructuresCalculationsContext) objects[8];
                ...
                var stabilityPointStructuresCalculationsContext = (StabilityPointStructuresCalculationsContext) objects[9];
                ...
                var duneErosionCalculationsContext = (DuneErosionCalculationsContext) objects[10];
                Assert.AreSame(assessmentSection.DuneErosion, duneErosionCalculationsContext.WrappedData);
                Assert.AreSame(assessmentSection, duneErosionCalculationsContext.Parent);
