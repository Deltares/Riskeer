...
{
    [TestFixture]
    public class HrdFileContextTreeNodeInfoTest : NUnitFormTest
    {
        [Test]
        ...
        [Test]
        public void Text_WithContext_ReturnHrdFileName()
        {
            // Setup
            ...
            using (var plugin = new RiskeerPlugin())
            {
                ...
                // Call
                string text = info.Text(hrdFileContext);

                // Assert
                Assert.AreEqual(hrdFileName, text);
            }
        }
        ...
        {
            return plugin.GetTreeNodeInfos().First(tni => tni.TagType == typeof(HrdFileContext));
        }
    }
}