...
namespace Riskeer.Integration.Plugin.Test.TreeNodeInfos
{
    ...
    public class WaterLevelCalculationsForUserDefinedTargetProbabilityContextTreeNodeInfoTest : NUnitFormTest
    {
        ...
        public void ContextMenuStrip_Always_CallsContextMenuBuilderMethods()
        {
            ...
            var nodeData = new WaterLevelCalculationsForUserDefinedTargetProbabilityContext(new HydraulicBoundaryLocationCalculationsForTargetProbability(0.1),
                                                                                            assessmentSection);
        ...
        public void GivenCalculationWithIllustrationPoints_WhenClearIllustrationPointsClicked_ThenInquiryAndExpectedOutputAndCalculationObserversNotified(bool continuation)
        {
            ...
            var nodeData = new WaterLevelCalculationsForUserDefinedTargetProbabilityContext(new HydraulicBoundaryLocationCalculationsForTargetProbability(0.01)
                                                                                            {
                                                                                                HydraulicBoundaryLocationCalculations =
                                                                                                {
                                                                                                    calculation
