...
namespace Riskeer.Integration.Plugin.Test.ViewInfos
{
    ...
    public class TechnicalInnovationResultViewInfoTest
    {
        ...
        public void SetUp()
        {
            ...
            info = plugin.GetViewInfos().First(tni => tni.ViewType == typeof(TechnicalInnovationResultViewOld));
        }
        ...
        public void CloseForData_ViewNotCorrespondingToRemovedFailureMechanismContext_ReturnsFalse()
        {
            // Setup
            var failurePathContext = mocks.StrictMock<IFailurePathContext<IFailureMechanism>>();
            failurePathContext.Expect(fm => fm.WrappedData).Return(new TechnicalInnovationFailureMechanism());
            mocks.ReplayAll();
        ...
        public void CreateInstance_WithContext_ReturnsView()
        {
            ...
            // Assert
            Assert.IsInstanceOf<TechnicalInnovationResultViewOld>(view);
        }
    }
}