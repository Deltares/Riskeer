...
{
    [TestFixture]
    public class HydraulicLoadsStateRootContextViewInfoTest
    {
        ...
        public void SetUp()
        {
            ...
            info = plugin.GetViewInfos().First(tni => tni.DataType == typeof(HydraulicLoadsStateRootContext));
        }
        ...
        {
            // Setup
            var context = new HydraulicLoadsStateRootContext(new AssessmentSection(AssessmentSectionComposition.Dike));
