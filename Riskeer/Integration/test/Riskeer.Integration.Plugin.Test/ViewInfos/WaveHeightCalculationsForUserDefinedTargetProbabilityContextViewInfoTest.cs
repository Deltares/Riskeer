        ...
        public void CreateInstance_WithContext_SetsExpectedDataGridViewData()
        {
            ...
            using (var plugin = new RiskeerPlugin())
            {
                ...
                using (var testForm = new Form())
                {
                    ...
                    Assert.AreEqual(calculations.HydraulicBoundaryLocationCalculations[0].Output.Result.ToString(), rows[0].Cells[waveHeightColumnIndex].FormattedValue);
                    Assert.AreEqual(calculations.HydraulicBoundaryLocationCalculations[1].Output.Result.ToString(), rows[1].Cells[waveHeightColumnIndex].FormattedValue);
                }
            }
        }
