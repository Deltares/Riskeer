...
{
    [TestFixture]
    public class WaveHeightCalculationsForUserDefinedTargetProbabilityContextViewInfoTest
    {
        ...
        public void ViewType_Always_ReturnsViewType()
        {
            ...
            using (var plugin = new RiskeerPlugin())
            {
                ...
                // Assert
                Assert.AreEqual(typeof(WaveHeightCalculationsView), viewType);
            }
        }
        ...
        public void GetViewName_WithContext_ReturnsExpectedViewName()
        {
            ...
            using (var plugin = new RiskeerPlugin())
            {
                ...
                // Assert
                Assert.AreEqual("Golfhoogten bij doelkans - 1/100", viewName);
            }
        }
        ...
        public void CreateInstance_WithContext_SetsExpectedViewProperties()
        {
            // Setup
            var assessmentSection = new AssessmentSectionStub();
            var context = new WaveHeightCalculationsForUserDefinedTargetProbabilityContext(new HydraulicBoundaryLocationCalculationsForTargetProbability(0.1),
                                                                                           assessmentSection);
        ...
        public void CreateInstance_WithContext_SetsExpectedDataGridViewData()
        {
            ...
            using (var plugin = new RiskeerPlugin())
            {
                ...
                using (var testForm = new Form())
                {
                    ...
                    Assert.AreEqual(calculationsForTargetProbability.HydraulicBoundaryLocationCalculations[0].Output.Result.ToString(), rows[0].Cells[waveHeightColumnIndex].FormattedValue);
                    Assert.AreEqual(calculationsForTargetProbability.HydraulicBoundaryLocationCalculations[1].Output.Result.ToString(), rows[1].Cells[waveHeightColumnIndex].FormattedValue);
                }
            }
        }
        ...
        public void AfterCreate_WithGuiSet_SetsSpecificPropertiesToView()
        {
            ...
            using (var view = new WaveHeightCalculationsView(calculationsForTargetProbability,
                                                             new AssessmentSectionStub(),
                                                             () => "1/100"))
        ...
        {
            return plugin.GetViewInfos().First(tni => tni.DataType == typeof(WaveHeightCalculationsForUserDefinedTargetProbabilityContext));
        }
    }
}