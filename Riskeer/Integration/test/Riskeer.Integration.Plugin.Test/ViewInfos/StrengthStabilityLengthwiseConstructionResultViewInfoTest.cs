...
namespace Riskeer.Integration.Plugin.Test.ViewInfos
{
    ...
    public class StrengthStabilityLengthwiseConstructionResultViewInfoTest
    {
        ...
        public void SetUp()
        {
            ...
            info = plugin.GetViewInfos().First(tni => tni.ViewType == typeof(StrengthStabilityLengthwiseConstructionResultViewOld));
        }
        ...
        public void CloseForData_ViewNotCorrespondingToRemovedFailureMechanismContext_ReturnsFalse()
        {
            // Setup
            var failurePathContext = mocks.StrictMock<IFailurePathContext<IFailureMechanism>>();
            failurePathContext.Expect(fm => fm.WrappedData).Return(new StrengthStabilityLengthwiseConstructionFailureMechanism());
            mocks.ReplayAll();
        ...
        public void CreateInstance_WithContext_ReturnsView()
        {
            ...
            // Assert
            Assert.IsInstanceOf<StrengthStabilityLengthwiseConstructionResultViewOld>(view);
        }
    }
}