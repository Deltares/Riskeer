...
{
    [TestFixture]
    public class AssessmentSectionAssemblyGroupsContextPropertyInfoTest
    {
        ...
        public void SetUp()
        {
            ...
            info = plugin.GetPropertyInfos().First(tni => tni.DataType == typeof(AssessmentSectionAssemblyGroupsContext));
        }
        ...
        public void Initialized_Always_ExpectedPropertiesSet()
        {
            ...
            Assert.AreEqual(typeof(AssessmentSectionAssemblyGroupsProperties), info.PropertyObjectType);
        }
