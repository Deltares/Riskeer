...
{
    [TestFixture]
    public class WaterLevelCalculationsForUserDefinedTargetProbabilityContextPropertyInfoTest
    {
        [Test]
        public void Initialized_Always_ExpectedPropertiesSet()
        {
            ...
            using (var plugin = new RiskeerPlugin())
            {
                ...
                // Assert
                Assert.AreEqual(typeof(WaterLevelCalculationsForUserDefinedTargetProbabilityProperties), info.PropertyObjectType);
            }
        }
        ...
        {
            return plugin.GetPropertyInfos().First(pi => pi.DataType == typeof(WaterLevelCalculationsForUserDefinedTargetProbabilityContext));
        }
    }
}