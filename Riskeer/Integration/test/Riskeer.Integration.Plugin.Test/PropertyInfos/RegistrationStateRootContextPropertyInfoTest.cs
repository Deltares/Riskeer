...
{
    [TestFixture]
    public class RegistrationStateRootContextPropertyInfoTest
    {
        [Test]
        public void Initialized_Always_ExpectedPropertiesSet()
        {
            ...
            using (var plugin = new RiskeerPlugin())
            {
                ...
                // Assert
                Assert.AreEqual(typeof(RegistrationStateRootContext), info.DataType);
                Assert.AreEqual(typeof(RegistrationStateAssessmentSectionProperties), info.PropertyObjectType);
            }
        }
        ...
        {
            return plugin.GetPropertyInfos().First(tni => tni.PropertyObjectType == typeof(RegistrationStateAssessmentSectionProperties));
        }
    }
}