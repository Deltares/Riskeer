    ...
    public class RiskeerPluginTest : NUnitFormTest
    {
        ...
        public void GetPropertyInfos_ReturnsSupportedPropertyInfos()
        {
            ...
            using (var plugin = new RiskeerPlugin())
            {
                ...
                PluginTestHelper.AssertPropertyInfoDefined(
                    propertyInfos,
                    typeof(HrdFileContext),
                    typeof(HrdFileProperties));
        ...
        public void GetViewInfos_ReturnsSupportedViewInfos()
        {
            ...
            })
            {
                ...
                PluginTestHelper.AssertViewInfoDefined(
                    ...
                    typeof(IObservableEnumerable<NonAdoptableWithProfileProbabilityFailureMechanismSectionResult>),
                    typeof(NonAdoptableWithProfileProbabilityFailureMechanismResultView<GrassCoverSlipOffOutwardsFailureMechanism>));
        ...
        public void GetTreeNodeInfos_ReturnsSupportedTreeNodeInfos()
        {
            ...
            using (var plugin = new RiskeerPlugin())
            {
                ...
                // Assert
                Assert.AreEqual(43, treeNodeInfos.Length);
                ...
                Assert.IsTrue(treeNodeInfos.Any(tni => tni.TagType == typeof(HrdFileGroupContext)));
                Assert.IsTrue(treeNodeInfos.Any(tni => tni.TagType == typeof(HrdFileContext)));
