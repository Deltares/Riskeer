...
{
    [TestFixture]
    public class WaterLevelCalculationsForNormTargetProbabilityContextExportInfoTest
    {
        [Test]
        ...
        {
            return plugin.GetExportInfos().First(ei => ei.DataType == typeof(WaterLevelCalculationsForNormTargetProbabilityContext));
        }
    }
}