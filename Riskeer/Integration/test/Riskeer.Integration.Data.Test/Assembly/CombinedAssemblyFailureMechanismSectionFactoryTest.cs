    ...
    public class CombinedAssemblyFailureMechanismSectionFactoryTest
    {
        ...
        public void CreateInput_WithAllFailureMechanisms_ReturnsInputCollection()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                for (var i = 1; i < assessmentSection.SpecificFailurePaths.Count; i++)
                {
                    AssertSectionsWithResult(assessmentSection.SpecificFailurePaths[i--].SectionResults, calculator.FailureMechanismSectionAssemblyResultOutput.FailureMechanismSectionAssemblyGroup, inputs.ElementAt(14 + i));
                }
            }
        }
        ...
        public void CreateInput_WithAllFailureMechanismsAndCalculatorThrowsException_ReturnsInputCollection()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                for (var i = 1; i < assessmentSection.SpecificFailurePaths.Count; i++)
                {
                    AssertSectionsWithResult(assessmentSection.SpecificFailurePaths[i--].SectionResults, FailureMechanismSectionAssemblyGroup.Gr, inputs.ElementAt(14 + i));
                }
            }
        }
        ...
        private static IEnumerable<TestCaseData> GetFailureMechanismTestCaseData()
        {
            ...
            yield return new TestCaseData(assessmentSection, assessmentSection.SpecificFailurePaths.Single());
        }
