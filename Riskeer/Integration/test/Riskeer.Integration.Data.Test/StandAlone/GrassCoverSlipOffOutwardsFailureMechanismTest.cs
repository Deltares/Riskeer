...
namespace Riskeer.Integration.Data.Test.StandAlone
{
    ...
    public class GrassCoverSlipOffOutwardsFailureMechanismTest
    {
        ...
        public void DefaultConstructor_Always_PropertiesSet()
        {
            ...
            Assert.IsInstanceOf<IHasSectionResults<GrassCoverSlipOffOutwardsFailureMechanismSectionResultOld, NonAdoptableWithProfileProbabilityFailureMechanismSectionResult>>(failureMechanism);
