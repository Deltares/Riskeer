...
namespace Riskeer.Integration.Data.Test.StandAlone
{
    ...
    public class WaterPressureAsphaltCoverFailureMechanismTest
    {
        ...
        public void DefaultConstructor_Always_PropertiesSet()
        {
            ...
            Assert.IsInstanceOf<IHasSectionResults<WaterPressureAsphaltCoverFailureMechanismSectionResultOld, NonAdoptableWithProfileProbabilityFailureMechanismSectionResult>>(failureMechanism);
