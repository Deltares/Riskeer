...
namespace Riskeer.Integration.Plugin.FileImporters
{
    ...
    /// </summary>
    public class AdoptableWithProfileProbabilityFailureMechanismSectionResultUpdateStrategy
        : IFailureMechanismSectionResultUpdateStrategy<AdoptableWithProfileProbabilityFailureMechanismSectionResult>
    {
