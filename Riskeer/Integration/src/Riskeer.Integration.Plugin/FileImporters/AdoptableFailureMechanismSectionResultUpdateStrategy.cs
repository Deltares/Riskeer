...
{
    /// <summary>
    /// An update strategy that can be used to update a <see cref="AdoptableFailureMechanismSectionResult"/>
    /// instance with data from an old instance.
    /// </summary>
    public class AdoptableFailureMechanismSectionResultUpdateStrategy : IFailureMechanismSectionResultUpdateStrategy<AdoptableFailureMechanismSectionResult>
    {
