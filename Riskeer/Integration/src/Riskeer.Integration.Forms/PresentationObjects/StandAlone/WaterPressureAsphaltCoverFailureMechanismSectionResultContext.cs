...
namespace Riskeer.Integration.Forms.PresentationObjects.StandAlone
{
    ...
    public class WaterPressureAsphaltCoverFailureMechanismSectionResultContext : FailureMechanismSectionResultContext<NonAdoptableWithProfileProbabilityFailureMechanismSectionResult>
    {
        ...
        public WaterPressureAsphaltCoverFailureMechanismSectionResultContext(IObservableEnumerable<NonAdoptableWithProfileProbabilityFailureMechanismSectionResult> wrappedSectionResults,
