...
namespace Riskeer.Integration.Forms.PresentationObjects.StandAlone
{
    ...
    /// </summary>
    public class WaterPressureAsphaltCoverFailureMechanismSectionResultContext : FailureMechanismSectionResultContext<NonAdoptableFailureMechanismSectionResult>
    {
        /// <summary>
        ...
        /// <param name="failureMechanism">The <see cref="WaterPressureAsphaltCoverFailureMechanism"/>
        ...
        public WaterPressureAsphaltCoverFailureMechanismSectionResultContext(IObservableEnumerable<NonAdoptableFailureMechanismSectionResult> wrappedSectionResults,
