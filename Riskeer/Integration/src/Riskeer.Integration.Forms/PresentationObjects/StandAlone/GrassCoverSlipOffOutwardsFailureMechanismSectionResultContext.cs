...
namespace Riskeer.Integration.Forms.PresentationObjects.StandAlone
{
    ...
    /// for the <see cref="GrassCoverSlipOffOutwardsFailureMechanism"/>.
    /// </summary>
    public class GrassCoverSlipOffOutwardsFailureMechanismSectionResultContext : ProbabilityFailureMechanismSectionResultContext<NonAdoptableWithProfileProbabilityFailureMechanismSectionResult>
    {
        /// <summary>
        /// Creates a new instance of <see cref="GrassCoverSlipOffOutwardsFailureMechanismSectionResultContext"/>.
        /// </summary>
        ...
        /// <param name="failureMechanism">The <see cref="GrassCoverSlipOffOutwardsFailureMechanism"/>
        ...
        public GrassCoverSlipOffOutwardsFailureMechanismSectionResultContext(IObservableEnumerable<NonAdoptableWithProfileProbabilityFailureMechanismSectionResult> wrappedSectionResults,
