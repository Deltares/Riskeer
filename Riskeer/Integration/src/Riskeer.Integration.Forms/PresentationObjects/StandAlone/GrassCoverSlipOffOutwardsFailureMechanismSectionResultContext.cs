...
namespace Riskeer.Integration.Forms.PresentationObjects.StandAlone
{
    ...
    /// </summary>
    public class GrassCoverSlipOffOutwardsFailureMechanismSectionResultContext : FailureMechanismSectionResultContext<NonAdoptableFailureMechanismSectionResult>
    {
        /// <summary>
        ...
        public GrassCoverSlipOffOutwardsFailureMechanismSectionResultContext(IObservableEnumerable<NonAdoptableFailureMechanismSectionResult> wrappedSectionResults,
