...
{
    /// <summary>
    /// This class is a presentation object for <see cref="WaterPressureAsphaltCoverFailureMechanism.Sections"/>.
    /// </summary>
    public class WaterPressureAsphaltCoverFailureMechanismSectionsContext : FailureMechanismSectionsContext
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WaterPressureAsphaltCoverFailureMechanismSectionsContext"/> class.
        /// </summary>
        /// <param name="wrappedData">The <see cref="WaterPressureAsphaltCoverFailureMechanism"/> to wrap.</param>
