...
namespace Riskeer.Integration.IO.Factories
{
    ...
    public static class ExportableWaveImpactAsphaltCoverFailureMechanismFactory
    {
        ...
        /// </summary>
        /// <param name="failureMechanism">The <see cref="WaveImpactAsphaltCoverFailureMechanism"/> to create a collection of
        ...
        private static IEnumerable<ExportableFailureMechanismSectionAssemblyWithProbabilityResult> CreateFailureMechanismSectionResults(
            WaveImpactAsphaltCoverFailureMechanism failureMechanism, IAssessmentSection assessmentSection)
        {
            ...
            {
                FailureMechanismSectionAssemblyResult assemblyResult = WaveImpactAsphaltCoverFailureMechanismAssemblyFactory.AssembleSection(
