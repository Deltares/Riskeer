...
namespace Riskeer.Integration.IO.Factories
{
    ...
    public static class ExportableGrassCoverErosionOutwardsFailureMechanismFactory
    {
        ...
        /// </summary>
        /// <param name="failureMechanism">The <see cref="GrassCoverErosionOutwardsFailureMechanism"/> to create a collection of
        ...
        private static IEnumerable<ExportableFailureMechanismSectionAssemblyWithProbabilityResult> CreateFailureMechanismSectionResults(
            GrassCoverErosionOutwardsFailureMechanism failureMechanism, IAssessmentSection assessmentSection)
        {
            ...
            {
                FailureMechanismSectionAssemblyResult assemblyResult = GrassCoverErosionOutwardsFailureMechanismAssemblyFactory.AssembleSection(
