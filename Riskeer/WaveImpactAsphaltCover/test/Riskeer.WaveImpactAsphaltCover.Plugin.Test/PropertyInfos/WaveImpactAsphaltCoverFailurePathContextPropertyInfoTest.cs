...
{
    [TestFixture]
    public class WaveImpactAsphaltCoverFailurePathContextPropertyInfoTest
    {
        [Test]
        public void Initialized_Always_ExpectedPropertiesSet()
        {
            ...
            using (var plugin = new WaveImpactAsphaltCoverPlugin())
            {
                ...
                Assert.AreEqual(typeof(WaveImpactAsphaltCoverFailurePathProperties), info.PropertyObjectType);
            }
        }
        ...
        public void CreateInstance_WithContext_SetsFailureMechanismAsData()
        {
            ...
            using (var plugin = new WaveImpactAsphaltCoverPlugin())
            {
                ...
                // Assert
                Assert.IsInstanceOf<WaveImpactAsphaltCoverFailurePathProperties>(objectProperties);
