...
namespace Riskeer.WaveImpactAsphaltCover.Plugin.Test.UpdateInfos
{
    ...
    public class WaveImpactAsphaltCoverFailureMechanismSectionsContextUpdateInfoTest
    {
        ...
        private static UpdateInfo GetUpdateInfo(WaveImpactAsphaltCoverPlugin plugin)
        {
            return plugin.GetUpdateInfos().First(ii => ii.DataType == typeof(WaveImpactAsphaltCoverFailureMechanismSectionsContext));
        }
    }
}