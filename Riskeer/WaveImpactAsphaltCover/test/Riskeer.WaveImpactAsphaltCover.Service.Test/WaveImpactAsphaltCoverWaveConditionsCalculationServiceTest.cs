...
namespace Riskeer.WaveImpactAsphaltCover.Service.Test
{
    ...
    public class WaveImpactAsphaltCoverWaveConditionsCalculationServiceTest
    {
        ...
        public void Calculate_CalculationWithForeshoreAndDoesNotUseBreakWaterAndHasInvalidBreakWaterHeight_PerformCalculationAndLogStartAndEnd(double breakWaterHeight)
        {
            ...
            WaveImpactAsphaltCoverWaveConditionsCalculation calculation = GetDefaultCalculation(assessmentSection.HydraulicBoundaryData.GetLocations().First());
            ...
            calculatorFactory.Received(2).CreateWaveConditionsCosineCalculator(Arg.Any<HydraRingCalculationSettings>());
        }
        ...
        public void Calculate_Always_InputPropertiesCorrectlySentToCalculator(BreakWaterType breakWaterType)
        {
            // Setup
            IAssessmentSection assessmentSection = CreateAssessmentSectionWithHydraulicBoundaryOutput();
            WaveImpactAsphaltCoverWaveConditionsCalculation calculation = GetValidCalculation(assessmentSection.HydraulicBoundaryData.GetLocations().First());
