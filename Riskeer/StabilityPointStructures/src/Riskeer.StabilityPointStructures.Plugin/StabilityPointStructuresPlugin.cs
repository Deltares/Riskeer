...
namespace Riskeer.StabilityPointStructures.Plugin
{
    ...
    public class StabilityPointStructuresPlugin : PluginBase
    {
        ...
        private static bool CloseFailureMechanismResultViewForData(StabilityPointStructuresFailureMechanismResultView view, object viewData)
        {
            ...
            if (viewData is IFailureMechanismContext<StabilityPointStructuresFailureMechanism> failureMechanismContext)
            {
        ...
        private ContextMenuStrip FailureMechanismEnabledContextMenuStrip(StabilityPointStructuresFailureMechanismContext context,
                                                                         object parentData,
                                                                         ...
                                                                         TreeViewControl treeViewControl)
        {
            ...
            StructuresCalculationScenario<StabilityPointStructuresInput>[] calculations = group
                                                                                          .GetCalculations()
        ...
        private static ClearStructuresCalculationOutputChangeHandler<StabilityPointStructuresInput> CreateClearCalculationOutputChangeHandler(
            IEnumerable<StructuresCalculationScenario<StabilityPointStructuresInput>> calculations, IInquiryHelper inquiryHelper, IViewCommands viewCommands)
        {
            return new ClearStructuresCalculationOutputChangeHandler<StabilityPointStructuresInput>(
