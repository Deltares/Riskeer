...
namespace Riskeer.StabilityPointStructures.Forms.Test.Views.CalculationsState
{
    ...
    public class StabilityPointStructuresFailureMechanismViewTest
    {
        ...
        public void Constructor_FailureMechanismNull_ThrowsArgumentNullException()
        {
            ...
            // Call
            void Call() => new StabilityPointStructuresFailureMechanismView(null, assessmentSection);
        ...
        {
            // Call
            void Call() => new StabilityPointStructuresFailureMechanismView(new StabilityPointStructuresFailureMechanism(), null);
        ...
        public void GivenViewWithAssessmentSectionData_WhenAssessmentSectionUpdatedAndNotified_ThenMapDataUpdated()
        {
            ...
            observers[foreshoreProfilesObserverIndex].DidNotReceive().UpdateObserver();
            observers[structuresObserverIndex].DidNotReceive().UpdateObserver();
        ...
        private static void AssertCalculationsMapData(IEnumerable<StructuresCalculation<StabilityPointStructuresInput>> calculations, MapData mapData)
        {
            ...
            StructuresCalculation<StabilityPointStructuresInput>[] calculationsArray = calculations.ToArray();
        ...
        private static IObserver[] AttachMapDataObservers(IEnumerable<MapData> mapData)
        {
            ...
            var structuresMapDataObserver = Substitute.For<IObserver>();
