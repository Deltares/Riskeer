...
namespace Riskeer.Storage.Core.Test.Read.StrengthStabilityLengthwiseConstruction
{
    [TestFixture]
    public class StrengthStabilityLengthwiseConstructionFailureMechanismMetaEntityReadExtensionsTest
    {
        ...
        {
            // Call
            void Call() => ((StrengthStabilityLengthwiseConstructionFailureMechanismMetaEntity) null).Read();
