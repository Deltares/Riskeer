...
namespace Riskeer.Storage.Core.Test.Read.FailureMechanismSectionResults
{
    ...
    public class FailureMechanismSectionResultEntityReadExtensionsTest
    {
        ...
        #region AdoptableWithProfileProbabilityFailureMechanismSectionResultEntity

        [Test]
        public void ReadAdoptableWithProfileProbabilityFailureMechanismSectionResultEntity_EntityNull_ThrowsArgumentNullException()
        {
            // Setup
        ...
        #region NonAdoptableWithProfileProbabilityFailureMechanismSectionResultEntity

        [Test]
        public void ReadNonAdoptableWithProfileProbabilityFailureMechanismSectionResultEntity_EntityNull_ThrowsArgumentNullException()
        {
            // Call
