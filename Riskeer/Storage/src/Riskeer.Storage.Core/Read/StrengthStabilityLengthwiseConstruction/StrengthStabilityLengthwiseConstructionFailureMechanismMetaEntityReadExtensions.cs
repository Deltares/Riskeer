...
namespace Riskeer.Storage.Core.Read.StrengthStabilityLengthwiseConstruction
{
    /// <summary>
    ...
    internal static class StrengthStabilityLengthwiseConstructionFailureMechanismMetaEntityReadExtensions
    {
        ...
        /// </summary>
        /// <param name="entity">The <see cref="StrengthStabilityLengthwiseConstructionFailureMechanismMetaEntity"/> to create
        /// <see cref="GeneralInput"/> for.</param>
        /// <returns>A new <see cref="GeneralInput"/>.</returns>
        /// <exception cref="ArgumentNullException">Thrown when <paramref name="entity"/> is <c>null</c>.</exception>
        internal static GeneralInput Read(this StrengthStabilityLengthwiseConstructionFailureMechanismMetaEntity entity)
        {
            if (entity == null)
            {
