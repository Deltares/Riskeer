...
namespace Riskeer.Storage.Core.Create
{
    ...
    internal static class AssessmentSectionCreateExtensions
    {
        ...
        internal static AssessmentSectionEntity Create(this AssessmentSection section, PersistenceRegistry registry)
        {
            ...
            AddEntityForHydraulicBoundaryData(section.HydraulicBoundaryData, entity, registry);
        ...
        private static void AddEntityForHydraulicBoundaryData(HydraulicBoundaryData hydraulicBoundaryData, AssessmentSectionEntity entity, PersistenceRegistry registry)
        {
            if (hydraulicBoundaryData.IsLinked())
            {
                entity.HydraulicBoundaryDataEntities.Add(hydraulicBoundaryData.Create(registry));
            }
        }
