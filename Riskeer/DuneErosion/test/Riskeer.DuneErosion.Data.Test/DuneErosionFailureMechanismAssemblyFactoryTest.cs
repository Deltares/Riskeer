...
namespace Riskeer.DuneErosion.Data.Test
{
    ...
    public class DuneErosionFailureMechanismAssemblyFactoryTest
    {
        ...
        public void AssembleFailureMechanism_FailureMechanismNull_ThrowsArgumentNullException()
        {
            ...
            // Call
            void Call() => DuneErosionFailureMechanismAssemblyFactory.AssembleFailureMechanism(null, assessmentSection);
        ...
        public void AssembleFailureMechanism_AssessmentSectionNull_ThrowsArgumentNullException()
        {
            ...
            // Call
            void Call() => DuneErosionFailureMechanismAssemblyFactory.AssembleFailureMechanism(failureMechanism, null);
        ...
        public void AssembleFailureMechanism_CalculatorThrowsException_ThrowsAssemblyException()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                void Call() => DuneErosionFailureMechanismAssemblyFactory.AssembleFailureMechanism(failureMechanism, assessmentSection);
