            ...
            using (var treeViewControl = new TreeViewControl())
            {
                ...
                using (new HydraRingCalculatorFactoryConfig(calculatorFactory))
                {
                    ...
                    TestHelper.AssertLogMessages(() => contextMenu.Items[contextMenuCalculateAllIndex].PerformClick(), messages =>
                    {
                        ...
                        Assert.AreEqual($"Hydraulische belastingen berekenen voor locatie '{locationName1}' ({categoryBoundaryName}) is gestart.", messageList[0]);
                        ...
                        Assert.AreEqual($"Hydraulische belastingenberekening voor locatie '{locationName1}' ({categoryBoundaryName}) is niet geconvergeerd.", messageList[4]);
                        ...
                        Assert.AreEqual($"Hydraulische belastingen berekenen voor locatie '{locationName1}' ({categoryBoundaryName}) is gelukt.", messageList[7]);

                        Assert.AreEqual($"Hydraulische belastingen berekenen voor locatie '{locationName2}' ({categoryBoundaryName}) is gestart.", messageList[8]);
                        ...
                        Assert.AreEqual($"Hydraulische belastingenberekening voor locatie '{locationName2}' ({categoryBoundaryName}) is niet geconvergeerd.", messageList[12]);
                        ...
                        Assert.AreEqual($"Hydraulische belastingen berekenen voor locatie '{locationName2}' ({categoryBoundaryName}) is gelukt.", messageList[15]);
                    });
                }
            }
        }
