                                                                                  ...
                                                                                  ICalculationMessageProvider messageProvider)
        {
            ...
            return new DuneLocationCalculationOutput(converged,
                                                     new DuneLocationCalculationOutput.ConstructionProperties
                                                     {
                                                         ...
                                                         MeanTidalAmplitude = calculator.MeanTidalAmplitude,
                                                         WaveDirectionalSpread = calculator.WaveDirectionalSpread,
                                                         TideSurgePhaseDifference = calculator.TideSurgePhaseDifference,
