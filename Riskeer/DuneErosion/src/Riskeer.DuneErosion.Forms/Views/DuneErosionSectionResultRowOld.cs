...
namespace Riskeer.DuneErosion.Forms.Views
{
    ...
    /// </summary>
    public class DuneErosionSectionResultRowOld : FailureMechanismSectionResultRowOld<DuneErosionFailureMechanismSectionResultOld>
    {
        ...
        /// <summary>
        /// Creates a new instance of <see cref="DuneErosionSectionResultRowOld"/>.
        /// </summary>
        /// <param name="sectionResult">The <see cref="DuneErosionFailureMechanismSectionResultOld"/> to wrap
        /// so that it can be displayed as a row.</param>
        /// <param name="constructionProperties">The property values required to create an instance of
        /// <see cref="DuneErosionSectionResultRowOld"/>.</param>
        /// <exception cref="ArgumentNullException">Thrown when any parameter is <c>null</c>.</exception>
        /// <exception cref="NotSupportedException">Thrown when <see cref="FailureMechanismSectionAssemblyCategoryGroup"/>
        /// is a valid value, but unsupported.</exception>
        internal DuneErosionSectionResultRowOld(DuneErosionFailureMechanismSectionResultOld sectionResult,
        ...
        /// <summary>
        /// Class holding the various construction parameters for <see cref="DuneErosionSectionResultRowOld"/>.
        /// </summary>
