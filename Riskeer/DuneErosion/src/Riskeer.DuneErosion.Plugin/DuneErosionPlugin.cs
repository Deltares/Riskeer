...
namespace Riskeer.DuneErosion.Plugin
{
    ...
    public class DuneErosionPlugin : PluginBase
    {
        ...
        private static object[] FailureMechanismEnabledChildNodeObjects(DuneErosionFailureMechanismContext failureMechanismContext)
        {
            ...
            return new object[]
            {
                new CategoryTreeFolder(RiskeerCommonFormsResources.FailureMechanism_Inputs_DisplayName, GetInputs(wrappedData), TreeFolderCategory.Input),
        ...
        private static IEnumerable<object> GetInputs(DuneErosionFailureMechanism failureMechanism)
        {
            return new object[]
            {
