    ...
    public class WaveConditionsExporterBaseTest
    {
        ...
        public void Export_ValidData_ValidFile()
        {
            ...
            ExportableWaveConditions[] exportableWaveConditions =
            {
                ...
                }, CreateWaveConditionsOutputForExport(1.11111, 2.22222, 3.33333, 4.4, 5.5555555), CoverType.StoneCoverBlocks, "A->B", i => "1/100"),
                ...
                }, CreateWaveConditionsOutputForExport(3.33333, 1.11111, 4.44444, 2.2, 6.66666), CoverType.StoneCoverColumns, "B->C", i => "1/100")
            };
