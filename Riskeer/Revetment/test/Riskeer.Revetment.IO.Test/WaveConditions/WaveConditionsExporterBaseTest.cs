    ...
    public class WaveConditionsExporterBaseTest
    {
        ...
        public void Export_ValidData_ValidFile()
        {
            ...
            using (new DirectoryDisposeHelper(TestHelper.GetScratchPadPath(), nameof(Export_ValidData_ValidFile)))
            {
                ...
                string expectedText = $"Naam berekening; Naam HB locatie; X HB locatie (RD) [m]; Y HB locatie (RD) [m]; Naam voorlandprofiel; Dam gebruikt; Voorlandgeometrie gebruikt; Type bekleding; Doelkans [1/jaar]; Waterstand [m+NAP]; Golfhoogte (Hs) [m]; Golfperiode (Tp) [s]; Golfrichting t.o.v. dijknormaal [°]; Golfrichting t.o.v. Noord [°]; Sterkte [-]{Environment.NewLine}" +
                                      $"blocksName; ; 0.000; 0.000; ; nee; nee; Steen (blokken); 1/100; 1.11; 2.22; 3.33; 4.40; 5.56; 6.67{Environment.NewLine}" +
                                      $"columnsName; aLocation; 44.000; 123.456; ; nee; nee; Steen (zuilen); 1/100; 3.33; 1.11; 4.44; 2.20; 6.67; 7.78{Environment.NewLine}";
