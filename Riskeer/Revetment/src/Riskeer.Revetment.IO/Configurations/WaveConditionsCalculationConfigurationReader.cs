...
namespace Riskeer.Revetment.IO.Configurations
{
        ...
        where T : WaveConditionsCalculationConfiguration
    {
        ...
        {
            configuration.HydraulicBoundaryLocationName = calculationElement.GetStringValueFromDescendantElement(ConfigurationSchemaIdentifiers.HydraulicBoundaryLocationElementNew);
