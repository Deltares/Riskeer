...
namespace Riskeer.Piping.InputParameterCalculation.Test
{
    ...
    public class InputParameterCalculationServiceTest
    {
        ...
        {
            // Setup
            PipingCalculation<PipingInput> invalidPipingCalculation = PipingCalculationScenarioTestFactory.CreatePipingCalculationScenarioWithValidInput(new TestHydraulicBoundaryLocation());
        ...
        {
            // Setup
            PipingCalculation<PipingInput> validPipingCalculation = PipingCalculationScenarioTestFactory.CreatePipingCalculationScenarioWithValidInput(new TestHydraulicBoundaryLocation());
