...
namespace Riskeer.Piping.Plugin.Test.PropertyInfos.Probabilistic
{
    ...
    public class ProbabilisticPipingInputContextPropertyInfoTest
    {
        ...
        public void SetUp()
        {
            ...
            info = plugin.GetPropertyInfos().First(tni => tni.PropertyObjectType == typeof(ProbabilisticPipingInputContextProperties));
        }
        ...
        public void Initialized_Always_ExpectedPropertiesSet()
        {
            ...
            Assert.AreEqual(typeof(ProbabilisticPipingInputContextProperties), info.PropertyObjectType);
        }
