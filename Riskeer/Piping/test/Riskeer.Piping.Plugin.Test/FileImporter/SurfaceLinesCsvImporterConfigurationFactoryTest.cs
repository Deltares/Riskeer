...
namespace Riskeer.Piping.Plugin.Test.FileImporter
{
    ...
    public class SurfaceLinesCsvImporterConfigurationFactoryTest
    {
        ...
        {
            // Call
            Action test = () => SurfaceLinesCsvImporterConfigurationFactory.CreateUpdateStrategyConfiguration(new PipingFailureMechanism(), null);
        ...
        {
            // Call
            Action test = () => SurfaceLinesCsvImporterConfigurationFactory.CreateReplaceStrategyConfiguration(new PipingFailureMechanism(), null);
