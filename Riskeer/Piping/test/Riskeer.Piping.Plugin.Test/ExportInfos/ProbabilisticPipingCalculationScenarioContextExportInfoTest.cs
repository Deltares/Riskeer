...
{
    [TestFixture]
    public class ProbabilisticPipingCalculationScenarioContextExportInfoTest
    {
        ...
        public void SetUp()
        {
            ...
            info = plugin.GetExportInfos().First(ei => ei.DataType == typeof(ProbabilisticPipingCalculationScenarioContext));
        }
