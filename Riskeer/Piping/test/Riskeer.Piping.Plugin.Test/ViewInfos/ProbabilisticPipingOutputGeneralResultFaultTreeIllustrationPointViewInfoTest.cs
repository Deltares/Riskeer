...
{
    [TestFixture]
    public class ProbabilisticPipingOutputGeneralResultFaultTreeIllustrationPointViewInfoTest
    {
        ...
        public void SetUp()
        {
            ...
            info = plugin.GetViewInfos().First(tni => tni.ViewType == typeof(ProbabilisticPipingOutputGeneralResultFaultTreeIllustrationPointView));
        }
        ...
        {
            // Assert
            Assert.AreEqual(typeof(ProbabilisticPipingOutputContext), info.DataType);
            Assert.AreEqual(typeof(CalculationGroup), info.ViewDataType);
            TestHelper.AssertImagesAreEqual(Resources.ScenariosIcon, info.Image);
        }
