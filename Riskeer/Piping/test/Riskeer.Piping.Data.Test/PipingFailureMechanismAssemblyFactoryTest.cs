...
namespace Riskeer.Piping.Data.Test
{
    ...
    public class PipingFailureMechanismAssemblyFactoryTest
    {
        ...
        public void AssembleFailureMechanism_FailureMechanismNull_ThrowsArgumentNullException()
        {
            ...
            // Call
            void Call() => PipingFailureMechanismAssemblyFactory.AssembleFailureMechanism(null, assessmentSection);
        ...
        public void AssembleFailureMechanism_AssessmentSectionNull_ThrowsArgumentNullException()
        {
            ...
            // Call
            void Call() => PipingFailureMechanismAssemblyFactory.AssembleFailureMechanism(failureMechanism, null);
        ...
        public void AssembleFailureMechanism_CalculatorThrowsException_ThrowsAssemblyException()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                void Call() => PipingFailureMechanismAssemblyFactory.AssembleFailureMechanism(failureMechanism, assessmentSection);
