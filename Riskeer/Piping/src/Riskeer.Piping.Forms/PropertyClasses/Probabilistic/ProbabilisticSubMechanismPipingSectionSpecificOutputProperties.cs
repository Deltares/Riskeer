...
namespace Riskeer.Piping.Forms.PropertyClasses.Probabilistic
{
    ...
    /// </summary>
    public class ProbabilisticSubMechanismPipingSectionSpecificOutputProperties : ProbabilisticPipingSectionSpecificOutputProperties
    {
        ...
        public ProbabilisticSubMechanismPipingSectionSpecificOutputProperties(PartialProbabilisticSubMechanismPipingOutput output)
            : base(output)
        {
