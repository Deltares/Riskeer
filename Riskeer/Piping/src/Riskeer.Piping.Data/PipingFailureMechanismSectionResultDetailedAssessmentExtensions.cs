...
namespace Riskeer.Piping.Data
{
    ...
    public static class PipingFailureMechanismSectionResultDetailedAssessmentExtensions
    {
        ...
        public static double GetDetailedAssessmentProbability(this PipingFailureMechanismSectionResultOld sectionResult,
        ...
        /// <exception cref="ArgumentNullException">Thrown when any parameter is <c>null</c>.</exception>
        public static RoundedDouble GetTotalContribution(this PipingFailureMechanismSectionResultOld sectionResult,
                                                         IEnumerable<SemiProbabilisticPipingCalculationScenario> calculationScenarios)
        {
            if (sectionResult == null)
            {
        ...
        public static IEnumerable<SemiProbabilisticPipingCalculationScenario> GetCalculationScenarios(
            this PipingFailureMechanismSectionResultOld sectionResult,
            IEnumerable<SemiProbabilisticPipingCalculationScenario> calculationScenarios)
        {
            if (sectionResult == null)
            {
