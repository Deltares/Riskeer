...
namespace Riskeer.Piping.Service.Probabilistic
{
    ...
    public class ProbabilisticPipingCalculationService
    {
        ...
        {
            string preprocessorDirectory = assessmentSection.HydraulicBoundaryDatabases.EffectivePreprocessorDirectory();
            string databaseValidationProblem = HydraulicBoundaryDatabaseConnectionValidator.Validate(assessmentSection.HydraulicBoundaryDatabases);
