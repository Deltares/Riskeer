...
namespace Riskeer.Piping.Service
{
    ...
    public static class PipingCalculationService
    {
        ...
        /// </summary>
        /// <param name="calculation">The <see cref="PipingCalculation{TPipingInput,TPipingOutput}"/> for which to validate the values.</param>
        ...
        public static bool Validate(PipingCalculation<PipingInput, PipingOutput> calculation, RoundedDouble normativeAssessmentLevel)
        {
            if (calculation == null)
            {
        ...
        /// <summary>
        /// Performs a piping calculation based on the supplied <see cref="PipingCalculation{TPipingInput,TPipingOutput}"/> and sets
        /// <see cref="PipingCalculation{TPipingInput,TPipingOutput}.Output"/>
        /// based on the result if the calculation was successful. Error and status information is logged during
        /// the execution of the operation.
        /// </summary>
        /// <param name="calculation">The <see cref="PipingCalculation{TPipingInput,TPipingOutput}"/> to base the input for the calculation upon.</param>
        /// <param name="normativeAssessmentLevel">The normative assessment level to use in case the manual assessment level is not applicable.</param>
        /// <exception cref="ArgumentNullException">Thrown when <paramref name="calculation"/> is <c>null</c>.</exception>
        ...
        public static void Calculate(PipingCalculation<PipingInput, PipingOutput> calculation, RoundedDouble normativeAssessmentLevel)
        {
            if (calculation == null)
            {
                throw new ArgumentNullException(nameof(calculation));
