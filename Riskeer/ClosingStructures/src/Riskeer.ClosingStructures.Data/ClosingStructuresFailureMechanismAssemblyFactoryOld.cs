...
namespace Riskeer.ClosingStructures.Data
{
    ...
    public static class ClosingStructuresFailureMechanismAssemblyFactoryOld
    {
        ...
        public static FailureMechanismSectionAssemblyOld AssembleSimpleAssessment(
            ClosingStructuresFailureMechanismSectionResultOld failureMechanismSectionResult)
        {
        ...
        /// could not be created.</exception>
        public static FailureMechanismSectionAssemblyCategoryGroup GetSectionAssemblyCategoryGroup(ClosingStructuresFailureMechanismSectionResultOld failureMechanismSectionResult,
                                                                                                   ClosingStructuresFailureMechanism failureMechanism,
                                                                                                   IAssessmentSection assessmentSection,
                                                                                                   bool useManual)
        {
        ...
        /// could not be created.</exception>
        private static FailureMechanismSectionAssemblyOld GetSectionAssembly(ClosingStructuresFailureMechanismSectionResultOld failureMechanismSectionResult,
                                                                             ClosingStructuresFailureMechanism failureMechanism,
                                                                             IAssessmentSection assessmentSection,
                                                                             bool useManual)
        {
        ...
        /// <exception cref="AssemblyException">Thrown when the <see cref="FailureMechanismSectionAssemblyOld"/>
        /// could not be created.</exception>
        private static FailureMechanismSectionAssemblyOld AssembleManualAssessment(ClosingStructuresFailureMechanismSectionResultOld sectionResult,
