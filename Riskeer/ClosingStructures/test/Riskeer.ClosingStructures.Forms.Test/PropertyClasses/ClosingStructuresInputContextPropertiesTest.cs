...
namespace Riskeer.ClosingStructures.Forms.Test.PropertyClasses
{
    ...
    public class ClosingStructuresInputContextPropertiesTest
    {
        ...
        public void InflowModelType_Always_InputChangedAndObservablesNotified()
        {
            ...
            SetPropertyAndVerifyNotificationsAndOutput(properties => properties.InflowModelType = inflowModelType);
        }
        ...
        public void ProbabilityOpenStructureBeforeFlooding_Always_InputChangedAndObservablesNotified()
        {
            ...
            SetPropertyAndVerifyNotificationsAndOutput(properties => properties.ProbabilityOpenStructureBeforeFlooding = random.NextDouble());
        }
        ...
        {
            var random = new Random(21);
            SetPropertyAndVerifyNotificationsAndOutput(properties => properties.FailureProbabilityOpenStructure = random.NextDouble());
        }
        ...
        {
            var random = new Random(21);
            SetPropertyAndVerifyNotificationsAndOutput(properties => properties.FailureProbabilityReparation = random.NextDouble());
        }
        ...
        public void IdenticalApertures_Always_InputChangedAndObservablesNotified()
        {
            ...
            SetPropertyAndVerifyNotificationsAndOutput(properties => properties.IdenticalApertures = propertiesIdenticalApertures);
        }
        ...
        {
            RoundedDouble newMean = new Random(21).NextRoundedDouble();
            SetPropertyAndVerifyNotificationsAndOutput(properties => properties.LevelCrestStructureNotClosing.Mean = newMean);
        }
