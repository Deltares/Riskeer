...
{
    [TestFixture]
    public class ClosingStructuresFailureMechanismSectionsContextUpdateInfoTest
    {
        [Test]
        ...
        public void IsEnabled_FailureMechanismSectionsSourcePathSet_ReturnTrue()
        {
            ...
            var context = new ClosingStructuresFailureMechanismSectionsContext(failureMechanism, assessmentSection);
