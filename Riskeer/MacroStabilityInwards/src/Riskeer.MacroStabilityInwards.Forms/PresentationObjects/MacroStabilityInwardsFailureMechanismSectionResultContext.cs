...
namespace Riskeer.MacroStabilityInwards.Forms.PresentationObjects
{
    ...
    /// </summary>
    public class MacroStabilityInwardsFailureMechanismSectionResultContext : FailureMechanismSectionResultContext<AdoptableFailureMechanismSectionResult>
    {
        /// <summary>
        ...
        public MacroStabilityInwardsFailureMechanismSectionResultContext(IObservableEnumerable<AdoptableFailureMechanismSectionResult> wrappedSectionResults,
