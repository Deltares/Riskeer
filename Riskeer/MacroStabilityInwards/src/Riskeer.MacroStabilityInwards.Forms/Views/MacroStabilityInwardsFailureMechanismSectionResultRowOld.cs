...
namespace Riskeer.MacroStabilityInwards.Forms.Views
{
    ...
    /// </summary>
    public class MacroStabilityInwardsFailureMechanismSectionResultRowOld : FailureMechanismSectionResultRowOld<MacroStabilityInwardsFailureMechanismSectionResultOld>
    {
        ...
        /// <summary>
        /// Creates a new instance of <see cref="MacroStabilityInwardsFailureMechanismSectionResultRowOld"/>.
        /// </summary>
        ...
        /// <see cref="MacroStabilityInwardsFailureMechanismSectionResultRowOld"/>.</param>
        /// <exception cref="ArgumentNullException">Throw when any parameter is <c>null</c>.</exception>
        /// <exception cref="NotSupportedException">Thrown when <see cref="FailureMechanismSectionAssemblyCategoryGroup"/>
        /// is a valid value, but unsupported.</exception>
        internal MacroStabilityInwardsFailureMechanismSectionResultRowOld(MacroStabilityInwardsFailureMechanismSectionResultOld sectionResult,
        ...
        private void UpdateDetailedAssessmentProbabilityError()
        {
            ...
            else
            {
                ColumnStateDefinitions[detailedAssessmentProbabilityIndex].ErrorText = FailureMechanismSectionResultRowHelper.GetDetailedAssessmentProbabilityError(
                    ...
                    scenarios => SectionResult.GetDetailedAssessmentProbability(scenarios, failureMechanism.GeneralInput.ModelFactor));
            }
        }
        ...
        /// <summary>
        /// Class holding the various construction parameters for <see cref="MacroStabilityInwardsFailureMechanismSectionResultRowOld"/>.
        /// </summary>
