...
namespace Riskeer.MacroStabilityInwards.Data
{
    ...
    public static class MacroStabilityInwardsFailureMechanismAssemblyFactory
    {
            ...
            IAssessmentSection assessmentSection)
        {
            ...
            try
            {
                return calculator.AssembleDetailedAssessment(
                    ...
                    failureMechanismSectionResult.GetDetailedAssessmentProbability(calculationScenarios, failureMechanism.GeneralInput.ModelFactor),
        ...
        /// could not be created.</exception>
        private static FailureMechanismSectionAssemblyOld GetSectionAssembly(MacroStabilityInwardsFailureMechanismSectionResultOld failureMechanismSectionResult,
                                                                             MacroStabilityInwardsFailureMechanism failureMechanism,
                                                                             IAssessmentSection assessmentSection,
                                                                             bool useManual)
        {
        ...
        /// <exception cref="AssemblyException">Thrown when the <see cref="FailureMechanismSectionAssemblyOld"/>
        /// could not be created.</exception>
        private static FailureMechanismSectionAssemblyOld AssembleManualAssessment(MacroStabilityInwardsFailureMechanismSectionResultOld sectionResult,
                                                                                   MacroStabilityInwardsFailureMechanism failureMechanism,
