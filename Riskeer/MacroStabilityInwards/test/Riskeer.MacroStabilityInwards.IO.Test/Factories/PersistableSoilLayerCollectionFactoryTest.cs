...
namespace Riskeer.MacroStabilityInwards.IO.Test.Factories
{
    ...
    public class PersistableSoilLayerCollectionFactoryTest
    {
        ...
        {
            // Call
            void Call() => PersistableSoilLayerCollectionFactory.Create(null, new MacroStabilityInwardsExportRegistry());
        ...
        {
            // Call
            void Call() => PersistableSoilLayerCollectionFactory.Create(new IdFactory(), null);
