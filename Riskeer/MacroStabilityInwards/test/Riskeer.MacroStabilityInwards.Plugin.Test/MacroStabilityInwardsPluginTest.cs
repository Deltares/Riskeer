    ...
    public class MacroStabilityInwardsPluginTest
    {
        ...
        public void GetPropertyInfos_ReturnsSupportedPropertyInfos()
        {
            ...
            using (var plugin = new MacroStabilityInwardsPlugin())
            {
                ...
                PluginTestHelper.AssertPropertyInfoDefined(
                    ...
                    typeof(FailureMechanismSectionConfigurationsProperties));
            }
        }
        ...
        public void GetTreeNodeInfos_ReturnsSupportedTreeNodeInfos()
        {
            ...
            using (var plugin = new MacroStabilityInwardsPlugin())
            {
                ...
                Assert.IsTrue(treeNodeInfos.Any(tni => tni.TagType == typeof(MacroStabilityInwardsFailureMechanismSectionsContext)));
            }
        }
        ...
        public void GetViewInfos_ReturnsSupportedViewInfos()
        {
            ...
            })
            {
                ...
                PluginTestHelper.AssertViewInfoDefined(
                    ...
                    typeof(FailureMechanismSectionConfigurationsView<FailureMechanismSectionConfiguration, FailureMechanismSectionConfigurationRow>));
