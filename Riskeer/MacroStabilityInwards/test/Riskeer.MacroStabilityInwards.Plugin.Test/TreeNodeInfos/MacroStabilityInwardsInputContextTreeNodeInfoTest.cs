...
{
    [TestFixture]
    public class MacroStabilityInwardsInputContextTreeNodeInfoTest
    {
        ...
        public void SetUp()
        {
            ...
            info = plugin.GetTreeNodeInfos().First(tni => tni.TagType == typeof(MacroStabilityInwardsInputContext));
        }
