...
{
    [TestFixture]
    public class MacroStabilityInwardsFailureMechanismSectionsViewInfoTest : ShouldCloseViewWithFailureMechanismTester
    {
        ...
        {
            if (failureMechanism is MacroStabilityInwardsFailureMechanism macroStabilityInwardsFailureMechanism)
            {
                return new FailureMechanismSectionConfigurationsView<FailureMechanismSectionConfiguration, FailureMechanismSectionConfigurationRow>(
                    macroStabilityInwardsFailureMechanism.SectionConfigurations,
