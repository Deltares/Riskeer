...
{
    /// <summary>
    /// Interface for a calculator which calculates probability of failure by piping.
    /// </summary>
    public interface IPipingCalculator
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="input">The <see cref="PipingCalculationInput"/> which contains all the necessary input
        ...
        void Calculate(PipingCalculationInput input);
