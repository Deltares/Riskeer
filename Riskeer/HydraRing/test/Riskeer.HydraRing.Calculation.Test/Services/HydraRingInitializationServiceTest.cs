...
namespace Riskeer.HydraRing.Calculation.Test.Services
{
    ...
    public class HydraRingInitializationServiceTest
    {
        ...
        {
            // Setup
            var settings = new HydraRingCalculationSettings("D:\\hlcd\\hlcdFilePath", false);
        ...
        public void WriteInitializationScript_WithSpecificUsePreprocessorClosureSetting_ReturnsExpectedInitializationScript(bool usePreprocessorClosure)
        {
            ...
            var settings = new HydraRingCalculationSettings(hlcdFilePath, usePreprocessorClosure);
