...
namespace Riskeer.HeightStructures.Service
{
    ...
    /// height structures calculations.
    /// </summary>
    public static class HeightStructuresCalculationActivityFactory
    {
        /// <summary>
        ...
        public static IEnumerable<CalculatableActivity> CreateCalculationActivities(HeightStructuresFailureMechanism failureMechanism,
        ...
        /// <exception cref="ArgumentNullException">Thrown when any parameter is <c>null</c>.</exception>
        public static CalculatableActivity CreateCalculationActivity(StructuresCalculation<HeightStructuresInput> calculation,
                                                                     HeightStructuresFailureMechanism failureMechanism,
                                                                     IAssessmentSection assessmentSection)
        {
            if (calculation == null)
