...
namespace Riskeer.HeightStructures.Data.TestUtil
{
    ...
    public static class HeightStructuresCalculationScenarioTestFactory
    {
        ...
        /// <returns>A new <see cref="StructuresCalculationScenario{T}"/>.</returns>
        /// <exception cref="ArgumentNullException">Thrown when <paramref name="section"/> is <c>null</c>.</exception>
        public static StructuresCalculationScenario<HeightStructuresInput> CreateNotCalculatedHeightStructuresCalculationScenario(
            FailureMechanismSection section)
        {
            if (section == null)
            {
            ...
            var scenario = new StructuresCalculationScenario<HeightStructuresInput>
            {
                IsRelevant = true,
                InputParameters =
                {
                    Structure = new TestHeightStructure(section.StartPoint)
                }
            };
