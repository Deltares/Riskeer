...
namespace Riskeer.GrassCoverErosionInwards.Forms.PresentationObjects.CalculationsState
{
    /// <summary>
    /// Presentation object for <see cref="GrassCoverErosionInwardsFailureMechanism"/> in the calculations state.
    /// </summary>
