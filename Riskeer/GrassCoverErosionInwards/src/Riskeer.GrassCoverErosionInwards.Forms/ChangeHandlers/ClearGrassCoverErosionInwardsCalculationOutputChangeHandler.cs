...
{
    /// <summary>
    /// Class for handling clearing the output of <see cref="GrassCoverErosionInwardsCalculationScenario"/>.
    /// </summary>
    public class ClearGrassCoverErosionInwardsCalculationOutputChangeHandler : ClearCalculationOutputChangeHandlerBase<GrassCoverErosionInwardsCalculationScenario>
    {
        /// <summary>
        /// Creates a new instance of <see cref="ClearGrassCoverErosionInwardsCalculationOutputChangeHandler"/>.
        /// </summary>
        ...
        public ClearGrassCoverErosionInwardsCalculationOutputChangeHandler(
            IEnumerable<GrassCoverErosionInwardsCalculationScenario> calculations,
