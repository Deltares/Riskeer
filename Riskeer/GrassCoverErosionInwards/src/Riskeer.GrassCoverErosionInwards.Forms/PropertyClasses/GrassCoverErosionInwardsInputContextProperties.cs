...
namespace Riskeer.GrassCoverErosionInwards.Forms.PropertyClasses
{
                                                                  ...
                                                                  IHasHydraulicBoundaryLocationProperty
    {
        ...
        private const int dikeHeightTargetProbabilityPropertyIndex = 12;
        ...
        private const int overtoppingRateTargetProbabilityPropertyIndex = 15;
        ...
        public IEnumerable<SelectableHydraulicBoundaryLocation> GetSelectableHydraulicBoundaryLocations()
        {
            ...
            return SelectableHydraulicBoundaryLocationHelper.GetSortedSelectableHydraulicBoundaryLocations(
                data.AssessmentSection.HydraulicBoundaryDatabases.GetAllLocations(), calculationLocation);
        }
    }
}