...
using Riskeer.GrassCoverErosionInwards.Forms.PropertyClasses.RegistrationState;

namespace Riskeer.GrassCoverErosionInwards.Forms.Test.PropertyClasses.RegistrationState
{
    [TestFixture]
