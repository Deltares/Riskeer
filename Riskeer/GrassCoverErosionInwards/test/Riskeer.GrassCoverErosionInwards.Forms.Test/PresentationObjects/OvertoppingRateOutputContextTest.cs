...
namespace Riskeer.GrassCoverErosionInwards.Forms.Test.PresentationObjects
{
    ...
    public class OvertoppingRateOutputContextTest
    {
        ...
        public void ParameteredConstructor_ExpectedValues()
        {
            ...
            // Assert
            Assert.IsInstanceOf<ObservableWrappedObjectContextBase<GrassCoverErosionInwardsCalculation>>(overtoppingRateOutputContext);
            Assert.AreSame(calculation, overtoppingRateOutputContext.WrappedData);
        }
    }
}