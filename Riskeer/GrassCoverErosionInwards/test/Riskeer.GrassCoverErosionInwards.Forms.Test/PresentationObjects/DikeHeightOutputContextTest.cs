...
namespace Riskeer.GrassCoverErosionInwards.Forms.Test.PresentationObjects
{
    ...
    public class DikeHeightOutputContextTest
    {
        ...
        public void ParameteredConstructor_ExpectedValues()
        {
            ...
            // Assert
            Assert.IsInstanceOf<ObservableWrappedObjectContextBase<GrassCoverErosionInwardsCalculation>>(dikeHeightOutputContext);
            Assert.AreSame(calculation, dikeHeightOutputContext.WrappedData);
        }
    }
}