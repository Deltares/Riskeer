...
{
    [TestFixture]
    public class ClearGrassCoverErosionInwardsCalculationOutputChangeHandlerTest
    {
        [Test]
        public void Constructor_ExpectedValues()
        {
            ...
            // Call
            var changeHandler = new ClearGrassCoverErosionInwardsCalculationOutputChangeHandler(
                Enumerable.Empty<GrassCoverErosionInwardsCalculationScenario>(), inquiryHelper, viewCommands);

            // Assert
            Assert.IsInstanceOf<ClearCalculationOutputChangeHandlerBase<GrassCoverErosionInwardsCalculationScenario>>(changeHandler);
            mocks.VerifyAll();
        }
