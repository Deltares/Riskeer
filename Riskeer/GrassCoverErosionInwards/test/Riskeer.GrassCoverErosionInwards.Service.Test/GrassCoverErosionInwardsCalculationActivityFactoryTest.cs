...
namespace Riskeer.GrassCoverErosionInwards.Service.Test
{
    ...
    public class GrassCoverErosionInwardsCalculationActivityFactoryTest
    {
        ...
        public void CreateCalculationActivity_WithValidCalculation_ReturnsGrassCoverErosionInwardsCalculationActivityWithParametersSet()
        {
            ...
            GrassCoverErosionInwardsCalculation calculation = CreateValidCalculation(hydraulicBoundaryLocation);
            ...
            AssertGrassCoverErosionInwardsCalculationActivity(activity, calculation, assessmentSection);
            mocks.VerifyAll();
        }
        ...
        public void CreateCalculationActivitiesForCalculationGroup_WithValidCalculations_ReturnsGrassCoverErosionInwardsCalculationActivitiesWithParametersSet()
        {
            ...
            AssertGrassCoverErosionInwardsCalculationActivity(activities.First(), calculation1, assessmentSection);
            AssertGrassCoverErosionInwardsCalculationActivity(activities.ElementAt(1), calculation2, assessmentSection);
            mocks.VerifyAll();
        }
