...
{
    [TestFixture]
    public class DikeProfileCollectionPropertyInfoTest
    {
        ...
        public void SetUp()
        {
            ...
            info = plugin.GetPropertyInfos().First(tni => tni.PropertyObjectType == typeof(DikeProfileCollectionProperties));
        }
        ...
        {
            // Assert
            Assert.AreEqual(typeof(DikeProfilesContext), info.DataType);
            Assert.AreEqual(typeof(DikeProfileCollectionProperties), info.PropertyObjectType);
        }
