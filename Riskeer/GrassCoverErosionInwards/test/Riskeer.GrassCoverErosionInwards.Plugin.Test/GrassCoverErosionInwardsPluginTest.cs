    ...
    public class GrassCoverErosionInwardsPluginTest
    {
        ...
        public void GetTreeNodeInfos_ReturnsSupportedTreeNodeInfos()
        {
            ...
            using (var plugin = new GrassCoverErosionInwardsPlugin())
            {
                ...
                Assert.IsTrue(treeNodeInfos.Any(tni => tni.TagType == typeof(GrassCoverErosionInwardsCalculationsContext)));
                Assert.IsTrue(treeNodeInfos.Any(tni => tni.TagType == typeof(GrassCoverErosionInwardsFailurePathContext)));
                ...
                Assert.IsTrue(treeNodeInfos.Any(tni => tni.TagType == typeof(ProbabilityFailureMechanismSectionResultContext<GrassCoverErosionInwardsFailureMechanismSectionResultOld>)));
