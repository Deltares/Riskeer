...
namespace Riskeer.GrassCoverErosionInwards.Data.Test
{
    ...
    public class GrassCoverErosionInwardsCalculationTest
    {
        ...
        private static IEnumerable<TestCaseData> GetCalculations()
        {
            ...
            yield return new TestCaseData(new GrassCoverErosionInwardsCalculation(0.1)
                {
                    InputParameters =
                    {
            ...
            yield return new TestCaseData(new GrassCoverErosionInwardsCalculation(0.1), true)
