...
/*  Created On : 04-nov-2021 08:18:17 				*/
/*  DBMS       : SQLite 								*/
/* ---------------------------------------------------- */
...
(
	...
	'NotRelevantComments' TEXT NULL,
	'N' REAL NOT NULL,
	CONSTRAINT 'FK_SpecificFailurePathEntity_AssessmentSectionEntity' FOREIGN KEY ('AssessmentSectionEntityId') REFERENCES 'AssessmentSectionEntity' ('AssessmentSectionEntityId') ON DELETE Cascade ON UPDATE Cascade
)
;
