...
/*  Created On : 02-nov-2021 13:58:52 				*/
/*  DBMS       : SQLite 								*/
/* ---------------------------------------------------- */
...
(
    'SpecificFailurePathEntityId' INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
    'AssessmentSectionEntityId' INTEGER NOT NULL,
    'Name' VARCHAR (260) NULL,
    'Order' INT (4) NOT NULL,
...
CREATE INDEX 'IXFK_SpecificFailurePathEntity_AssessmentSectionEntity'
    ON 'SpecificFailurePathEntity' ('AssessmentSectionEntityId' ASC)
;
