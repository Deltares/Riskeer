...
(
    ...
    HydraulicLocationEntityId                  INTEGER NULL, 'Order'
    INT
(
    4
) NOT NULL,
...
(
    ...
    DikeProfileEntityId                         INTEGER NULL, 'Order'
    INT
(
    4
) NOT NULL,
...
(
    ...
    PermeabilityCoefficientOfVariation REAL NULL, 'Order'
    INT
(
    4
) NOT NULL,
...
(
    ...
    Probability                         REAL    NOT NULL, 'Order'
    INT
(
    4
) NOT NULL,
...
(
    ...
    FailureMechanismEntityId           INTEGER NOT NULL,
    Name                               TEXT    NOT NULL COLLATE NOCASE,
    StochasticSoilModelSegmentPointXml TEXT    NOT NULL COLLATE NOCASE, 'Order'
    INT
(
    4
) NOT NULL,
...
(
    ...
    PointsXml                  TEXT         NOT NULL COLLATE NOCASE, 'Order'
    INT
(
    4
) NOT NULL,
...
(
    ...
    BackgroundDataEntityId     INTEGER NOT NULL, 'Key'
    TEXT
    NOT
    NULL
    COLLATE
...
(
    ...
    FailureMechanismEntityId INTEGER NOT NULL, 'Order'
    INT
(
    4
) NOT NULL,
...
(
    ...
    HydraulicLocationEntityId            INTEGER NULL,
    ClosingStructureEntityId             INTEGER NULL, 'Order'
    INT
(
    4
) NOT NULL,
...
(
    ...
    DuneErosionFailureMechanismMetaEntityId   INTEGER NOT NULL, 'Order'
    INT
(
    4
) NOT NULL,
...
(
    ...
    FailureMechanismEntityId  INTEGER      NOT NULL,
    Name                      VARCHAR(260) NOT NULL,
    CoastalAreaId             INT (4) NOT NULL, 'Offset'
    REAL
    NULL, 'Order'
    INT
(
...
(
    ...
    FaultTreeIllustrationPointEntityId    INTEGER NOT NULL,
    CONSTRAINT PK_FaultTreeSubMechanismIllustrationPointEntityId PRIMARY KEY (SubMechanismIllustrationPointEntityId,
...
(
    ...
    GeneralResultFaultTreeIllustrationPointEntityId INTEGER NULL, 'Order'
    INT
(
    4
) NOT NULL,
...
(
    ...
    ForeshoreProfileEntityId                                           INTEGER NULL,
    HydraulicLocationEntityId                                          INTEGER NULL,
    HydraulicLocationCalculationForTargetProbabilityCollectionEntityId INTEGER NULL, 'Order'
    INT
(
    4
) NOT NULL,
...
(
    ...
    GrassCoverErosionOutwardsWaveConditionsCalculationEntityId INTEGER NOT NULL, 'Order'
    INT
(
    4
) NOT NULL,
...
(
    ...
    ForeshoreProfileEntityId            INTEGER NULL, 'Order'
    INT
(
    4
) NOT NULL,
...
(
    ...
    CONSTRAINT PK_HydraulicLocationCalculationCollectionHydraulicLocationCalculationEntity PRIMARY KEY (HydraulicLocationCalculationCollectionEntityId,
...
(
    ...
    AssessmentSectionEntityId                                          INTEGER NOT NULL, 'Order'
    INT
(
    4
) NOT NULL,
...
(
    ...
    HydraulicLocationCalculationEntityId                               INTEGER NOT NULL,
    CONSTRAINT PK_HydraulicBoundaryLocationCalculationsForTargetProbabilityHydraulicLocationCalculationEntity PRIMARY KEY (HydraulicLocationCalculationForTargetProbabilityCollectionEntityId,
                                                                                                                           HydraulicLocationCalculationEntityId),
...
(
    ...
    PreconsolidationStressCoefficientOfVariation        REAL NULL, 'Order'
    INT
(
    4
) NOT NULL,
...
(
    ...
    PopMean                                        REAL NULL,
    PopCoefficientOfVariation                      REAL NULL, 'Order'
    INT
(
    4
) NOT NULL,
...
(
    ...
    OuterRingXml                                     TEXT    NOT NULL COLLATE NOCASE, 'Order'
    INT
(
    4
) NOT NULL,
...
(
    ...
    CONSTRAINT PK_MacroStabilityInwardsSoilProfileTwoDSoilLayerTwoDEntity PRIMARY KEY (MacroStabilityInwardsSoilProfileTwoDEntityId,
...
(
    ...
    SectionSpecificGeneralResultSubMechanismIllustrationPointEntityId INTEGER NULL, 'Order'
    INT
(
    4
) NOT NULL,
...
(
    ...
    SemiProbabilisticPipingCalculationEntityId       INTEGER NOT NULL, 'Order'
    INT
(
    4
) NOT NULL,
...
(
    ...
    ForeshoreProfileEntityId                    INTEGER NULL,
    HydraulicLocationEntityId                   INTEGER NULL,
    StabilityPointStructureEntityId             INTEGER NULL, 'Order'
    INT
(
    4
) NOT NULL,
...
(
    ...
    StabilityStoneCoverWaveConditionsCalculationEntityId INTEGER NOT NULL, 'Order'
    INT
(
    4
) NOT NULL,
...
(
    ...
    Duration                                      REAL    NOT NULL,
    Alpha                                         REAL    NOT NULL,
    Realization                                   REAL    NOT NULL, 'Order'
    INT
(
    4
) NOT NULL,
...
(
    ...
    WindDirectionAngle                              REAL    NOT NULL, 'Order'
    INT
(
    4
) NOT NULL,
...
(
    ...
    WaveImpactAsphaltCoverWaveConditionsCalculationEntityId INTEGER NOT NULL, 'Order'
    INT
(
    4
) NOT NULL,
...
CREATE INDEX IXFK_GrassCoverErosionOutwardsWaveConditionsCalculationEntity_HydraulicLocationCalculationForTargetProbabilityCollectionEntity
    ON GrassCoverErosionOutwardsWaveConditionsCalculationEntity (HydraulicLocationCalculationForTargetProbabilityCollectionEntityId
                                                                 ASC)
;
...
CREATE INDEX IXFK_HydraulicBoundaryLocationCalculationsForTargetProbabilityHydraulicLocationCalculationEntity_HydraulicBoundaryLocationCalculationsForTargetProbabilityEntity
    ON HydraulicLocationCalculationForTargetProbabilityCollectionHydraulicLocationCalculationEntity (HydraulicLocationCalculationForTargetProbabilityCollectionEntityId
                                                                                                     ASC)
;
...
SELECT CASE
           WHEN
                   (
                           NEW.MacroStabilityInwardsSoilProfileOneDEntityId IS NULL AND
                           NEW.MacroStabilityInwardsSoilProfileTwoDEntityId IS NULL
                       ) OR (
                           NEW.MacroStabilityInwardsSoilProfileOneDEntityId IS NOT NULL AND
                           NEW.MacroStabilityInwardsSoilProfileTwoDEntityId IS NOT NULL
                       )
...
CREATE INDEX IXFK_StabilityStoneCoverWaveConditionsCalculationEntity_HydraulicLocationCalculationForTargetProbabilityCollectionEntity
    ON StabilityStoneCoverWaveConditionsCalculationEntity (HydraulicLocationCalculationForTargetProbabilityCollectionEntityId
                                                           ASC)
;
...
CREATE INDEX IXFK_WaveImpactAsphaltCoverWaveConditionsCalculationEntity_HydraulicLocationCalculationForTargetProbabilityCollectionEntity
    ON WaveImpactAsphaltCoverWaveConditionsCalculationEntity (HydraulicLocationCalculationForTargetProbabilityCollectionEntityId
                                                              ASC)
;
