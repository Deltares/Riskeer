            ...
            using (new FileDisposeHelper(targetFilePath))
            {
                ...
                using (var reader = new MigrationLogDatabaseReader(logFilePath))
                {
                    ...
                    MigrationLogTestHelper.AssertMigrationLogMessageEqual(
                        ...
                        messages[9]);
                    MigrationLogTestHelper.AssertMigrationLogMessageEqual(
                        new MigrationLogMessage("19.1", "19.2", "Gevolgen van de migratie van versie 19.1 naar versie 19.2:"),
                        messages[10]);
                    MigrationLogTestHelper.AssertMigrationLogMessageEqual(
                        new MigrationLogMessage("19.1", "19.2", "* Geen aanpassingen."),
                        messages[11]);
                    MigrationLogTestHelper.AssertMigrationLogMessageEqual(
                        new MigrationLogMessage("19.2", latestVersion, $"Gevolgen van de migratie van versie 19.2 naar versie {latestVersion}:"),
                        messages[12]);
                    MigrationLogTestHelper.AssertMigrationLogMessageEqual(
                        new MigrationLogMessage("19.2", latestVersion, "* Geen aanpassingen."),
                        messages[13]);
                }
            }
        }
