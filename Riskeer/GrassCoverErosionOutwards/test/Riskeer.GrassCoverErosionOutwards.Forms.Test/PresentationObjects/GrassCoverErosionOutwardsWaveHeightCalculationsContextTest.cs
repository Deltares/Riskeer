...
namespace Riskeer.GrassCoverErosionOutwards.Forms.Test.PresentationObjects
{
    ...
    public class GrassCoverErosionOutwardsWaveHeightCalculationsContextTest
    {
        ...
        public void Constructor_FailureMechanismNull_ThrowsArgumentNullException()
        {
            ...
            // Call
            TestDelegate call = () => new GrassCoverErosionOutwardsWaveHeightCalculationsContext(calculations, null, assessmentSection,
                                                                                                 () => 0.1, "Test name");
        ...
        public void Constructor_ValidData_ExpectedValues()
        {
            ...
            // Call
            var context = new GrassCoverErosionOutwardsWaveHeightCalculationsContext(calculations, failureMechanism, assessmentSection,
                                                                                     getNormFunc, categoryBoundaryName);

            // Assert
            Assert.IsInstanceOf<WaveHeightCalculationsContext>(context);
