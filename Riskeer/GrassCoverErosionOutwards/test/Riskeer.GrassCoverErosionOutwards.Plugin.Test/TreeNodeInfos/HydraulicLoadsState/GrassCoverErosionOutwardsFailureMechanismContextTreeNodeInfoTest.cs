...
namespace Riskeer.GrassCoverErosionOutwards.Plugin.Test.TreeNodeInfos.HydraulicLoadsState
{
    [TestFixture]
    public class GrassCoverErosionOutwardsFailureMechanismContextTreeNodeInfoTest
    {
        ...
        public void GivenValidCalculations_WhenCalculatingAllFromContextMenu_ThenAllCalculationsScheduled()
        {
            ...
            using (var treeViewControl = new TreeViewControl())
            {
                ...
                HydraulicBoundaryCalculationSettings expectedCalculationSettings = HydraulicBoundaryCalculationSettingsFactory.CreateSettings(assessmentSection.HydraulicBoundaryData);
