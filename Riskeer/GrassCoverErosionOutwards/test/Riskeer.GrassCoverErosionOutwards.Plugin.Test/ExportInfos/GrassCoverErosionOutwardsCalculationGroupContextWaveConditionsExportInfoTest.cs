...
{
    [TestFixture]
    public class GrassCoverErosionOutwardsCalculationGroupContextWaveConditionsExportInfoTest
    {
        ...
        public void SetUp()
        {
            ...
            info = plugin.GetExportInfos()
                         .Single(ei => ei.DataType == typeof(GrassCoverErosionOutwardsCalculationGroupContext)
