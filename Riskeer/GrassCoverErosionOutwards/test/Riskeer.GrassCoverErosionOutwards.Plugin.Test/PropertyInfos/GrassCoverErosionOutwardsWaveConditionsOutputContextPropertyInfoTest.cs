...
{
    [TestFixture]
    public class GrassCoverErosionOutwardsWaveConditionsOutputContextPropertyInfoTest
    {
        [Test]
        public void Initialized_Always_ExpectedPropertiesSet()
        {
            ...
            using (var plugin = new GrassCoverErosionOutwardsPlugin())
            {
                ...
                // Assert
                Assert.AreEqual(typeof(GrassCoverErosionOutwardsWaveConditionsOutputContext), info.DataType);
                Assert.AreEqual(typeof(GrassCoverErosionOutwardsWaveConditionsOutputProperties), info.PropertyObjectType);
            }
        }
        ...
        {
            return plugin.GetPropertyInfos().First(pi => pi.DataType == typeof(GrassCoverErosionOutwardsWaveConditionsOutputContext));
        }
    }
}