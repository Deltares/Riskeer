...
namespace Riskeer.GrassCoverErosionOutwards.Data.Test
{
    ...
    public class GrassCoverErosionOutwardsFailureMechanismAssemblyFactoryTest
    {
        ...
        public void AssembleSection_SectionResultNull_ThrowsArgumentNullException()
        {
            ...
            // Call
            void Call() => GrassCoverErosionOutwardsFailureMechanismAssemblyFactory.AssembleSection(null, failureMechanism, assessmentSection);
        ...
        public void AssembleSection_FailureMechanismNull_ThrowsArgumentNullException()
        {
            ...
            // Call
            void Call() => GrassCoverErosionOutwardsFailureMechanismAssemblyFactory.AssembleSection(sectionResult, null, assessmentSection);
        ...
        public void AssembleSection_AssessmentSectionNull_ThrowsArgumentNullException()
        {
            ...
            // Call
            void Call() => GrassCoverErosionOutwardsFailureMechanismAssemblyFactory.AssembleSection(sectionResult, failureMechanism, null);
        ...
        public void AssembleSection_WithInput_SetsInputOnCalculator()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                GrassCoverErosionOutwardsFailureMechanismAssemblyFactory.AssembleSection(sectionResult, failureMechanism, assessmentSection);
        ...
        public void AssembleSection_CalculatorThrowsException_ThrowsAssemblyException()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                void Call() => GrassCoverErosionOutwardsFailureMechanismAssemblyFactory.AssembleSection(
                    sectionResult, failureMechanism, assessmentSection);
        ...
        public void AssembleFailureMechanism_AssessmentSectionNull_ThrowsArgumentNullException()
        {
            ...
            // Call
            void Call() => GrassCoverErosionOutwardsFailureMechanismAssemblyFactory.AssembleFailureMechanism(failureMechanism, null);
        ...
        public void AssembleFailureMechanism_CalculatorThrowsException_ThrowsAssemblyException()
        {
            ...
            using (new AssemblyToolCalculatorFactoryConfig())
            {
                ...
                // Call
                void Call() => GrassCoverErosionOutwardsFailureMechanismAssemblyFactory.AssembleFailureMechanism(failureMechanism, assessmentSection);
