...
namespace Riskeer.GrassCoverErosionOutwards.IO.Test.Configurations.Converters
{
    ...
    public class ConfigurationGrassCoverErosionOutwardsCalculationTypeConverterTest
    {
        ...
        [TestCase(ConfigurationGrassCoverErosionOutwardsCalculationType.WaveImpactWithWaveDirection, GrassCoverErosionOutwardsWaveConditionsCalculationType.WaveImpactWithWaveDirection)]
        [TestCase(ConfigurationGrassCoverErosionOutwardsCalculationType.WaveRunUpAndWaveImpactWithWaveDirection, GrassCoverErosionOutwardsWaveConditionsCalculationType.WaveRunUpAndWaveImpactWithWaveDirection)]
        [TestCase(ConfigurationGrassCoverErosionOutwardsCalculationType.All, GrassCoverErosionOutwardsWaveConditionsCalculationType.All)]
        ...
        [TestCase(ConfigurationGrassCoverErosionOutwardsCalculationType.WaveImpactWithWaveDirection, "Gras (golfklap met golfrichting)")]
        [TestCase(ConfigurationGrassCoverErosionOutwardsCalculationType.WaveRunUpAndWaveImpactWithWaveDirection, "Gras (golfoploop en golfklap met golfrichting)")]
        [TestCase(ConfigurationGrassCoverErosionOutwardsCalculationType.All, "Gras (alle types)")]
        ...
        [TestCase("Gras (golfklap met golfrichting)", ConfigurationGrassCoverErosionOutwardsCalculationType.WaveImpactWithWaveDirection)]
        [TestCase("Gras (golfoploop en golfklap met golfrichting)", ConfigurationGrassCoverErosionOutwardsCalculationType.WaveRunUpAndWaveImpactWithWaveDirection)]
        [TestCase("Gras (alle types)", ConfigurationGrassCoverErosionOutwardsCalculationType.All)]
        ...
        [TestCase(GrassCoverErosionOutwardsWaveConditionsCalculationType.WaveImpactWithWaveDirection, ConfigurationGrassCoverErosionOutwardsCalculationType.WaveImpactWithWaveDirection)]
        [TestCase(GrassCoverErosionOutwardsWaveConditionsCalculationType.WaveRunUpAndWaveImpactWithWaveDirection, ConfigurationGrassCoverErosionOutwardsCalculationType.WaveRunUpAndWaveImpactWithWaveDirection)]
        [TestCase(GrassCoverErosionOutwardsWaveConditionsCalculationType.All, ConfigurationGrassCoverErosionOutwardsCalculationType.All)]
