...
namespace Riskeer.GrassCoverErosionOutwards.Service
{
    ...
    public class GrassCoverErosionOutwardsWaveConditionsCalculationService : WaveConditionsCalculationServiceBase
    {
                              ...
                              IAssessmentSection assessmentSection)
        {
            ...
            HydraulicBoundaryDatabases hydraulicBoundaryDatabases = assessmentSection.HydraulicBoundaryDatabases;
            ...
            try
            {
                ...
                if (ShouldCalculateWaveRunUp(calculationType))
                {
                    ...
                    waveRunUpOutput = CalculateWaveRunUp(calculation, failureMechanism, hydraulicBoundaryDatabases, assessmentLevel, targetProbability);
                }
                ...
                if (ShouldCalculateWaveImpact(calculationType))
                {
                    ...
                    waveImpactOutput = CalculateWaveImpact(calculation, failureMechanism, hydraulicBoundaryDatabases, assessmentLevel, targetProbability);
                }
                ...
                if (ShouldCalculateWaveImpactWithWaveDirection(calculationType))
                {
                    ...
                    waveImpactWithWaveDirectionOutput = CalculateWaveImpactWithWaveDirection(calculation, failureMechanism, hydraulicBoundaryDatabases, assessmentLevel, targetProbability);
                }
