...
namespace Demo.Ringtoets.Commands
{
    ...
    public class AddNewDemoAssessmentSectionCommand : ICommand
    {
        ...
        private static void SetGrassCoverErosionOutwardsHydraulicBoundaryLocationDesignWaterLevelOutputValues(GrassCoverErosionOutwardsFailureMechanism failureMechanism)
        {
            ...
            locations[0].DesignWaterLevelCalculation.Output = new HydraulicBoundaryLocationOutput(
                7.19,
                targetProbability, 4.79014,
                1.0 / 1196727, 4.78959,
                CalculationConvergence.CalculatedConverged,
                generalResult);
            locations[1].DesignWaterLevelCalculation.Output = new HydraulicBoundaryLocationOutput(
                7.19,
                targetProbability, 4.79014,
                1.0 / 1196727, 4.78959,
                CalculationConvergence.CalculatedConverged,
                generalResult);
            locations[2].DesignWaterLevelCalculation.Output = new HydraulicBoundaryLocationOutput(
                7.18,
                targetProbability, 4.79014,
                1.0 / 1196727, 4.78959,
                CalculationConvergence.CalculatedConverged,
                generalResult);
            locations[3].DesignWaterLevelCalculation.Output = new HydraulicBoundaryLocationOutput(
                7.18,
                targetProbability, 4.79014,
                1.0 / 1196787, 4.78960,
                CalculationConvergence.CalculatedConverged,
                generalResult);
            locations[4].DesignWaterLevelCalculation.Output = new HydraulicBoundaryLocationOutput(
                7.18,
                targetProbability, 4.79014,
                1.0 / 1196787, 4.78960,
                CalculationConvergence.CalculatedConverged,
                generalResult);
            locations[5].DesignWaterLevelCalculation.Output = new HydraulicBoundaryLocationOutput(
                7.39,
                targetProbability, 4.79014,
                1.0 / 1196489, 4.78955,
                CalculationConvergence.CalculatedConverged,
                generalResult);
            locations[6].DesignWaterLevelCalculation.Output = new HydraulicBoundaryLocationOutput(
                7.39,
                targetProbability, 4.79014,
                1.0 / 1196489, 4.78955,
                CalculationConvergence.CalculatedConverged,
                generalResult);
            locations[7].DesignWaterLevelCalculation.Output = new HydraulicBoundaryLocationOutput(
                7.39,
                targetProbability, 4.79014,
                1.0 / 1196489, 4.78955,
                CalculationConvergence.CalculatedConverged,
                generalResult);
            locations[8].DesignWaterLevelCalculation.Output = new HydraulicBoundaryLocationOutput(
                7.40,
                targetProbability, 4.79014,
                1.0 / 1196489, 4.78955,
                CalculationConvergence.CalculatedConverged,
                generalResult);
            locations[9].DesignWaterLevelCalculation.Output = new HydraulicBoundaryLocationOutput(
                7.40,
                targetProbability, 4.79014,
                1.0 / 1196429, 4.78954,
                CalculationConvergence.CalculatedConverged,
                generalResult);
            locations[10].DesignWaterLevelCalculation.Output = new HydraulicBoundaryLocationOutput(
                7.40,
                targetProbability, 4.79014,
                1.0 / 1196429, 4.78954,
                CalculationConvergence.CalculatedConverged,
                generalResult);
            locations[11].DesignWaterLevelCalculation.Output = new HydraulicBoundaryLocationOutput(
                7.40,
                targetProbability, 4.79014,
                1.0 / 1196429, 4.78954,
                CalculationConvergence.CalculatedConverged,
                generalResult);
            locations[12].DesignWaterLevelCalculation.Output = new HydraulicBoundaryLocationOutput(
                7.40,
                targetProbability, 4.79014,
                1.0 / 1196429, 4.78954,
                CalculationConvergence.CalculatedConverged,
                generalResult);
            locations[13].DesignWaterLevelCalculation.Output = new HydraulicBoundaryLocationOutput(
                7.41,
                targetProbability, 4.79014,
                1.0 / 1196429, 4.78954,
                CalculationConvergence.CalculatedConverged,
                generalResult);
            locations[14].DesignWaterLevelCalculation.Output = new HydraulicBoundaryLocationOutput(
                7.41,
                targetProbability, 4.79014,
                1.0 / 1196429, 4.78954,
                CalculationConvergence.CalculatedConverged,
                generalResult);
            locations[15].DesignWaterLevelCalculation.Output = new HydraulicBoundaryLocationOutput(
                6.91,
                targetProbability, 4.79014,
                1.0 / 1197264, 4.78968,
                CalculationConvergence.CalculatedConverged,
                generalResult);
            locations[16].DesignWaterLevelCalculation.Output = new HydraulicBoundaryLocationOutput(
                7.53,
                targetProbability, 4.79014,
                1.0 / 1195476, 4.78938,
                CalculationConvergence.CalculatedConverged,
                generalResult);
            locations[17].DesignWaterLevelCalculation.Output = new HydraulicBoundaryLocationOutput(
                7.80,
                targetProbability, 4.79014,
                1.0 / 1194761, 4.78926,
                CalculationConvergence.CalculatedConverged,
        ...
        private static void SetGrassCoverErosionOutwardsHydraulicBoundaryLocationWaveHeightOutputValues(GrassCoverErosionOutwardsFailureMechanism failureMechanism)
        {
            ...
            ObservableList<HydraulicBoundaryLocation> locations = failureMechanism.HydraulicBoundaryLocations;
            GeneralResult<TopLevelSubMechanismIllustrationPoint> generalResult = null;
            locations[0].WaveHeightCalculation.Output = new HydraulicBoundaryLocationOutput(
                4.99,
                targetProbability, 4.79014,
                1.0 / 1199892, 4.79012,
                CalculationConvergence.CalculatedConverged,
                generalResult);
            locations[1].WaveHeightCalculation.Output = new HydraulicBoundaryLocationOutput(
                5.04,
                targetProbability, 4.79014,
                1.0 / 1199892, 4.79012,
                CalculationConvergence.CalculatedConverged,
                generalResult);
            locations[2].WaveHeightCalculation.Output = new HydraulicBoundaryLocationOutput(
                4.87,
                targetProbability, 4.79014,
                1.0 / 1199892, 4.79012,
                CalculationConvergence.CalculatedConverged,
                generalResult);
            locations[3].WaveHeightCalculation.Output = new HydraulicBoundaryLocationOutput(
                4.73,
                targetProbability, 4.79014,
                1.0 / 1199892, 4.79012,
                CalculationConvergence.CalculatedConverged,
                generalResult);
            locations[4].WaveHeightCalculation.Output = new HydraulicBoundaryLocationOutput(
                4.59,
                targetProbability, 4.79014,
                1.0 / 1199833, 4.79011,
                CalculationConvergence.CalculatedConverged,
                generalResult);
            locations[5].WaveHeightCalculation.Output = new HydraulicBoundaryLocationOutput(
                3.35,
                targetProbability, 4.79014,
                1.0 / 1197264, 4.78968,
                CalculationConvergence.CalculatedConverged,
                generalResult);
            locations[6].WaveHeightCalculation.Output = new HydraulicBoundaryLocationOutput(
                3.83,
                targetProbability, 4.79014,
                1.0 / 1196906, 4.78962,
                CalculationConvergence.CalculatedConverged,
                generalResult);
            locations[7].WaveHeightCalculation.Output = new HydraulicBoundaryLocationOutput(
                4.00,
                targetProbability, 4.79014,
                1.0 / 1197264, 4.78968,
                CalculationConvergence.CalculatedConverged,
                generalResult);
            locations[8].WaveHeightCalculation.Output = new HydraulicBoundaryLocationOutput(
                4.20,
                targetProbability, 4.79014,
                1.0 / 1197324, 4.78969,
                CalculationConvergence.CalculatedConverged,
                generalResult);
            locations[9].WaveHeightCalculation.Output = new HydraulicBoundaryLocationOutput(
                4.41,
                targetProbability, 4.79014,
                1.0 / 1197324, 4.78969,
                CalculationConvergence.CalculatedConverged,
                generalResult);
            locations[10].WaveHeightCalculation.Output = new HydraulicBoundaryLocationOutput(
                4.50,
                targetProbability, 4.79014,
                1.0 / 1197622, 4.78974,
                CalculationConvergence.CalculatedConverged,
                generalResult);
            locations[11].WaveHeightCalculation.Output = new HydraulicBoundaryLocationOutput(
                4.57,
                targetProbability, 4.79014,
                1.0 / 1197145, 4.78966,
                CalculationConvergence.CalculatedConverged,
                generalResult);
            locations[12].WaveHeightCalculation.Output = new HydraulicBoundaryLocationOutput(
                4.63,
                targetProbability, 4.79014,
                1.0 / 1196608, 4.78957,
                CalculationConvergence.CalculatedConverged,
                generalResult);
            locations[13].WaveHeightCalculation.Output = new HydraulicBoundaryLocationOutput(
                4.68,
                targetProbability, 4.79014,
                1.0 / 1196549, 4.78956,
                CalculationConvergence.CalculatedConverged,
                generalResult);
            locations[14].WaveHeightCalculation.Output = new HydraulicBoundaryLocationOutput(
                4.17,
                targetProbability, 4.79014,
                1.0 / 1199713, 4.79009,
                CalculationConvergence.CalculatedConverged,
                generalResult);
            locations[15].WaveHeightCalculation.Output = new HydraulicBoundaryLocationOutput(
                11.13,
                targetProbability, 4.79014,
                1.0 / 201269, 4.79035,
                CalculationConvergence.CalculatedConverged,
                generalResult);
            locations[16].WaveHeightCalculation.Output = new HydraulicBoundaryLocationOutput(
                9.24,
                targetProbability, 4.79014,
                1.0 / 197742, 4.78976,
                CalculationConvergence.CalculatedConverged,
                generalResult);
            locations[17].WaveHeightCalculation.Output = new HydraulicBoundaryLocationOutput(
                5.34,
                targetProbability, 4.79014,
                1.0 / 199056, 4.78998,
                CalculationConvergence.CalculatedConverged,
        ...
        private static void SetHydraulicBoundaryLocationDesignWaterLevelOutputValues(IList<HydraulicBoundaryLocation> locations)
        {
        ...
        private static void SetHydraulicBoundaryLocationWaveHeightOutputValues(IList<HydraulicBoundaryLocation> locations)
        {
            const double targetProbability = 1.0 / 30000;
            GeneralResult<TopLevelSubMechanismIllustrationPoint> generalResult = null;
            locations[0].WaveHeightCalculation.Output = new HydraulicBoundaryLocationOutput(
