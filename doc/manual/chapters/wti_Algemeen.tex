...
\item Klik op \includegraphics{pictures/Hoofdstuk_AandeSlag_nieuw/Run_Arrow.png} (run) of \includegraphics{pictures/Hoofdstuk_AandeSlag_nieuw/RunAll_Arrow.png} (run All) in de \textbf{Home} tab van de ribbon (zie ook paragraaf \ref{sec:DS_Toolbar})
...
\hline
\rule{0in}{4ex} \includegraphics{pictures/Hoofdstuk_Delta_Shell/Message_Icon_Info.png} & Informatie \\
\hline
\rule{0in}{4ex}
