...
/*  Created On : 31-Jan-2017 07:54:01 				*/
/*  DBMS       : SQLite 								*/
/* ---------------------------------------------------- */
...
(
	...
	'Order' INT (4) NOT NULL,
	'WmtsName' TEXT NOT NULL,
	'SourceCapabilitesUrl' TEXT,
	'SelectedCapabilityName' TEXT,
	'PreferredFormat' VARCHAR (255),
	'BackgroundMapDataIsVisible' TINYINT (1) NOT NULL, -- true or false
	'BackgroundMapDataTransparency' REAL NOT NULL,
