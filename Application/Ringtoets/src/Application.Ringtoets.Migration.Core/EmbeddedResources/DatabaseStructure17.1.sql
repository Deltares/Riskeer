...
/*  Created On : 13-Sep-2017 2:01:02 PM 				*/
/*  DBMS       : SQLite 								*/
/* ---------------------------------------------------- */
...
BEGIN
	SELECT
		CASE
		WHEN NEW.MacroStabilityInwardsSoilProfileOneDEntityId IS NULL AND NEW.MacroStabilityInwardsSoilProfileTwoDEntityId IS NULL
