...
/*  Created On : 22-Mar-2018 09:53:11 				*/
/*  DBMS       : SQLite 								*/
/* ---------------------------------------------------- */
...
(
	...
	'HydraulicLocationCalculationCollectionEntity1Id' INTEGER NOT NULL, -- Represents the wave height factorized lower limit norm
	'HydraulicLocationCalculationCollectionEntity2Id' INTEGER NOT NULL, -- Represents the waveheight lower limit norm
	'HydraulicLocationCalculationCollectionEntity3Id' INTEGER NOT NULL, -- Represents the waveheight signaling norm
	'HydraulicLocationCalculationCollectionEntity4Id' INTEGER NOT NULL, -- Represents the waveheight factorized signaling norm
	'HydraulicLocationCalculationCollectionEntity5Id' INTEGER NOT NULL, -- Represents the design water level factorized lower limit norm
	'HydraulicLocationCalculationCollectionEntity6Id' INTEGER NOT NULL, -- Represents the design water level lower limit norm
	'HydraulicLocationCalculationCollectionEntity7Id' INTEGER NOT NULL, -- Represents the design water level signaling norm
	'HydraulicLocationCalculationCollectionEntity8Id' INTEGER NOT NULL, -- Represents the design water level factorized signalling norm
	'Id' TEXT,
	'Name' VARCHAR (260),
	'Comments' TEXT,
...
(
	...
	CONSTRAINT 'U_HydraulicLocationCalculationEntityId' UNIQUE ('HydraulicLocationCalculationEntityId')
)
;
