...
/*  Created On : 06-Apr-2018 14:15:13 				*/
/*  DBMS       : SQLite 								*/
/* ---------------------------------------------------- */
...
(
	...
	'TailorMadeAssessmentResult' TINYINT (1) NOT NULL, -- Enum: 1 = None, 2 = NotApplicable 3 = Iv, 4 = IIv, 5 = IIIv, 6 = IVv, 7 = Vv, 8 = VIv, 9 = VIIv
...
;
CREATE TRIGGER [TR_AfterDeleteHydraulicLocationCalculationCollectionEntity_RemoveHydraulicLocationCalculationEntities]
	AFTER DELETE
...
BEGIN
	...
	WHERE HydraulicLocationCalculationEntityId IS OLD.HydraulicLocationCalculationEntityId;
END; 
;
