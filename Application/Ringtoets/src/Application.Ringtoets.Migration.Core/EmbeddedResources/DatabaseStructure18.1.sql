...
(
	...
	'AssessmentSectionEntityId' INTEGER NOT NULL,
	'HydraulicLocationCalculationEntity1Id' INTEGER NOT NULL, -- Represents DesignWaterLevelCalculation1
	'HydraulicLocationCalculationEntity2Id' INTEGER NOT NULL, -- Represents DesignWaterLevelCalculation2
	'HydraulicLocationCalculationEntity3Id' INTEGER NOT NULL, -- Represents DesignWaterLevelCalculation3
	'HydraulicLocationCalculationEntity4Id' INTEGER NOT NULL, -- Represents DesignWaterLevelCalculation4
	'HydraulicLocationCalculationEntity5Id' INTEGER NOT NULL, -- Represents WaveHeightCalculation1
	'HydraulicLocationCalculationEntity6Id' INTEGER NOT NULL, -- Represents WaveHeightCalculation2
	'HydraulicLocationCalculationEntity7Id' INTEGER NOT NULL, -- Represents WaveHeightCalculation3
	'HydraulicLocationCalculationEntity8Id' INTEGER NOT NULL, -- Represents WaveHeightCalculation4
	...
	CONSTRAINT 'U_HydraulicLocationCalculationEntity_HydraulicLocationCalculationEntity2Id' UNIQUE ('HydraulicLocationCalculationEntity2Id'),
	CONSTRAINT 'U_HydraulicLocationCalculationEntity_HydraulicLocationCalculationEntity4Id' UNIQUE ('HydraulicLocationCalculationEntity4Id'),
	CONSTRAINT 'U_HydraulicLocationCalculationEntity_HydraulicLocationCalculationEntity3Id' UNIQUE ('HydraulicLocationCalculationEntity3Id'),
	CONSTRAINT 'U_HydraulicLocationCalculationEntity_HydraulicLocationCalculationEntity1Id' UNIQUE ('HydraulicLocationCalculationEntity1Id'),
	...
	CONSTRAINT 'U_HydraulicLocationCalculationEntity_HydraulicLocationCalculationEntity8Id' UNIQUE ('HydraulicLocationCalculationEntity8Id'),
	CONSTRAINT 'U_HydraulicLocationCalculationEntity_HydraulicLocationCalculationEntity7Id' UNIQUE ('HydraulicLocationCalculationEntity7Id'),
	CONSTRAINT 'U_HydraulicLocationCalculationEntity_HydraulicLocationCalculationEntity5Id' UNIQUE ('HydraulicLocationCalculationEntity5Id')
)
;
...
;
CREATE TRIGGER [TR_AfterDeleteHydraulicLocationEntity_RemoveHydraulicLocationCalculationEntity_CalculationEntity2]
	AFTER DELETE
...
BEGIN
	...
	WHERE OLD.HydraulicLocationCalculationEntity1Id IS NOT NULL 
	AND HydraulicLocationCalculationEntityId IS OLD.HydraulicLocationCalculationEntity2Id;
END; 
;

CREATE TRIGGER [TR_AfterDeleteHydraulicLocationEntity_RemoveHydraulicLocationCalculationEntity_CalculationEntity4]
	AFTER DELETE
	ON HydraulicLocationEntity
	FOR EACH ROW
BEGIN
	...
	FROM HydraulicLocationCalculationEntity
	WHERE OLD.HydraulicLocationCalculationEntity1Id IS NOT NULL 
	AND HydraulicLocationCalculationEntityId IS OLD.HydraulicLocationCalculationEntity4Id;
END; 
;

CREATE TRIGGER [TR_AfterDeleteHydraulicLocationEntity_RemoveHydraulicLocationCalculationEntity_CalculationEntity3]
	AFTER DELETE
	ON HydraulicLocationEntity
	FOR EACH ROW
BEGIN
	...
	FROM HydraulicLocationCalculationEntity
	WHERE OLD.HydraulicLocationCalculationEntity1Id IS NOT NULL 
	AND HydraulicLocationCalculationEntityId IS OLD.HydraulicLocationCalculationEntity3Id;
END; 
;

CREATE TRIGGER [TR_AfterDeleteHydraulicLocationEntity_RemoveHydraulicLocationCalculationEntity_CalculationEntity1]
	AFTER DELETE
	ON HydraulicLocationEntity
	FOR EACH ROW
BEGIN
	...
	FROM HydraulicLocationCalculationEntity
	WHERE OLD.HydraulicLocationCalculationEntity1Id IS NOT NULL 
	AND HydraulicLocationCalculationEntityId IS OLD.HydraulicLocationCalculationEntity1Id;
END; 
;

CREATE TRIGGER [TR_AfterDeleteHydraulicLocationEntity_RemoveHydraulicLocationCalculationEntity_CalculationEntity6]
	AFTER DELETE
	ON HydraulicLocationEntity
	FOR EACH ROW
BEGIN
	...
	FROM HydraulicLocationCalculationEntity
	WHERE OLD.HydraulicLocationCalculationEntity1Id IS NOT NULL 
	AND HydraulicLocationCalculationEntityId IS OLD.HydraulicLocationCalculationEntity6Id;
END; 
;
...
BEGIN
	...
	FROM HydraulicLocationCalculationEntity
	WHERE OLD.HydraulicLocationCalculationEntity1Id IS NOT NULL 
	AND HydraulicLocationCalculationEntityId IS OLD.HydraulicLocationCalculationEntity8Id;
END; 
;

CREATE TRIGGER [TR_AfterDeleteHydraulicLocationEntity_RemoveHydraulicLocationCalculationEntity_CalculationEntity7]
	AFTER DELETE
	ON HydraulicLocationEntity
	FOR EACH ROW
BEGIN
	...
	FROM HydraulicLocationCalculationEntity
	WHERE OLD.HydraulicLocationCalculationEntity1Id IS NOT NULL 
	AND HydraulicLocationCalculationEntityId IS OLD.HydraulicLocationCalculationEntity7Id;
END; 
;

CREATE TRIGGER [TR_AfterDeleteHydraulicLocationEntity_RemoveHydraulicLocationCalculationEntity_CalculationEntity5]
	AFTER DELETE
	ON HydraulicLocationEntity
	FOR EACH ROW
BEGIN
	...
	FROM HydraulicLocationCalculationEntity
	WHERE OLD.HydraulicLocationCalculationEntity1Id IS NOT NULL 
	AND HydraulicLocationCalculationEntityId IS OLD.HydraulicLocationCalculationEntity5Id;
END; 
;
