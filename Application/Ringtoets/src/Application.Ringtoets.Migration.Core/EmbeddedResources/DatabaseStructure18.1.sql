...
/*  Created On : 30-May-2018 10:34:37 				*/
/*  DBMS       : SQLite 								*/
/* ---------------------------------------------------- */
...
(
	...
	'CalculatedReliability' REAL,
	'CalculationConvergence' TINYINT (1) NOT NULL, -- Enum: 1 = NotCalculated, 2 = CalculatedNotConverged, 3 = CalculatedConverged
	CONSTRAINT 'FK_DuneLocationOutputEntity_DuneLocationCalculationEntity' FOREIGN KEY ('DuneLocationCalculationEntityId') REFERENCES 'DuneLocationCalculationEntity' ('DuneLocationCalculationEntityId') ON DELETE Cascade ON UPDATE Cascade
)
;
...
CREATE INDEX 'IXFK_DuneLocationOutputEntity_DuneLocationCalculationEntity'
 ON 'DuneLocationOutputEntity' ('DuneLocationCalculationEntityId' ASC)
;
