...
/*  Created On : 13-Sep-2017 11:27:07 AM 				*/
/*  DBMS       : SQLite 								*/
/* ---------------------------------------------------- */
...
(
	...
	'SurfaceLineEntityId' INTEGER NOT NULL,
	'Type' SMALLINT NOT NULL, -- Enumtype: 1 = SurfaceLevelOutside 2 = SurfaceLevelInside  3 = TrafficLoadOutside 4 = TrafficLoadInside 5 = ShoulderBaseInside 6 = ShoulderTopInside 7 = DikeToeAtRiver 8 = DikeToeAtPolder 9 = BottomDitchDikeSide 10 = BottomDitchPolderSide 11 = DitchDikeSide 12 = DikeTopAtRiver 13 = DikeTopAtPolder 14 = DitchPolderSide
	'X' REAL,
	'Y' REAL,
	'Z' REAL,
...
(
	...
	'HolesXml' TEXT,
	'Order' INT (4) NOT NULL,
	CONSTRAINT 'FK_MacroStabilityInwardsSoilLayerTwoDEntity_MacroStabilityInwardsSoilProfileTwoDEntity' FOREIGN KEY ('MacroStabilityInwardsSoilProfileTwoDEntityId') REFERENCES 'MacroStabilityInwardsSoilProfileTwoDEntity' ('MacroStabilityInwardsSoilProfileTwoDEntityId') ON DELETE Cascade ON UPDATE Cascade
)
;
...
(
	...
	'PreconsolidationStressMean' REAL NOT NULL,
	'PreconsolidationStressCoefficientOfVariation' REAL NOT NULL,
...
CREATE INDEX 'IXFK_MacroStabilityInwardsSoilLayer2DEntity_MacroStabilityInwardsSoilProfile2DEntity'
 ON 'MacroStabilityInwardsSoilLayerTwoDEntity' ('MacroStabilityInwardsSoilProfileTwoDEntityId' ASC)
;
