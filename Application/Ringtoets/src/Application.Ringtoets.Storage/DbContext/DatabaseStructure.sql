...
/*  Created On : 13-Dec-2016 11:03:20 AM 				*/
/*  DBMS       : SQLite 								*/
/* ---------------------------------------------------- */
...
(
	...
	'UseForeshore' TINYINT (1) NOT NULL,
	'DikeHeightCalculationType' TINYINT (1) NOT NULL, -- NoCalculation = 1, CalculateByAssessmentSectionNorm = 2, CalculateByProfileSpecificRequiredProbability = 3
	'DikeHeight' REAL,
	'UseBreakWater' TINYINT (1) NOT NULL,
	'BreakWaterType' SMALLINT NOT NULL,
	'BreakWaterHeight' REAL,
