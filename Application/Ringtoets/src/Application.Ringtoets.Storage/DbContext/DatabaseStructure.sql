...
/*  Created On : 10-Jan-2017 8:02:32 AM 				*/
/*  DBMS       : SQLite 								*/
/* ---------------------------------------------------- */
...
(
	...
	'D50' REAL,
	'Order' INT (4) NOT NULL,
	CONSTRAINT 'FK_DuneLocationEntity_AssessmentSectionEntity' FOREIGN KEY ('AssessmentSectionEntityId') REFERENCES 'AssessmentSectionEntity' ('AssessmentSectionEntityId') ON DELETE Cascade ON UPDATE Cascade
)
;
...
CREATE INDEX 'IXFK_DuneLocationEntity_AssessmentSectionEntity'
 ON 'DuneLocationEntity' ('AssessmentSectionEntityId' ASC)
;
