...
/*  Created On : 07-Dec-2016 1:02:28 PM 				*/
/*  DBMS       : SQLite 								*/
/* ---------------------------------------------------- */
...
(
	...
	'AssessmentSectionEntityId' INTEGER NOT NULL,
	'DesignWaterLevelOutput' INTEGER,
	'WaveHeightOutput' INTEGER,
...
(
	...
	'HydraulicLocationOutputType' TINYINT (1) NOT NULL,
	'Result' REAL,
	'TargetProbability' REAL,
	'TargetReliability' REAL,
	'CalculatedProbability' REAL,
...
(
	...
	CONSTRAINT 'U_GrassCoverErosionOutwardsHydraulicLocationOutputType' UNIQUE ('GrassCoverErosionOutwardsHydraulicLocationEntityId','HydraulicLocationOutputType')
)
;
