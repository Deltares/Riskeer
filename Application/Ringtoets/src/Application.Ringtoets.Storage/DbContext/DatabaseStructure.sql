...
/*  Created On : 01-aug-2016 14:44:48 				*/
/*  DBMS       : SQLite 								*/
/* ---------------------------------------------------- */
...
(
	...
	'FailureMechanismSectionPointData' BLOB NOT NULL,
...
(
	...
	'Diameter70Mean' REAL,
	'Diameter70StandardDeviation' REAL,
	'DarcyPermeabilityMean' REAL,
	'DarcyPermeabilityStandardDeviation' REAL,
	'DampingFactorExitMean' REAL,
	'DampingFactorExitStandardDeviation' REAL,
	'SaturatedVolumicWeightOfCoverageLayerMean' REAL,
	'SaturatedVolumicWeightOfCoverageLayerStandardDeviation' REAL,
	'SaturatedVolumicWeightOfCoverageLayerShift' REAL,
...
(
	...
	CONSTRAINT 'FK_GrassCoverErosionInwardsCalculationEntity_GrassCoverErosionInwardsOutputEntity' FOREIGN KEY ('GrassCoverErosionInwardsOutputEntityId') REFERENCES 'GrassCoverErosionInwardsOutputEntity' ('GrassCoverErosionInwardsOutputId') ON DELETE Set Null ON UPDATE Cascade,
...
(
	...
	'Name' TEXT,
	'SegmentName' TEXT,
	'StochasticSoilModelSegmentPointData' BLOB NOT NULL,
...
(
	'GrassCoverErosionInwardsOutputId' INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
