...
/*  Created On : 24-mei-2016 16:07:16 				*/
/*  DBMS       : SQLite 								*/
/* ---------------------------------------------------- */
...
(
	...
	CONSTRAINT 'FK_CalculationGroupEntity_FailureMechanismEntity' FOREIGN KEY ('FailureMechanismEntityId') REFERENCES 'FailureMechanismEntity' ('FailureMechanismEntityId') ON DELETE No Action ON UPDATE Cascade
)
;
...
CREATE INDEX 'IXFK_CalculationGroupEntity_FailureMechanismEntity'
 ON 'CalculationGroupEntity' ('FailureMechanismEntityId' ASC)
;
