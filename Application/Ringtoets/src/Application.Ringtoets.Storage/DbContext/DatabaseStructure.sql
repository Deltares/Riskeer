...
/*  Created On : 26-mei-2016 14:48:57 				*/
/*  DBMS       : SQLite 								*/
/* ---------------------------------------------------- */
...
(
	...
	CONSTRAINT 'FK_CalculationGroupEntity_FailureMechanismEntity' FOREIGN KEY ('CalculationGroupEntityId') REFERENCES 'FailureMechanismEntity' ('FailureMechanismEntityId') ON DELETE No Action ON UPDATE No Action
)
;
...
CREATE INDEX 'IXFK_CalculationGroupEntity_FailureMechanismEntity'
 ON 'CalculationGroupEntity' ('CalculationGroupEntityId' ASC)
;
