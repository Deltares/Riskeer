...
namespace Application.Ringtoets.Storage.Read.MacroStabilityInwards
{
    ...
    /// based on the <see cref="MacroStabilityInwardsSoilLayer1DEntity"/>.
    /// </summary>
    internal static class MacroStabilityInwardsSoilLayer1DEntityReadExtensions
    {
        /// <summary>
        /// Reads the <see cref="MacroStabilityInwardsSoilLayer1DEntity"/> and use the information 
        /// to construct a <see cref="MacroStabilityInwardsSoilLayer1D"/>.
        /// </summary>
        /// <param name="entity">The <see cref="MacroStabilityInwardsSoilLayer1DEntity"/> to create 
        ...
        public static MacroStabilityInwardsSoilLayer1D Read(this MacroStabilityInwardsSoilLayer1DEntity entity)
        {
            if (entity == null)
            {
