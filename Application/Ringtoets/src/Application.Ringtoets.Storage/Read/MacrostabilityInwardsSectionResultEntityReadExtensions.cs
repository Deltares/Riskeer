...
namespace Application.Ringtoets.Storage.Read
{
    ...
    internal static class MacrostabilityInwardsSectionResultEntityReadExtensions
    {
        ...
        internal static void Read(this MacrostabilityInwardsSectionResultEntity entity, MacrostabilityInwardsFailureMechanismSectionResult sectionResult, ReadConversionCollector collector)
        {
            if (collector == null)
            {
