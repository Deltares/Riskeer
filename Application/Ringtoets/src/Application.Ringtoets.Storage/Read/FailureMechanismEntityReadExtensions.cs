...
namespace Application.Ringtoets.Storage.Read
{
    ...
    internal static class FailureMechanismEntityReadExtensions
    {
                                                                        ...
                                                                        ReadConversionCollector collector)
        {
            ...
            {
                FailureMechanismSection failureMechanismSection = collector.Get(sectionResultEntity.FailureMechanismSectionEntity);
                StructuresFailureMechanismSectionResult<HeightStructuresInput> result = failureMechanism.SectionResults.Single(sr => ReferenceEquals(sr.Section, failureMechanismSection));
                                                                         ...
                                                                         ReadConversionCollector collector)
        {
            ...
            {
                FailureMechanismSection failureMechanismSection = collector.Get(sectionResultEntity.FailureMechanismSectionEntity);
                StructuresFailureMechanismSectionResult<ClosingStructuresInput> result = failureMechanism.SectionResults.Single(sr => ReferenceEquals(sr.Section, failureMechanismSection));
                                                                                ...
                                                                                ReadConversionCollector collector)
        {
            ...
            {
                FailureMechanismSection failureMechanismSection = collector.Get(sectionResultEntity.FailureMechanismSectionEntity);
                StructuresFailureMechanismSectionResult<StabilityPointStructuresInput> result = failureMechanism.SectionResults
