...
namespace Application.Ringtoets.Storage.Read
{
    ...
    internal static class GrassCoverSlipOffInwardsSectionResultEntityReadExtensions
    {
        ...
        internal static void Read(this GrassCoverSlipOffInwardsSectionResultEntity entity, GrassCoverSlipOffInwardsFailureMechanismSectionResult sectionResult, ReadConversionCollector collector)
        {
            if (collector == null)
            {
            ...
            sectionResult.StorageId = entity.GrassCoverSlipOffInwardsSectionResultEntityId;
