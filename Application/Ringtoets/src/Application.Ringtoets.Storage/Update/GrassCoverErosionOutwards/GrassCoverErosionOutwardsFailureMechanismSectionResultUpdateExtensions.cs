...
{
    /// <summary>
    /// Extension methods for <see cref="GrassCoverErosionOutwardsFailureMechanismSectionResult"/> related to updating a 
    /// <see cref="GrassCoverErosionOutwardsSectionResultEntity"/>.
    /// </summary>
    internal static class GrassCoverErosionOutwardsFailureMechanismSectionResultUpdateExtensions
    {
        /// <summary>
        /// Updates a <see cref="GrassCoverErosionOutwardsSectionResultEntity"/> in the database based on the information of the 
        ...
        internal static void Update(this GrassCoverErosionOutwardsFailureMechanismSectionResult result, PersistenceRegistry registry, IRingtoetsEntities context)
        {
            if (context == null)
            {
