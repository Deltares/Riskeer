...
namespace Application.Ringtoets.Storage.Update.StrengthStabilityPointConstruction
{
    /// <summary>
    /// Extension methods for <see cref="StrengthStabilityPointConstructionFailureMechanismSectionResult"/> related to updating a 
    ...
    {
        /// <summary>
        /// Updates a <see cref="StrengthStabilityPointConstructionSectionResultEntity"/> in the database based on the information of the 
