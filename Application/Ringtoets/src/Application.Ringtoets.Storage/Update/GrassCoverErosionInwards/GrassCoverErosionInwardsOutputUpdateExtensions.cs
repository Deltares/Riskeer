...
{
    /// <summary>
    /// Extension methods for <see cref="GrassCoverErosionInwardsOutput"/> related to
    /// updating a <see cref="GrassCoverErosionInwardsOutputEntity"/>.
    /// </summary>
    internal static class GrassCoverErosionInwardsOutputUpdateExtensions
    {
        /// <summary>
        /// Updates a <see cref="GrassCoverErosionInwardsOutputEntity"/> in the database
        /// based on the information of the <see cref="GrassCoverErosionInwardsOutput"/>.
        /// </summary>
        /// <param name="output">The grass cover erosion inwards calculation output to
        /// update the database entity for.</param>
