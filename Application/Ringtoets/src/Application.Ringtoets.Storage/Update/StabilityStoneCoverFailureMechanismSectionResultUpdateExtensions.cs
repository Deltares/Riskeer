...
{
    /// <summary>
    /// Extension methods for <see cref="StabilityStoneCoverFailureMechanismSectionResult"/> related to updating a 
    /// <see cref="StabilityStoneCoverSectionResultEntity"/>.
    /// </summary>
    internal static class StabilityStoneCoverFailureMechanismSectionResultUpdateExtensions
    {
        /// <summary>
        /// Updates a <see cref="StabilityStoneCoverSectionResultEntity"/> in the database based on the information of the 
        ...
        internal static void Update(this StabilityStoneCoverFailureMechanismSectionResult result, PersistenceRegistry registry, IRingtoetsEntities context)
        {
            if (context == null)
            {
