...
namespace Application.Ringtoets.Storage.Update.TechnicalInnovation
{
    /// <summary>
    /// Extension methods for <see cref="TechnicalInnovationFailureMechanismSectionResult"/> related to updating a 
    /// <see cref="TechnicalInnovationSectionResultEntity"/>.
    /// </summary>
    internal static class TechnicalInnovationFailureMechanismSectionResultUpdateExtensions
    {
        /// <summary>
        /// Updates a <see cref="TechnicalInnovationSectionResultEntity"/> in the database based on the information of the 
