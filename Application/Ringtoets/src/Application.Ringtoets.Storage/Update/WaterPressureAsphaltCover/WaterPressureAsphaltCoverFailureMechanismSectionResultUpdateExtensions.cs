...
{
    /// <summary>
    /// Extension methods for <see cref="WaterPressureAsphaltCoverFailureMechanismSectionResult"/> related to updating a 
    /// <see cref="WaterPressureAsphaltCoverSectionResultEntity"/>.
    /// </summary>
    internal static class WaterPressureAsphaltCoverFailureMechanismSectionResultUpdateExtensions
    {
        /// <summary>
        /// Updates a <see cref="WaterPressureAsphaltCoverSectionResultEntity"/> in the database based on the information of the 
