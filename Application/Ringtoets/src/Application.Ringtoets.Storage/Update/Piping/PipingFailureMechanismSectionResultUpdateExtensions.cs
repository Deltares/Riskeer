...
{
    /// <summary>
    /// Extension methods for <see cref="PipingFailureMechanismSectionResult"/> related to updating a 
    /// <see cref="PipingSectionResultEntity"/>.
    /// </summary>
    internal static class PipingFailureMechanismSectionResultUpdateExtensions
    {
        /// <summary>
        /// Updates a <see cref="PipingSectionResultEntity"/> in the database based on the information of the 
