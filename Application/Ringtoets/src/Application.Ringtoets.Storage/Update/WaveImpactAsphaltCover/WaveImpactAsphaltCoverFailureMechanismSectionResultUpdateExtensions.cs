...
{
    /// <summary>
    /// Extension methods for <see cref="WaveImpactAsphaltCoverFailureMechanismSectionResult"/> related to updating a 
    /// <see cref="WaveImpactAsphaltCoverSectionResultEntity"/>.
    /// </summary>
    internal static class WaveImpactAsphaltCoverFailureMechanismSectionResultUpdateExtensions
    {
        /// <summary>
        /// Updates a <see cref="WaveImpactAsphaltCoverSectionResultEntity"/> in the database based on the information of the 
        ...
        internal static void Update(this WaveImpactAsphaltCoverFailureMechanismSectionResult result, PersistenceRegistry registry, IRingtoetsEntities context)
        {
            if (context == null)
            {
