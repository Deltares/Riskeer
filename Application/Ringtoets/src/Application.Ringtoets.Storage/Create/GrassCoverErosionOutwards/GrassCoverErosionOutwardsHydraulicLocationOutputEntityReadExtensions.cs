...
namespace Application.Ringtoets.Storage.Create.GrassCoverErosionOutwards
{
    ...
    /// </summary>
    internal static class GrassCoverErosionOutwardsHydraulicLocationOutputEntityReadExtensions
    {
        /// <summary>
        /// Read the <see cref="GrassCoverErosionOutwardsHydraulicLocationOutputEntity"/> and use the information 
        /// to construct a <see cref="HydraulicBoundaryLocationOutput"/>.
        /// </summary>
