...
namespace Application.Ringtoets.Storage.TestUtil
{
    public static class RingtoetsEntitiesHelper
    {
        ...
        public static IRingtoetsEntities CreateStub(MockRepository mockRepository)
        {
            ...
            DbSet<GrassCoverErosionInwardsCalculationEntity> grassCoverErosionInwardsCalculationSet = CreateEmptyTestDbSet<GrassCoverErosionInwardsCalculationEntity>();
            DbSet<GrassCoverErosionInwardsOutputEntity> grassCoverErosionInwardsOutputSet = CreateEmptyTestDbSet<GrassCoverErosionInwardsOutputEntity>();
