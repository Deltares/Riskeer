...
namespace Application.Ringtoets.Storage.Test.Exceptions
{
    ...
    public class CannotDeleteBackupFileExceptionTest
    {
        ...
        public void Constructor_SerializationRoundTrip_ExceptionProperlyInitialized()
        {
            ...
            var originalException = new CannotDeleteBackupFileException("outer", originalInnerException);
            ...
            // Call
            CannotDeleteBackupFileException persistedException = SerializationTestHelper.SerializeAndDeserializeException(originalException);
