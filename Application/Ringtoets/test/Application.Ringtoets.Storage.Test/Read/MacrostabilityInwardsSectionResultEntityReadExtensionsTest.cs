...
namespace Application.Ringtoets.Storage.Test.Read
{
    ...
    public class MacrostabilityInwardsSectionResultEntityReadExtensionsTest
    {
        ...
        public void Read_CollectorIsNull_ThrowArgumentNullException()
        {
            ...
            // Call
            TestDelegate call = () => entity.Read(new MacrostabilityInwardsFailureMechanismSectionResult(new TestFailureMechanismSection()), null);
        ...
        [TestCase(true)]
        [TestCase(false)]
        public void Read_WithDecimalParameterValues_ReturnMacrostabilityInwardsSectionResultWithDoubleParameterValues(bool layerOne)
        {
            // Setup
            ...
            var entity = new MacrostabilityInwardsSectionResultEntity
            {
                MacrostabilityInwardsSectionResultEntityId = entityId,
        ...
        [TestCase(true)]
        [TestCase(false)]
        public void Read_WithNullLayerTwoA_ReturnMacrostabilityInwardsSectionResultWithNullParameters(bool layerOne)
        {
            // Setup
            var collector = new ReadConversionCollector();
            var failureMechanismSectionEntity = new FailureMechanismSectionEntity();
        ...
        [TestCase(true)]
        [TestCase(false)]
        public void Read_WithNullLayerThree_ReturnMacrostabilityInwardsSectionResultWithNullParameters(bool layerOne)
        {
            // Setup
            var collector = new ReadConversionCollector();
            var failureMechanismSectionEntity = new FailureMechanismSectionEntity();
