...
namespace Application.Ringtoets.Storage.Test.Read
{
    ...
    public class StabilityStoneCoverSectionResultEntityReadExtensionsTest
    {
        ...
        public void Read_WithDecimalParameterValues_ReturnStabilityStoneCoverSoilLayerWithDoubleParameterValues(bool layerOne, AssessmentLayerTwoAResult layerTwoA)
        {
            // Setup
        ...
        [TestCase(false, AssessmentLayerTwoAResult.Successful)]
        [TestCase(false, AssessmentLayerTwoAResult.Failed)]
        public void Read_WithNullLayerThree_ReturnStabilityStoneCoverSoilLayerWithNullParameters(bool layerOne, AssessmentLayerTwoAResult layerTwoA)
        {
            // Setup
            var collector = new ReadConversionCollector();
            var failureMechanismSectionEntity = new FailureMechanismSectionEntity();
