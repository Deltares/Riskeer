...
namespace Application.Ringtoets.Storage.Test.Read
{
    ...
    public class MacrostabilityOutwardsSectionResultEntityReadExtensionsTest
    {
        ...
        public void Read_CollectorIsNull_ThrowArgumentNullException()
        {
            ...
            // Call
            TestDelegate call = () => entity.Read(new MacrostabilityOutwardsFailureMechanismSectionResult(new TestFailureMechanismSection()), null);
        ...
        public void Read_WithDecimalParameterValues_ReturnMacrostabilityOutwardsSectionResultWithDoubleParameterValues(bool layerOne)
        {
            ...
            var entity = new MacrostabilityOutwardsSectionResultEntity
            {
                MacrostabilityOutwardsSectionResultEntityId = entityId,
