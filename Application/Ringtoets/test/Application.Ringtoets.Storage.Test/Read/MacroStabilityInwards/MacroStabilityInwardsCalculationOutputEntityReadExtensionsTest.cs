    ...
    public class MacroStabilityInwardsCalculationOutputEntityReadExtensionsTest
    {
        ...
        public void Read_EntityWithValues_ReturnExpectedOutput()
        {
            ...
            var entity = new MacroStabilityInwardsCalculationOutputEntity
            {
                ...
                SlipPlaneLeftGridXLeft = random.GetFromRange(0.0, 1.0),
                SlipPlaneLeftGridXRight = random.GetFromRange(2.0, 3.0),
                SlipPlaneLeftGridNrOfHorizontalPoints = random.Next(1, 100),
                SlipPlaneLeftGridZTop = random.GetFromRange(2.0, 3.0),
                SlipPlaneLeftGridZBottom = random.GetFromRange(0.0, 1.0),
                SlipPlaneLeftGridNrOfVerticalPoints = random.Next(1, 100),
                SlipPlaneRightGridXLeft = random.GetFromRange(0.0, 1.0),
                SlipPlaneRightGridXRight = random.GetFromRange(2.0, 3.0),
                SlipPlaneRightGridNrOfHorizontalPoints = random.Next(1, 100),
                SlipPlaneRightGridZTop = random.GetFromRange(2.0, 3.0),
                SlipPlaneRightGridZBottom = random.GetFromRange(0.0, 1.0),
