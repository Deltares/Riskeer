...
namespace Application.Ringtoets.Storage.Test.Read.StabilityPointStructures
{
    ...
    public class StabilityPointStructureEntityReadExtensionsTest
    {
        ...
        public void Read_ValidEntity_ReturnStabilityPointStructure()
        {
            ...
            Assert.AreEqual(entity.FlowVelocityStructureClosableStandardDeviation, structure.FlowVelocityStructureClosable.StandardDeviation.Value);
        ...
        public void Read_NullValues_ReturnStabilityPointStructureWithNaN()
        {
            ...
            Assert.IsNaN(structure.FlowVelocityStructureClosable.StandardDeviation);
