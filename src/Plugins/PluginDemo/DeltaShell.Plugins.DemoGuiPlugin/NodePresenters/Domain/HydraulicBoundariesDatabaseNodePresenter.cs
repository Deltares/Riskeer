...
namespace DeltaShell.Plugins.DemoGuiPlugin.NodePresenters.Domain
{
    public class HydraulicBoundariesDatabaseNodePresenter : ITreeNodePresenter
    {
        public ITreeView TreeView { get; set; }

        public Type NodeTagType { get { return typeof(HydraulicBoundariesDatabase); } }

        public void UpdateNode(ITreeNode parentNode, ITreeNode node, object nodeData)
        {
            node.Text = "Hydraulic boundaries database";
            node.Image = Properties.Resources.database__arrow;
        }
