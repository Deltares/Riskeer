...
{
    public class AssessmentNodePresenter : ITreeNodePresenter
    {
        public ITreeView TreeView { get; set; }

        public Type NodeTagType { get { return typeof(IAssessment); } }

        public void UpdateNode(ITreeNode parentNode, ITreeNode node, object nodeData)
        {
            node.Text = ((IAssessment) nodeData).Name;
            node.Image = Properties.Resources.gear;
        }
