...
namespace DeltaShell.Plugins.DemoGuiPlugin.NodePresenters.Schematization
{
    public class ReferenceLineNodePresenter : ITreeNodePresenter
    {
        public ITreeView TreeView { get; set; }

        public Type NodeTagType { get { return typeof(ReferenceLine); } }

        public void UpdateNode(ITreeNode parentNode, ITreeNode node, object nodeData)
        {
            node.Text = "Reference line";
            node.Image = Properties.Resources.layer_shape_curve;
        }
