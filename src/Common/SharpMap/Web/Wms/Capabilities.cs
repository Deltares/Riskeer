...
namespace SharpMap.Web.Wms
{
    ...
    public class Capabilities
    {
        ...
        private static XmlElement GenerateBoundingBoxElement(IEnvelope bbox, int SRID, XmlDocument doc)
        {
            ...
            xmlBbox.Attributes.Append(CreateAttribute("minx", bbox.MinX.ToString(Map.numberFormat_EnUS), doc));
            xmlBbox.Attributes.Append(CreateAttribute("miny", bbox.MinY.ToString(Map.numberFormat_EnUS), doc));
            xmlBbox.Attributes.Append(CreateAttribute("maxx", bbox.MaxX.ToString(Map.numberFormat_EnUS), doc));
            xmlBbox.Attributes.Append(CreateAttribute("maxy", bbox.MaxY.ToString(Map.numberFormat_EnUS), doc));
        ...
        {
            //Get XML Schema
            Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("SharpMap.Web.Wms.Schemas._1._3._0.capabilities_1_3_0.xsd");
