...
namespace SharpMap.Data.Providers.EGIS.ShapeFileLib
{
    ...
    public struct SizeD
    {
        ...
        /// <param name="width">The width component of the new <see cref="T:SharpMap.Data.Providers.EGIS.ShapeFileLib.SizeD"></see>. </param>
        /// <param name="height">The height component of the new <see cref="T:SharpMap.Data.Providers.EGIS.ShapeFileLib.SizeD"></see>. </param>
        ...
        /// <returns>A <see cref="T:SharpMap.Data.Providers.EGIS.ShapeFileLib.SizeD"></see> that is the result of the subtraction operation.</returns>
        /// <param name="sz2">The <see cref="T:SharpMap.Data.Providers.EGIS.ShapeFileLib.SizeD"></see> on the right side of the subtraction operator. </param>
        /// <param name="sz1">The <see cref="T:SharpMap.Data.Providers.EGIS.ShapeFileLib.SizeD"></see> on the left side of the subtraction operator. </param>
        /// <filterpriority>3</filterpriority>
        public static SizeD operator -(SizeD sz1, SizeD sz2)
        {
        ...
        /// <summary>Tests whether two <see cref="T:SharpMap.Data.Providers.EGIS.ShapeFileLib.SizeD"></see> structures are equal.</summary>
        /// <returns>This operator returns true if sz1 and sz2 have equal width and height; otherwise, false.</returns>
        /// <param name="sz2">The <see cref="T:SharpMap.Data.Providers.EGIS.ShapeFileLib.SizeD"></see> structure on the right of the equality operator. </param>
        /// <param name="sz1">The <see cref="T:SharpMap.Data.Providers.EGIS.ShapeFileLib.SizeD"></see> structure on the left side of the equality operator. </param>
        /// <filterpriority>3</filterpriority>
        ...
        /// <summary>Tests whether two <see cref="T:SharpMap.Data.Providers.EGIS.ShapeFileLib.SizeD"></see> structures are different.</summary>
        ...
        /// <param name="sz2">The <see cref="T:SharpMap.Data.Providers.EGIS.ShapeFileLib.SizeD"></see> structure on the right of the inequality operator. </param>
        /// <param name="sz1">The <see cref="T:SharpMap.Data.Providers.EGIS.ShapeFileLib.SizeD"></see> structure on the left of the inequality operator. </param>
        /// <filterpriority>3</filterpriority>
        public static bool operator !=(SizeD sz1, SizeD sz2)
        {
            return !(sz1 == sz2);
        ...
        /// <summary>Converts the specified <see cref="T:SharpMap.Data.Providers.EGIS.ShapeFileLib.SizeD"></see> to a <see cref="T:EGIS.ShapeFileLib.PointD"></see>.</summary>
        /// <returns>The <see cref="T:EGIS.ShapeFileLib.PointD"></see> structure to which this operator converts.</returns>
        /// <param name="size">The <see cref="T:SharpMap.Data.Providers.EGIS.ShapeFileLib.SizeD"></see> structure to be converted</param>
        /// <filterpriority>3</filterpriority>
        ...
        /// <summary>Gets a value indicating whether this <see cref="T:SharpMap.Data.Providers.EGIS.ShapeFileLib.SizeD"></see> has zero width and height.</summary>
        /// <returns>This property returns true when this <see cref="T:SharpMap.Data.Providers.EGIS.ShapeFileLib.SizeD"></see> has both a width and height of zero; otherwise, false.</returns>
        /// <filterpriority>1</filterpriority>
        [Browsable(false)]
        public bool IsEmpty
        {
        ...
        /// <summary>Converts a <see cref="T:SharpMap.Data.Providers.EGIS.ShapeFileLib.SizeD"></see> to a <see cref="T:EGIS.ShapeFileLib.PointD"></see>.</summary>
        ...
        /// <returns>A string that represents this <see cref="T:SharpMap.Data.Providers.EGIS.ShapeFileLib.SizeD"></see>.</returns>
        /// <filterpriority>1</filterpriority>
