...
namespace SharpMap.Utilities
{
    ...
    public class Transform
    {
        ...
        public static Point WorldtoMap(ICoordinate p, IMap map)
        {
        ...
        public static ICoordinate MapToWorld(PointF p, Map map)
        {
            ...
            return GeometryFactory.CreateCoordinate(env.MinX + p.X*map.PixelWidth,
        ...
        /// <returns>point in image coordinates</returns>
        public static PointF TransformToImage(IPoint p, Map map)
        {
            return WorldtoMap(p.Coordinate, map);
        }
        ...
        public static PointF[] TransformToImage(IPolygon poly, Map map)
        {
            ...
            {
                v[i] = WorldtoMap(poly.Shell.Coordinates[i], map);
            }
            ...
            for (int k = 0; k < poly.Holes.Length; k++)
            {
                ...
                {
                    v[j + i] = WorldtoMap(poly.Holes[k].Coordinates[i], map);
                }
