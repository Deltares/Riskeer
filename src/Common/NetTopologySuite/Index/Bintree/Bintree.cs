...
{
    /// <summary>
    /// An <c>BinTree</c> (or "Binary Interval Tree") is a 1-dimensional version of a <seealso cref="SharpMap.Utilities.SpatialIndexing.QuadTree"/>.
    /// </summary>
    /// <para>
    /// It indexes 1-dimensional intervals (which of course may be the projection of 2-D objects on an axis).
    /// It supports range searching (where the range may be a single point).
    /// This implementation does not require specifying the extent of the inserted items beforehand. It will automatically expand to 
    /// accommodate any extent of dataset.
    /// </para>
    /// <para>
