...
namespace DelftTools.Controls.Swf.Csv.FormatPickers
{
    public class DateTimeCsvFormatPickerProvider : CsvFormatPickerProvider
    {
        ...
        {
            var panel = new Panel {Height = 25, Width = 400};
            
            dateTimeFormatBox = new TextBox { Left = 0, Width = 150 };
            ...
            var applyButton = new Button { Left = 155, Width = 45, Height = dateTimeFormatBox.Height, Text = "Apply" };
        ...
        void dateTimeFormatBox_Leave(object sender, EventArgs e)
        {
