...
namespace DelftTools.Controls.Swf.Table
{
    public class NonMandatoryDataGridViewComboBoxCell : DataGridViewComboBoxCell
    {
            ...
            TypeConverter valueTypeConverter, TypeConverter formattedValueTypeConverter, DataGridViewDataErrorContexts context)
        {
            ...
            var gdvcfe = (DataGridViewCellFormattingEventArgs) methodInfo.Invoke(DataGridView, new[] {ColumnIndex, rowIndex, value, FormattedValueType, cellStyle});
        ...
        private bool LookupValue(object originalValue, out object value)
        {
            ...
            var parameters = new[] { originalValue, Value };
            ...
            IFormatProvider formatInfo, object formattedNullValue, object dataSourceNullValue)
        {
            ...
            return methodInfo.Invoke(null, new[] { value, targetType, sourceType, targetConverter, sourceConverter, formatInfo, formattedNullValue, dataSourceNullValue });
        }
            ...
            , string format, IFormatProvider formatProvider, object nullValue, object dataSourceNullValue)
        {
            ...
            return methodInfo.Invoke(null, new[] { formattedValue, formattedValueType, valueTypeConverter, formattedValueTypeConverter, format, formatProvider, nullValue, dataSourceNullValue });
        }
