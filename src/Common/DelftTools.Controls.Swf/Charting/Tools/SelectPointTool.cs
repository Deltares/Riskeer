...
namespace DelftTools.Controls.Swf.Charting.Tools
{
    ...
    {
        private static ILog log = LogManager.GetLogger(typeof(SelectPointTool));
        ...
        void SelectedPointsCollectionChanged(object sender, NotifyCollectionChangingEventArgs e)
        {
        ...
        {
            get { return size; }
            set { SetIntegerProperty(ref size, value); }
        }
        ...
        {
            get { return Texts.NearestPointSummary; }
        }
        ...
        {
            get { return drawLine; }
            set { SetBooleanProperty(ref drawLine, value); }
        }
        ...
        {
            get { return fullRepaint; }
            set { SetBooleanProperty(ref fullRepaint, value); }
        }
        ...
        private ChartPen Pen
        {
            get
            {
                if (pPen == null) pPen = new ChartPen(Chart, Color.Blue);
                return pPen;
            }
            set { pPen = value; }
        }
        ...
        {
            get { return bBrush ?? (bBrush = new ChartBrush(Chart, Color.HotPink, false)); }
            set { bBrush = value; }
        }
...
*/
        ...
        {
            base.ChartEvent(e);
            if (e is AfterDrawEventArgs) PaintHint();
        }
