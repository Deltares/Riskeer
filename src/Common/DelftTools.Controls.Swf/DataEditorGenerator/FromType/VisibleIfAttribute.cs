...
namespace DelftTools.Controls.Swf.DataEditorGenerator.FromType
{
    ...
    public class VisibleIfAttribute : OperationIfAttribute
    {
        public VisibleIfAttribute(string propertyName, object value, IfOperation operation = IfOperation.Equal)
