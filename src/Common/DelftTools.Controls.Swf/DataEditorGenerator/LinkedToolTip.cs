...
namespace DelftTools.Controls.Swf.DataEditorGenerator
{
    public static class LinkedToolTip
    {
        ...
        private static Control CreateToolTipControl(string text, string linkedString)
        {
            ...
            var control = new Panel { Width = widthChars * charWidth, Height = heightFactor * charHeight };
            ...
            {
                var linkLabel = new LinkLabel { Text = "more...", BackColor = Color.Transparent, Dock = DockStyle.Bottom };
