...
namespace DelftTools.Controls.Swf.DataEditorGenerator.Metadata
{
    public class FieldUIDescription
    {
        ...
        private Func<object, object, string> validationMethod;

        public Func<object, object, string> ValidationMethod
        {
            get { return validationMethod; }
            set { validationMethod = value; }
        }

        public bool HasDependencyFunctions
        {
            get { return isEnabledFunc != null || isVisibleFunc != null; }
        }
