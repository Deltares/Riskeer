...
namespace DeltaShell.Gui.Forms.ViewManager
{
    ...
    {
        private static readonly Bitmap LockImage = Properties.Resources.lock_edit;

        private DockingManager dockingManager;
        private ViewLocation[] dockingLocations;

        private List<IView> views;
        private IView activeView;
        
        private List<WindowsFormsHost> hostControls;
        ...
        void DockingManagerMouseDown(object sender, MouseButtonEventArgs e)
        {
        ...
        private void DockingManagerOnActiveContentChanged(object sender, EventArgs eventArgs)
        {
            ...
            {
                ViewActivated(this, new ActiveViewChangeEventArgs { View = view });
            }
        }
        ...
        private void OnCloseView(IView view, CancelEventArgs e)
        {
            if (views.Contains(view))
            {
                ...
                {
                    var viewEventArgs = new DockTabClosingEventArgs {View = view};
        ...
        private void AddToolView(IView view, ViewLocation location)
        {
            ...
            var hostControl = new WindowsFormsHost { Child = control };
            ...
            if (location.HasFlag(ViewLocation.Left))
            {
                ...
                {
                    var paneGroup = new LayoutAnchorablePaneGroup { Orientation = System.Windows.Controls.Orientation.Vertical, DockWidth = new GridLength(220) };
                    anchorablePane = new LayoutAnchorablePane { DockWidth = new GridLength(220.0, GridUnitType.Pixel) };
        ...
        private void AddDocumentView(IView view)
        {
            ...
            var hostControl = new WindowsFormsHost {Child = (Control) view};
            hostControls.Add(hostControl);
        ...
        public void Remove(IView view, bool removeTabFromDockingbar)
        {
            ...
            if (ViewActivated != null)
            {
                ViewActivated(this, new ActiveViewChangeEventArgs { View = activeView });
            }
        }
        ...
        void ReusableLockedChanged(object sender, EventArgs e)
        {
