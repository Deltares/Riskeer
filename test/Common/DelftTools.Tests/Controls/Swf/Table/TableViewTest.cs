...
namespace DelftTools.Tests.Controls.Swf.Table
{
    ...
    public class TableViewTest
    {
        ...
        class AddDashTestFormatter : ICustomFormatter
        {
            public string Format(string format, object arg, IFormatProvider formatProvider)
            {
                return String.Format("-{0}-", arg);
        ...
        public void SetRowCellValueOnInvalidCellDoesNotCommit()
        {
            ...
            var tableView = new TableView
                                {
                                    Data = persons,
                                    InputValidator = (tvc, obj) => new DelftTools.Utils.Tuple<string, bool>("first", false)
                                };
        ...
        public void AllowAddNewRowShouldBeDeducedFromBindingSource()
        {
            ...
            var tableView = new TableView {Data = new BindingList<Person>(persons) {AllowNew = false}};
        ...
        public void ClickingCheckboxColumnShouldChangeSelection()
        {
            ...
            var tableView = new TableView { Data = table, MultiSelect = true , RowSelect = true, ReadOnly = true};
