...
namespace SharpMap.Tests.Editors.Snapping
{
    ...
    public class SnapStrategyTest
    {
                ...
                new LineString(new[]
                                   {
                                       ...
                                       new Coordinate(30, 10), new Coordinate(40, 10)
                                   });
            multiLineString =
                new MultiLineString(new[] {(ILineString) lineString, lineString2});
        ...
        public void SnapToLineStringUsingFreeAtObject()
        {
            ...
            {
                var candidates = new[] { new Tuple<IFeature, ILayer>(feature, new VectorLayer())};
