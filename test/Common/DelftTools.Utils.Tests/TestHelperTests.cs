...
namespace DelftTools.Utils.Tests
{
    ...
    public class TestHelperTests
    {
        ...
        public void TestPredefinedTestPath()
        {
            ...
            path = TestHelper.GetTestDataPath(TestDataPath.Common.DelftTools.DelftToolsTestsUtilsXmlSerialization);
            Assert.IsTrue(Directory.Exists(path));

            //deltashell
            path = TestHelper.GetTestDataPath(TestDataPath.DeltaShell.DeltaShellDeltaShellPluginsSharpMapGisTests);
            Assert.IsTrue(Directory.Exists(path));
            path = TestHelper.GetTestDataPath(TestDataPath.DeltaShell.DeltaShellDeltaShellPluginsSharpMapGisTestsRasterData);
            Assert.IsTrue(Directory.Exists(path));
