...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Validate_WaterLevelOrWaveHeightNthRow(repo.RiskeerMainWindow.ContainerMultipleViews.DocumentViewContainer.DesignWaterLevelWaveHeightCalculationsView.LeftSide.Table.GenericRowInDV.WaterLevelOrWaveHeightNthRowInfo);
            
            Report.Screenshot(ReportLevel.Info, "User", "", repo.RiskeerMainWindow.ContainerMultipleViews.DocumentViewContainer.DesignWaterLevelWaveHeightCalculationsView.LeftSide.Table.GenericRowInDV.WaterLevelOrWaveHeightNthRow, false, new RecordItemIndex(1));
