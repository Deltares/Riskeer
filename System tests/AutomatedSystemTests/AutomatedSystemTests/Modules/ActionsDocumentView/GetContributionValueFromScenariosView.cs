...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Get Value", "Getting attribute 'Text' from item 'RiskeerMainWindow.ContainerMultipleViews.DocumentViewContainer.ScenariosView.Table.GenericRowContribution' and assigning its value to variable 'valueContributionCell'.", repo.RiskeerMainWindow.ContainerMultipleViews.DocumentViewContainer.ScenariosView.Table.GenericRowContributionInfo, new RecordItemIndex(0));
            valueContributionCell = repo.RiskeerMainWindow.ContainerMultipleViews.DocumentViewContainer.ScenariosView.Table.GenericRowContribution.Element.GetAttributeValueText("Text");
