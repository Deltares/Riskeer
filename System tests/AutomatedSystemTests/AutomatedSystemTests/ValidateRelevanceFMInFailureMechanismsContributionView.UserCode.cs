...
namespace AutomatedSystemTests
{
    public partial class ValidateRelevanceFMInFailureMechanismsContributionView
    {
        ...
        public void ValidateCheckStateOfIsRelevantCell(RepoItemInfo cellInfo, string expectedRelevance)
        {
        	string currentStates = cellInfo.CreateAdapter<Cell>(true).As<Accessible>().State.ToString();
