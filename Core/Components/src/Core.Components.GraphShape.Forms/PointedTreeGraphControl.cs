...
namespace Core.Components.GraphShape.Forms
{
    ...
    public partial class PointedTreeGraphControl : UserControl, IPointedTreeGraphControl
    {
        ...
        private void InitializeZoomControl()
        {
            ...
            {
                Source = new Uri($"{PackUriHelper.UriSchemePack}://application:,,,/Core.Components.GraphShape.Forms;component/Templates/PointedTreeGraphTemplate.xaml", UriKind.Absolute)
            };
