...
{
    /// <summary>
    /// <see cref="MapLineData"/> that is marked as being removable.
    /// </summary>
    public class RemovableMapLineData : MapLineData, IRemovable
    {
        /// <summary>
        ...
        public RemovableMapLineData(string name, LineStyle style) : base(name, style) {}
    }
}