...
namespace Core.Gui.ContextMenu
{
    ...
    public interface IContextMenuBuilderProvider
    {
        ...
        /// <param name="treeViewControl">The <see cref="ITreeViewCommands"/> to use while executing the
        ...
        IContextMenuBuilder Get(object value, ITreeViewCommands treeViewControl);
    }
}