...
{
    [ResourcesDisplayName(typeof(Resources), "VectorLayerPointProperties_DisplayName")]
    public class VectorLayerPointProperties : PointStylePropertiesBase<VectorLayer>
    {
        [DynamicReadOnly]
