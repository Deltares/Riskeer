...
{
    /// <summary>
    /// ViewModel of <see cref="ChartMultipleLineData"/> for the property panel.
    /// </summary>
    public class ChartMultipleLineDataProperties : ChartDataProperties<ChartMultipleLineData>
    {
