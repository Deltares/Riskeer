...
namespace Core.Plugins.Map.Test.Legend
{
    ...
    public class MapPolygonDataTreeNodeInfoTest
    {
        ...
        public void Text_Always_ReturnsNameFromMapData()
        {
            ...
            // Call
            string text = info.Text(mapPolygonData);
        ...
        public void CanDrag_Always_ReturnsTrue()
        {
            ...
            // Call
            bool canDrag = info.CanDrag(mapPolygonData, null);
        ...
        {
            // Setup
            var removable = mocks.StrictMultiMock<MapPolygonData>(new[]
            {
                typeof(IRemovable)
            }, "name");
            mocks.ReplayAll();
        ...
        {
            // Setup
            var toRemove = mocks.StrictMultiMock<MapPolygonData>(new[]
            {
                typeof(IRemovable)
            }, "name");
            var otherData = mocks.Stub<MapPolygonData>("name");
            mocks.ReplayAll();
        ...
        public void IsChecked_Always_ReturnsAccordingToVisibleStateOfPolygonData(bool isVisible)
        {
            ...
            // Call
            bool canCheck = info.IsChecked(mapPolygonData);
