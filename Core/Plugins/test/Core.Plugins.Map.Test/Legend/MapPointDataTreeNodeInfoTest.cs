...
namespace Core.Plugins.Map.Test.Legend
{
    ...
    public class MapPointDataTreeNodeInfoTest
    {
        ...
        public void Text_Always_ReturnsNameFromMapData()
        {
            ...
            // Call
            string text = info.Text(mapPointData);
        ...
        public void CanCheck_Always_ReturnsTrue()
        {
            ...
            // Call
            bool canCheck = info.CanCheck(mapPointData);
        ...
        public void CanDrag_Always_ReturnsTrue()
        {
            ...
            // Call
            bool canDrag = info.CanDrag(mapPointData, null);
        ...
        {
            // Setup
            var removable = mocks.StrictMultiMock<MapPointData>(new[]
            {
                typeof(IRemovable)
            }, "name");
            mocks.ReplayAll();
        ...
        {
            // Setup
            var notRemovable = mocks.StrictMock<MapPointData>("name");
            mocks.ReplayAll();
        ...
        {
            // Setup
            var toRemove = mocks.StrictMultiMock<MapPointData>(new[]
            {
                typeof(IRemovable)
            }, "name");
            var otherData = mocks.Stub<MapPointData>("name");
            mocks.ReplayAll();
        ...
        public void IsChecked_Always_ReturnsAccordingToVisibleStateOfPointData(bool isVisible)
        {
            ...
            // Call
            bool canCheck = info.IsChecked(mapPointData);
