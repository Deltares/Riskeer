...
namespace Core.Plugins.ProjectExplorer.Test.Exceptions
{
    ...
    public class RingtoetsPipingSurfaceLineExceptionExceptionTest
    {
        ...
        {
            // Call
            var exception = new ProjectExplorerGuiPluginException();
        ...
        public void MessageConstructor_ExpectedValues()
        {
            ...
            // Call
            var exception = new ProjectExplorerGuiPluginException(messageText);
        ...
        public void MessageAndInnerExceptionConstructor_ExpectedValues()
        {
            ...
            // Call
            var exception = new ProjectExplorerGuiPluginException(messageText, innerException);
