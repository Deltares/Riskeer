...
namespace Core.Common.Base.IO
{
    ...
    public class CriticalFileReadException : Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="CriticalFileReadException"/> with
        ...
        protected CriticalFileReadException(SerializationInfo info, StreamingContext context) : base(info, context) {}
    }
}