...
namespace Core.Common.Base.Storage
{
    ...
    public class StorageValidationException : StorageException
    {
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="StorageValidationException"/> with
        ...
        protected StorageValidationException(SerializationInfo info, StreamingContext context) : base(info, context) {}
    }
}