...
namespace Core.Common.Base.Exceptions
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DoubleParsingException"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DoubleParsingException"/> class with a specified error message 
