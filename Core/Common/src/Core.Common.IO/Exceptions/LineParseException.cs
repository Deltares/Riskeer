...
namespace Core.Common.IO.Exceptions
{
    ...
    public class LineParseException : Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="LineParseException"/> with
        ...
        protected LineParseException(SerializationInfo info, StreamingContext context) : base(info, context) {}
    }
}