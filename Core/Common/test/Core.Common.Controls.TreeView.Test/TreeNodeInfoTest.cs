...
namespace Core.Common.Controls.TreeView.Test
{
    ...
    public class TreeNodeInfoTest
    {
        ...
        public void SimpleProperties_SetNewValues_GetNewlySetValues()
        {
            ...
            Func<object, object, ITreeViewCommands, ContextMenuStrip> contextMenuStrip = (o1, o2, tvc) => new ContextMenuStrip();
            ...
            Action<object, object, object, int, ITreeViewCommands> onDrop = (o1, o2, o3, index, tvc) => {};
        ...
        public void SimpleProperties_GenericTreeNodeInfoSetNewValues_GetNewlySetValues()
        {
            ...
            Func<int, object, ITreeViewCommands, ContextMenuStrip> contextMenuStrip = (o1, o2, tvc) => new ContextMenuStrip();
