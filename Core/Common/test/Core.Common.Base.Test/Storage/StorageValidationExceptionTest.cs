...
namespace Core.Common.Base.Test.Storage
{
    ...
    public class StorageValidationExceptionTest
    {
        ...
        public void Constructor_SerializationRoundTrip_ExceptionProperlyInitialized()
        {
            ...
            var originalException = new StorageValidationException("outer", originalInnerException);
            ...
            // Call
            StorageValidationException persistedException = SerializationTestHelper.SerializeAndDeserializeException(originalException);
