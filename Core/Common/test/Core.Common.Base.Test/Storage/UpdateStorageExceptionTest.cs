...
namespace Core.Common.Base.Test.Storage
{
    ...
    public class UpdateStorageExceptionTest
    {
        ...
        public void Constructor_SerializationRoundTrip_ExceptionProperlyInitialized()
        {
            ...
            var originalException = new UpdateStorageException("outer", originalInnerException);
            ...
            // Call
            UpdateStorageException persistedException = SerializationTestHelper.SerializeAndDeserializeException(originalException);
