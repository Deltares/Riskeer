...
namespace Core.Common.Util.Test.Attributes
{
    ...
    public class ResourcesCategoryAttributeTest
    {
        ...
        {
            // Call
            Action call = () => new ResourcesCategoryAttribute(typeof(Resources), "DoesNotExist");
        ...
        {
            // Call
            Action call = () => new ResourcesCategoryAttribute(typeof(Resources), nameof(Resources.abacus));
