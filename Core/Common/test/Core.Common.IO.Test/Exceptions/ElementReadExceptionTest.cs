...
{
    [TestFixture]
    public class ElementReadExceptionTest
    {
        [Test]
        [SetCulture("en-US")]
        ...
        {
            // Call
            var exception = new ElementReadException();
        ...
        public void MessageConstructor_ExpectedValues()
        {
            ...
            // Call
            var exception = new ElementReadException(messageText);
        ...
        public void MessageAndInnerExceptionConstructor_ExpectedValues()
        {
            ...
            // Call
            var exception = new ElementReadException(messageText, innerException);
