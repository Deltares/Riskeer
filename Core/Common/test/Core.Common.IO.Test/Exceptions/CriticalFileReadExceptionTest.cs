...
namespace Core.Common.IO.Test.Exceptions
{
    ...
    public class CriticalFileReadExceptionTest
    {
        ...
        public void Constructor_SerializationRoundTrip_ExceptionProperlyInitialized()
        {
            ...
            var originalException = new CriticalFileReadException("outer", originalInnerException);
            ...
            // Call
            CriticalFileReadException persistedException = SerializationTestHelper.SerializeAndDeserializeException(originalException);
