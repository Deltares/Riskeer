...
namespace Core.Common.IO.Test.Exceptions
{
    ...
    public class ConversionExceptionTest
    {
        ...
        public void MessageConstructor_ExpectedValues()
        {
            ...
            // Call
            var exception = new ConversionException(messageText);
        ...
        public void MessageAndInnerExceptionConstructor_ExpectedValues()
        {
            ...
            // Call
            var exception = new ConversionException(messageText, innerException);
        ...
        public void Constructor_SerializationRoundTrip_ExceptionProperlyInitialized()
        {
            ...
            var originalException = new ConversionException("outer", originalInnerException);
            ...
            // Call
            ConversionException persistedException = SerializationTestHelper.SerializeAndDeserializeException(originalException);
