...
{
    [TestFixture]
    public class CriticalFileWriteExceptionTest
    {
        [Test]
        [SetCulture("en-US")]
        ...
        {
            // Call
            var exception = new CriticalFileWriteException();
        ...
        public void MessageConstructor_ExpectedValues()
        {
            ...
            // Call
            var exception = new CriticalFileWriteException(messageText);
        ...
        public void MessageAndInnerExceptionConstructor_ExpectedValues()
        {
            ...
            // Call
            var exception = new CriticalFileWriteException(messageText, innerException);
        ...
        public void Constructor_SerializationRoundTrip_ExceptionProperlyInitialized()
        {
            ...
            var originalException = new CriticalFileWriteException("outer", originalInnerException);
            ...
            // Call
            CriticalFileWriteException persistedException = SerializationTestHelper.SerializeAndDeserializeException(originalException);
