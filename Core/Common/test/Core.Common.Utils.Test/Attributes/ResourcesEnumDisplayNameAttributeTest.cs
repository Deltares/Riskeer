...
{
    [TestFixture]
    public class ResourcesEnumDisplayNameAttributeTest
    {
        [Test]
        public void ParameteredConstructor_ResourcePropertyDoesNotExist_ThrowInvalidOperationException()
        {
            // Call
            TestDelegate call = () => new ResourcesEnumDisplayNameAttribute(typeof(Resources), "DoesNotExist");
        ...
        {
            // Call
            TestDelegate call = () => new ResourcesEnumDisplayNameAttribute(typeof(Resources), "abacus");
        ...
        {
            // Call
            var attribute = new ResourcesEnumDisplayNameAttribute(typeof(Resources), "SomeStringResource");
