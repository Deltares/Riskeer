...
namespace Core.Gis.GeoApi.CoordinateSystems
{
    ...
    {
        /// <summary>
        /// A list of currently supported coordinate systems.
        /// </summary>
        IList<ICoordinateSystem> SupportedCoordinateSystems { get; }

        /// <summary>
        /// Custom coordinatey 
        /// </summary>
        IList<ICoordinateSystem> CustomCoordinateSystems { get; set; }

        /// <summary>
        /// Creates coordinate system from EPSG code.
        /// </summary>
        /// <param name="code"></param>
        /// <returns></returns>
        ICoordinateSystem CreateFromEPSG(int code);

        /// <summary>
        /// Creates coordinate system transformation.
        /// </summary>
        /// <param name="src"></param>
        /// <param name="dst"></param>
        /// <returns></returns>
        ICoordinateTransformation CreateTransformation(ICoordinateSystem src, ICoordinateSystem dst);
