...
namespace Core.GIS.NetTopologySuite.Index.Chain
{
    ...
    public class MonotoneChain
    {
        ...
        private readonly object context = null; // user-defined information
        ...
        public IEnvelope Envelope
        {
            get
            {
                if (env == null)
                {
                    ICoordinate p0 = pts[StartIndex];
                    ICoordinate p1 = pts[EndIndex];
        ...
        public ICoordinate[] Coordinates
        {
            get
            {
                ICoordinate[] coord = new ICoordinate[EndIndex - StartIndex + 1];
                int index = 0;
