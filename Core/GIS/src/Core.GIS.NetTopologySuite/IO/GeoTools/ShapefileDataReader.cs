...
namespace Core.GIS.NetTopologySuite.IO.GeoTools
{
    ...
    public class ShapefileDataReader : IDataReader, IEnumerable
    {
        ...
        private readonly DbaseFileReader _dbfReader;
        private readonly ShapefileReader _shpReader;
        private readonly IEnumerator _dbfEnumerator;
        private readonly IEnumerator _shpEnumerator;
        private IGeometryFactory _geometryFactory;
        private bool _moreRecords = false;
        private readonly int _recordCount = 0;
        ...
        public ShapefileDataReader(string filename, IGeometryFactory geometryFactory)
        {
            ...
            _recordCount = DbaseHeader.NumRecords;
        ...
        public object this[string name]
        {
            get
            {
                ...
                return _columnValues[GetOrdinal(name) + 1];
            }
        }
        ...
        /// </summary>
        public DbaseFileHeader DbaseHeader { get; private set; }
