...
namespace Core.GIS.NetTopologySuite.IO.GeoTools
{
    ...
    {
        private readonly ShapefileHeader _mainHeader = null;
        private readonly IGeometryFactory _geometryFactory = null;
        ...
        private class ShapefileEnumerator : IEnumerator, IDisposable
        {
            ...
            private readonly BigEndianBinaryReader _shpBinaryReader = null;
