...
namespace Core.GIS.SharpMap.Utilities
{
    /// <summary>
    ...
    public class Transform
    {
        ...
        public static ICoordinate MapToWorld(PointF p, Map.Map map)
        {
        ...
        /// <returns>point in image coordinates</returns>
        public static PointF TransformToImage(IPoint p, Map.Map map)
        {
            return WorldtoMap(p.Coordinate, map);
        }

        public static Point[] TransformToImageI(ILineString line, Map.Map map, bool simplifyGeometry, ref int pointCount)
        {
        ...
        public static PointF[] TransformToImage(IPolygon poly, Map.Map map)
        {
