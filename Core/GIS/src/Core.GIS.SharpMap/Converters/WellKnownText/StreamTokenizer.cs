...
namespace Core.GIS.SharpMap.Converters.WellKnownText
{
    ...
    internal class StreamTokenizer
    {
        ...
        public double GetNumericValue()
        {
            ...
            {
                return double.Parse(number, Map.Map.numberFormat_EnUS);
            }
            throw new Exception(String.Format(Map.Map.numberFormat_EnUS, "The token '{0}' is not a number at line {1} column {2}.", number, LineNumber, Column));
        }
