...
namespace Core.GIS.SharpMap.Rendering
{
    ...
    public class VectorRenderingHelper
    {
        ...
        public static void DrawMultiLineString(Graphics g, IMultiLineString lines, Pen pen, IMap map)
        {
        ...
        /// <param name="pen">Pen style used for rendering</param>
        /// <param name="map">Map reference</param>
        public static void DrawLineString(Graphics g, ILineString line, Pen pen, IMap map)
        {
        ...
        /// <param name="map">Map reference</param>
        public static void DrawMultiPolygon(Graphics g, IMultiPolygon pols, Brush brush, Pen pen, bool clip, IMap map)
        {
        ...
        /// <param name="clip">Specifies whether polygon clipping should be applied</param>
        /// <param name="map">Map reference</param>
        public static void DrawPolygon(Graphics g, IPolygon pol, Brush brush, Pen pen, bool clip, IMap map)
        {
            try
            {
                if (pol.Shell == null)
        ...
        /// <param name="map">Map reference</param>
        public static void DrawLabel(Graphics g, PointF LabelPoint, PointF Offset, Font font, Color forecolor, Brush backcolor, Pen halo, float rotation, string text, IMap map)
        {
        ...
        public static void RenderGeometry(Graphics g, IMap map, IGeometry feature, VectorStyle style, Bitmap defaultSymbol, bool clippingEnabled)
        {
            ...
            switch (feature.GeometryType)
            {
                ...
                case "MultiPoint":
                    ...
                    DrawMultiPoint(g, (IMultiPoint) feature, symbol, style.SymbolScale,
                                   style.SymbolOffset, style.SymbolRotation, map);
                    break;
        ...
        internal static PointF[] clipPolygon(PointF[] vertices, int width, int height)
        {
			...
			*/
            ...
            if (line.Count > 0)
            {
                line.Add(new PointF(line[0].Y, line[0].Y));
            }
