        ...
        internal object ReadDbfValue(DbaseField dbf)
        {
            switch (dbf.DataType.ToString())
            {
                ...
                case "System.Double":
                    ...
                    double dbl = 0;
                    if (double.TryParse(temp, NumberStyles.Float, Map.Map.numberFormat_EnUS, out dbl))
                    {
                        return dbl;
                    }
                    else
                ...
                case "System.Int16":
                    ...
                    Int16 i16 = 0;
                    if (Int16.TryParse(temp16, NumberStyles.Float, Map.Map.numberFormat_EnUS, out i16))
                    {
                        return i16;
                    }
                    else
                ...
                case "System.Int32":
                    ...
                    Int32 i32 = 0;
                    if (Int32.TryParse(temp32, NumberStyles.Float, Map.Map.numberFormat_EnUS, out i32))
                    {
                        return i32;
                    }
                    else
                ...
                case "System.Int64":
                    ...
                    Int64 i64 = 0;
                    if (Int64.TryParse(temp64, NumberStyles.Float, Map.Map.numberFormat_EnUS, out i64))
                    {
                        return i64;
                    }
                    else
                ...
                case "System.Single":
                    ...
                    float f = 0;
                    if (float.TryParse(temp4, NumberStyles.Float, Map.Map.numberFormat_EnUS, out f))
                    {
                        return f;
                    }
                    else
                ...
                case "System.DateTime":
                    ...
                    if (DateTime.TryParseExact(Encoding.UTF7.GetString((br.ReadBytes(8))),
                                               "yyyyMMdd", Map.Map.numberFormat_EnUS, DateTimeStyles.None, out date))
                    {
                        return date;
                    }
                    else
